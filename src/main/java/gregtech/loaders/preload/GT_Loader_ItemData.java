...
public class GT_Loader_ItemData
    ...
    public void run() {
        ...
        GT_OreDictUnificator.addItemData(ItemList.Cell_Universal_Fluid.get(1L), new ItemData(Materials.Tin, 7257600L, new MaterialStack(Materials.Glass, 1360800L)));
        ...
        GT_OreDictUnificator.addItemData(new ItemStack(Items.glass_bottle, 1), new ItemData(Materials.Glass, 3628800L));

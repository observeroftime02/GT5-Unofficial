...
public class GT_Loader_MaterialRecipes implements Runnable {
    ...
    public void addHotIngotRecipes(Materials aMaterial) {
        GT_Values.RA.addVacuumFreezerRecipe(MatUnifier.get(OrePrefixes.ingotHot, aMaterial, 1), aIngotStack, (int) Math.max(aMaterial.getMass() * 3L, 1L));
    }

    public void addSpringRecipes(Materials aMaterial) {
        GT_Values.RA.addBenderRecipe(MatUnifier.get(OrePrefixes.stick, aMaterial, 1), MatUnifier.get(OrePrefixes.spring, aMaterial), 200, 16);
    }

    public void addDensePlateRecipes(Materials aMaterial) {
        ItemStack aDenseStack = MatUnifier.get(OrePrefixes.plateDense, aMaterial, 1);
        GT_ModHandler.removeRecipeByOutput(aDenseStack);
        GT_Utility.removeSimpleIC2MachineRecipe(GT_Utility.copyAmount(9, aPlateStack), GT_ModHandler.getCompressorRecipeList(), aDenseStack);
    ...
    public void addRotorRecipes(Materials aMaterial) {
        ItemStack aRotorStack = MatUnifier.get(OrePrefixes.rotor, aMaterial, 1);
        ItemStack aRingStack = MatUnifier.get(OrePrefixes.ring, aMaterial, 1);
    ...
    public void addFineWireRecipes(Materials aMaterial) {
        ItemStack aWireStack = MatUnifier.get(OrePrefixes.wireFine, aMaterial, 1);
        if (!aNoSmashing) {
            ...
            GT_Values.RA.addWiremillRecipe(MatUnifier.get(OrePrefixes.stick, aMaterial, 1), GT_Utility.copy(MatUnifier.get(OrePrefixes.wireGt01, aMaterial, 1), aWireStack), 50, 4);
        }
        if ((aMaterial.mUnificatable) && (aMaterial.mMaterialInto == aMaterial) && !aNoWorking) {
    ...
    public void addGearSmallRecipes(Materials aMaterial) {
        ItemStack aGearSmallStack = MatUnifier.get(OrePrefixes.gearGtSmall, aMaterial, 1);
        if (aMaterial.mStandardMoltenFluid != null) {
            GT_Values.RA.addFluidSolidifierRecipe(ItemList.Shape_Mold_Gear_Small.get(0), aMaterial.getMolten(144L), GT_Utility.copyAmount(1, aGearSmallStack), 16, 8);
        }
        if (aMaterial.mUnificatable && (aMaterial.mMaterialInto == aMaterial) && !aNoWorking) {
    ...
    public void addGearRecipes(Materials aMaterial) {
        ItemStack aGearStack = MatUnifier.get(OrePrefixes.gearGt, aMaterial, 1);
        GT_ModHandler.removeRecipeByOutput(aGearStack);
        if (aMaterial.mStandardMoltenFluid != null) {
            GT_Values.RA.addFluidSolidifierRecipe(ItemList.Shape_Mold_Gear.get(0), aMaterial.getMolten(576L), aGearStack, 128, 8);
        }
        if (aMaterial.mUnificatable && (aMaterial.mMaterialInto == aMaterial) && !aNoWorking) {
            GT_ModHandler.addCraftingRecipe(MatUnifier.get(OrePrefixes.gearGt, aMaterial, 1), tBits, new Object[]{"SPS", "PwP", "SPS", Character.valueOf('P'), OrePrefixes.plate.get(aMaterial), Character.valueOf('S'), OrePrefixes.stick.get(aMaterial)});
        }
        MatUnifier.registerOre(OrePrefixes.gear, aGearStack);
    }

    public void addScrewRecipes(Materials aMaterial) {
        ItemStack aScrewStack = MatUnifier.get(OrePrefixes.screw, aMaterial, 1);
        if (!aNoWorking) {
            GT_Values.RA.addLatheRecipe(MatUnifier.get(OrePrefixes.bolt, aMaterial, 1), aScrewStack, null, (int) Math.max(aMaterial.getMass() / 8L, 1L), 4);
    ...
    public void addFoilRecipes(Materials aMaterial) {
        ItemStack aFoilStack = MatUnifier.get(OrePrefixes.foil, aMaterial, 1);
        GT_Values.RA.addBenderRecipe(GT_Utility.copyAmount(1, MatUnifier.get(OrePrefixes.plate, aMaterial, 4)), GT_Utility.copyAmount(4, aFoilStack), (int) Math.max(aMaterial.getMass(), 1L), 24);
    ...
    public void addRingRecipes(Materials aMaterial) {
        if ((aMaterial.mUnificatable) && (aMaterial.mMaterialInto == aMaterial) && !aNoSmashing) {
            GT_ModHandler.addCraftingRecipe(MatUnifier.get(OrePrefixes.ring, aMaterial, 1), tBits, new Object[]{"h ", " X", Character.valueOf('X'), OrePrefixes.stick.get(aMaterial)});
        }
    }

    public void addStickRecipes(Materials aMaterial) {
        ItemStack aStickStack = MatUnifier.get(OrePrefixes.stick, aMaterial, 1);
        if (!aNoWorking) {
            GT_Values.RA.addLatheRecipe(aMaterial.contains(SubTag.CRYSTAL) ? MatUnifier.get(OrePrefixes.gem, aMaterial, 1) : aIngotStack, aStickStack, MatUnifier.get(OrePrefixes.dustSmall, aMaterial.mMacerateInto, 2), (int) Math.max(aMaterial.getMass() * 5L, 1L), 16);
    ...
    public void addPlateRecipes(Materials aMaterial) {
        ...
        if (aMaterial.mStandardMoltenFluid != null) {
            GT_Values.RA.addFluidSolidifierRecipe(ItemList.Shape_Mold_Plate.get(0), aMaterial.getMolten(144L), MatUnifier.get(OrePrefixes.plate, aMaterial, 1), 32, 8);
        }
        if (aMaterial.mFuelPower > 0) {
            GT_Values.RA.addFuel(aPlateStack, null, aMaterial.mFuelPower, aMaterial.mFuelType);
        }
        GT_Values.RA.addImplosionRecipe(GT_Utility.copyAmount(aMaterial == Materials.MeteoricIron ? 1 : 2, aPlateStack), 2, MatUnifier.get(OrePrefixes.compressed, aMaterial, 1), MatUnifier.get(OrePrefixes.dustTiny, Materials.DarkAsh, 1));
        ...
        if ((aMaterial.mUnificatable) && (aMaterial.mMaterialInto == aMaterial)) {
            ...
            if ((aMaterial.contains(SubTag.MORTAR_GRINDABLE)) && (GregTech_API.sRecipeFile.get(ConfigCategories.Tools.mortar, aMaterial.mName, true))) {
                GT_ModHandler.addCraftingRecipe(MatUnifier.get(OrePrefixes.dust, aMaterial, 1), tBits, new Object[]{"X", "m", 'X', aPlateStack});
            }
        }
    ...
    public void addToolRecipes(Materials aMaterial) {
        ItemStack aStickStack = MatUnifier.get(OrePrefixes.stick, aMaterial, 1);
        ItemStack aStainlessScrew = MatUnifier.get(OrePrefixes.screw, Materials.StainlessSteel, 1);
        ItemStack aTitaniumScrew = MatUnifier.get(OrePrefixes.screw, Materials.Titanium, 1);
        ItemStack aTungstensteelScrew = MatUnifier.get(OrePrefixes.screw, Materials.TungstenSteel, 1);
        ItemStack aStainlessPlate = MatUnifier.get(OrePrefixes.plate, Materials.StainlessSteel, 1);
        ItemStack aTitaniumPlate = MatUnifier.get(OrePrefixes.plate, Materials.Titanium, 1);
        ItemStack aTungstensteelPlate = MatUnifier.get(OrePrefixes.plate, Materials.TungstenSteel, 1);
        ItemStack aStainlessSmallGear = MatUnifier.get(OrePrefixes.gearGtSmall, Materials.StainlessSteel, 1);
        ItemStack aTitaniumSmallGear = MatUnifier.get(OrePrefixes.gearGtSmall, Materials.Titanium, 1);
        ItemStack aTungstensteelSmallGear = MatUnifier.get(OrePrefixes.gearGtSmall, Materials.TungstenSteel, 1);
        ItemStack aTitaniumSpring = MatUnifier.get(OrePrefixes.spring, Materials.Titanium, 1);
    ...
    public void addCellRecipes(Materials aMaterial) {
        ItemStack aCellStack = MatUnifier.get(OrePrefixes.cell, aMaterial, 1);
        ItemStack aPlasmaStack = MatUnifier.get(OrePrefixes.cellPlasma, aMaterial, 1);
        if (aMaterial == Materials.Empty) {
            ...
            if (aMaterial.mMaterialList.size() > 0 && aMaterial.hasFlag(MaterialFlags.ELEC.bit) && aMaterial.hasFlag(MaterialFlags.CENT.bit)) {
                ...
                int tItemAmount = 0;
                int tCapsuleCount = GT_ModHandler.getCapsuleCellContainerCountMultipliedWithStackSize(aCellStack) * -tAllAmount;
                ...
                for (MaterialStack tMat : aMaterial.mMaterialList) {
                    if (tMat.mAmount > 0L) {
                        ...
                        if (tMat.mMaterial == Materials.Air) {
                            tStack = ItemList.Cell_Air.get((int)tMat.mAmount * tDensityMultiplier / 2); //TODO REMOVE CAST TO INT
                        } else {
                            tStack = MatUnifier.get(OrePrefixes.dust, tMat.mMaterial, (int)tMat.mAmount);//TODO REMOVE CAST TO INT
                            if (tStack == null) {
                                tStack = MatUnifier.get(OrePrefixes.cell, tMat.mMaterial, (int)tMat.mAmount);//TODO REMOVE CAST TO INT
                            }
                        }
                        if (tItemAmount + tMat.mAmount * 3628800L <= aCellStack.getMaxStackSize() * aMaterial.getDensity()) {
                            tItemAmount += tMat.mAmount * 3628800L;
                            if (tStack != null) {
                                tStack.stackSize = tStack.stackSize * tDensityMultiplier;
                ...
                tItemAmount = (tItemAmount * tDensityMultiplier % aMaterial.getDensity() > 0 ? 1 : 0) + tItemAmount * tDensityMultiplier / (int) aMaterial.getDensity();
                if (tList.size() > 0) {
    ...
    public void addOreRecipes(Materials aMaterial, boolean aIsRich) { //Ore, Crushed, CrushedCent, CrushedPure
        ...
        ItemStack aOreStack = MatUnifier.get(OrePrefixes.ore, aMaterial, 1);
        ...
        for (Materials tMat : aMaterial.mOreByProducts) {
            ...
            if (tMat.contains(SubTag.WASHING_MERCURY)) {
                GT_Values.RA.addChemicalBathRecipe(aCrushedStack, Materials.Mercury.getFluid(1000L), aCrushedPureStack/*TODO CHECK GT_OreDictUnificator.get(aPrefix == OrePrefixes.crushed ? OrePrefixes.crushedPurified : OrePrefixes.dustPure, aMaterial, 1L)*/, MatUnifier.get(OrePrefixes.dust, tMat.mMacerateInto), aDustStone, new int[]{10000, 7000, 4000}, 800, 8);
            }
            if (tMat.contains(SubTag.WASHING_SODIUMPERSULFATE)) {
                GT_Values.RA.addChemicalBathRecipe(aCrushedStack, Materials.SodiumPersulfate.getFluid(GT_Mod.gregtechproxy.mReenableSimplifiedChemicalRecipes ? 1000L : 100L), aCrushedPureStack/*TODO CHECK GT_OreDictUnificator.get(aPrefix == OrePrefixes.crushed ? OrePrefixes.crushedPurified : OrePrefixes.dustPure, aMaterial, 1L)*/, MatUnifier.get(OrePrefixes.dust, tMat.mMacerateInto), aDustStone, new int[]{10000, 7000, 4000}, 800, 8);
            }
        }
        ...
        if (aSmeltIntoStack != null) {
            if ((aMaterial.mBlastFurnaceRequired) || (aMaterial.mDirectSmelting.mBlastFurnaceRequired)) {
                ...
                if (GT_Mod.gregtechproxy.mTEMachineRecipes) {
                    GT_ModHandler.addInductionSmelterRecipe(aOreStack, new ItemStack(net.minecraft.init.Blocks.sand, 1), GT_Utility.mul(aMultiplier * (aMaterial.contains(SubTag.INDUCTIONSMELTING_LOW_OUTPUT) ? 1 : 2) * aMaterial.mSmeltingMultiplier, aSmeltIntoStack), ItemList.TE_Slag_Rich.get(1), 300 * aMultiplier, 10 * aMultiplier);
            ...
            if (aMaterial.contains(SubTag.BLASTFURNACE_CALCITE_TRIPLE)) {
                GT_Values.RA.addBlastRecipe(aOreStack, MatUnifier.get(OrePrefixes.dust, Materials.Calcite, aMultiplier), null, null, GT_Utility.mul(aMultiplier * 3 * aMaterial.mSmeltingMultiplier, aSmeltIntoStack), ItemList.TE_Slag.get(1, MatUnifier.get(OrePrefixes.dustSmall, Materials.DarkAsh)), aSmeltIntoStack.stackSize * 500, 120, 1500);
                GT_Values.RA.addBlastRecipe(aOreStack, MatUnifier.get(OrePrefixes.dustTiny, Materials.Quicklime, aMultiplier * 3), null, null, GT_Utility.mul(aMultiplier * 3 * aMaterial.mSmeltingMultiplier, aSmeltIntoStack), ItemList.TE_Slag.get(1, MatUnifier.get(OrePrefixes.dustSmall, Materials.DarkAsh)), aSmeltIntoStack.stackSize * 500, 120, 1500);
        ...
        if (aWashingMercury) {
            GT_Values.RA.addChemicalBathRecipe(aCrushedStack, Materials.Mercury.getFluid(1000L), aCrushedPureStack/*TODO CHECK GT_OreDictUnificator.get(aPrefix == OrePrefixes.crushed ? OrePrefixes.crushedPurified : OrePrefixes.dustPure, aMaterial, 1L)*/, MatUnifier.get(OrePrefixes.dust, aMaterial.mMacerateInto), aDustStone, new int[]{10000, 7000, 4000}, 800, 8);
        }
        if (aWashingSodium) {
            GT_Values.RA.addChemicalBathRecipe(aCrushedStack, Materials.SodiumPersulfate.getFluid(GT_Mod.gregtechproxy.mReenableSimplifiedChemicalRecipes ? 1000L : 100L), aCrushedPureStack/*TODO CHECK GT_OreDictUnificator.get(aPrefix == OrePrefixes.crushed ? OrePrefixes.crushedPurified : OrePrefixes.dustPure, aMaterial, 1L)*/, MatUnifier.get(OrePrefixes.dust, aMaterial.mMacerateInto), aDustStone, new int[]{10000, 7000, 4000}, 800, 8);
        }
        GT_Values.RA.addForgeHammerRecipe(GT_Utility.copyAmount(1, aCrushedStack), MatUnifier.get(OrePrefixes.dustImpure, aMaterial.mMacerateInto), 10, 16);
        GT_Values.RA.addForgeHammerRecipe(GT_Utility.copyAmount(1, aCrushedCentStack), MatUnifier.get(OrePrefixes.dust, aMaterial.mMacerateInto), 10, 16);
        GT_Values.RA.addForgeHammerRecipe(GT_Utility.copyAmount(1, aCrushedPureStack), MatUnifier.get(OrePrefixes.dustPure, aMaterial.mMacerateInto), 10, 16);
        GT_Values.RA.addSifterRecipe(GT_Utility.copyAmount(1, aCrushedPureStack), new ItemStack[]{MatUnifier.get(OrePrefixes.gemExquisite, aMaterial, aGemStack), MatUnifier.get(OrePrefixes.gemFlawless, aMaterial, aGemStack, 1), aGemStack, MatUnifier.get(OrePrefixes.gemFlawed, aMaterial, aGemStack), MatUnifier.get(OrePrefixes.gemChipped, aMaterial, aGemStack), MatUnifier.get(OrePrefixes.dust, aMaterial, aGemStack)}, new int[]{100, 400, 1500, 2000, 4000, 5000}, 800, 16);
        GT_ModHandler.addPulverisationRecipe(GT_Utility.copyAmount(1, aCrushedStack), MatUnifier.get(OrePrefixes.dustImpure, aMaterial.mMacerateInto, MatUnifier.get(OrePrefixes.dust, aMaterial.mMacerateInto)), MatUnifier.get(OrePrefixes.dust, GT_Utility.selectItemInList(0, aMaterial.mMacerateInto, aMaterial.mOreByProducts)), 10, false);
        GT_ModHandler.addPulverisationRecipe(GT_Utility.copyAmount(1, aCrushedCentStack), MatUnifier.get(OrePrefixes.dust, aMaterial.mMacerateInto), MatUnifier.get(OrePrefixes.dust, GT_Utility.selectItemInList(2, aMaterial.mMacerateInto, aMaterial.mOreByProducts)), 10, false);
        GT_ModHandler.addPulverisationRecipe(GT_Utility.copyAmount(1, aCrushedPureStack), MatUnifier.get(OrePrefixes.dustPure, aMaterial.mMacerateInto, MatUnifier.get(OrePrefixes.dust, aMaterial.mMacerateInto)), MatUnifier.get(OrePrefixes.dust, GT_Utility.selectItemInList(1, aMaterial.mMacerateInto, aMaterial.mOreByProducts)), 10, false);
        GT_ModHandler.addThermalCentrifugeRecipe(GT_Utility.copyAmount(1, aCrushedStack), (int) Math.min(5000L, Math.abs(aMaterial.getMass() * 20L)), aCrushedPureStack/*TODO CHECK GT_OreDictUnificator.get(aPrefix == OrePrefixes.crushed ? OrePrefixes.crushedPurified : OrePrefixes.dustPure, aMaterial, 1L)*/, MatUnifier.get(OrePrefixes.dustTiny, GT_Utility.selectItemInList(1, aMaterial.mMacerateInto, aMaterial.mOreByProducts)), aDustStone);
        GT_ModHandler.addThermalCentrifugeRecipe(GT_Utility.copyAmount(1, aCrushedPureStack), (int) Math.min(5000L, Math.abs(aMaterial.getMass() * 20L)), MatUnifier.get(OrePrefixes.crushedCentrifuged, aMaterial.mMacerateInto, MatUnifier.get(OrePrefixes.dust, aMaterial.mMacerateInto)), MatUnifier.get(OrePrefixes.dustTiny, GT_Utility.selectItemInList(1, aMaterial.mMacerateInto, aMaterial.mOreByProducts)));
        GT_ModHandler.addOreWasherRecipe(GT_Utility.copyAmount(1, aCrushedStack), 1000, aCrushedPureStack/*TODO CHECK GT_OreDictUnificator.get(aPrefix == OrePrefixes.crushed ? OrePrefixes.crushedPurified : OrePrefixes.dustPure, aMaterial, 1L)*/, MatUnifier.get(OrePrefixes.dustTiny, GT_Utility.selectItemInList(0, aMaterial.mMacerateInto, aMaterial.mOreByProducts)), aDustStone);
        ...
        if ((aMaterial == Materials.Glass || aIngotStack != null) && (!aMaterial.contains(SubTag.NO_SMELTING))) {
            ...
            if ((tAmount > 0) && (tAmount <= 64) && (OrePrefixes.ingot.mMaterialAmount % 3628800L == 0L)) {
                ...
                if (!OrePrefixes.block.isIgnored(aMaterial.mSmeltInto)) {
                    GT_Values.RA.addExtruderRecipe(GT_Utility.copyAmount(9, aIngotStack), ItemList.Shape_Extruder_Block.get(0), MatUnifier.get(OrePrefixes.block, aMaterial.mSmeltInto, tAmount), 10 * tAmount, 8 * tVoltageMultiplier);
                    GT_Values.RA.addAlloySmelterRecipe(GT_Utility.copyAmount(9, aIngotStack), ItemList.Shape_Mold_Block.get(0), MatUnifier.get(OrePrefixes.block, aMaterial.mSmeltInto, tAmount), 5 * tAmount, 4 * tVoltageMultiplier);
                }
                if (aMaterial != aMaterial.mSmeltInto) {
                    GT_Values.RA.addExtruderRecipe(MatUnifier.get(OrePrefixes.dust, aMaterial, 1), ItemList.Shape_Extruder_Ingot.get(0), MatUnifier.get(OrePrefixes.ingot, aMaterial.mSmeltInto, tAmount), 10, 4 * tVoltageMultiplier);
                }
    ...
    public void addSolidRecipes(Materials aMaterial) { //Nugget & Ingot Processing
        long aMaterialMass = aMaterial.getMass();
        if (aMaterial.mFuelPower > 0) {
            GT_Values.RA.addFuel(GT_Utility.copyAmount(1, aIngotStack), null, aMaterial.mFuelPower, aMaterial.mFuelType);
        }
        if (aMaterial.mStandardMoltenFluid != null) {
            GT_Values.RA.addFluidSolidifierRecipe(ItemList.Shape_Mold_Ingot.get(0), aMaterial.getMolten(144L), aIngotStack, 32, 8);
            GT_Values.RA.addFluidSolidifierRecipe(ItemList.Shape_Mold_Nugget.get(0), aMaterial.getMolten(16L), aNuggetStack, 16, 4);
        }
    ...
    public void addDustRecipes(Materials aMaterial) { //Tiny, Small, Normal, Impure & Pure Dust Processing
        ...
        if (!aMaterial.mBlastFurnaceRequired) {
            ...
            if (!aNoSmelting) {
                GT_ModHandler.addSmeltingRecipe(GT_Utility.copyAmount(1, aTinyDustStack), MatUnifier.get(OrePrefixes.nugget, aMaterial.mSmeltInto));
            ...
            if (aMaterial.mSmeltInto != null && aMaterial.mSmeltInto.mArcSmeltInto != aMaterial) {
                GT_RecipeRegistrator.registerReverseArcSmelting(GT_Utility.copyAmount(1, aNormalDustStack), aMaterial, OrePrefixes.dust.mMaterialAmount, null, null, null);
                GT_RecipeRegistrator.registerReverseArcSmelting(GT_Utility.copyAmount(1, aSmallDustStack), aMaterial, OrePrefixes.dustSmall.mMaterialAmount, null, null, null);
                GT_RecipeRegistrator.registerReverseArcSmelting(GT_Utility.copyAmount(1, aTinyDustStack), aMaterial, OrePrefixes.dustTiny.mMaterialAmount, null, null, null);
            }
        } else {
        ...
        if (aMaterial.mFuelPower > 0) {
            GT_Values.RA.addFuel(GT_Utility.copyAmount(1, aNormalDustStack), null, aMaterial.mFuelPower, aMaterial.mFuelType);
        }
        ...
        if (aMaterial.contains(SubTag.ELECTROMAGNETIC_SEPERATION_GOLD))
            GT_Values.RA.addElectromagneticSeparatorRecipe(GT_Utility.copyAmount(1, aPureDust), MatUnifier.get(OrePrefixes.dust, aMaterial), MatUnifier.get(OrePrefixes.dustSmall, Materials.Gold), MatUnifier.get(OrePrefixes.nugget, Materials.Gold), new int[]{10000, 4000, 2000}, 400, 24);
        if (aMaterial.contains(SubTag.ELECTROMAGNETIC_SEPERATION_IRON))
            GT_Values.RA.addElectromagneticSeparatorRecipe(GT_Utility.copyAmount(1, aPureDust), MatUnifier.get(OrePrefixes.dust, aMaterial), MatUnifier.get(OrePrefixes.dustSmall, Materials.Iron), MatUnifier.get(OrePrefixes.nugget, Materials.Iron), new int[]{10000, 4000, 2000}, 400, 24);
        if (aMaterial.contains(SubTag.ELECTROMAGNETIC_SEPERATION_NEODYMIUM)) {
            GT_Values.RA.addElectromagneticSeparatorRecipe(GT_Utility.copyAmount(1, aPureDust), MatUnifier.get(OrePrefixes.dust, aMaterial), MatUnifier.get(OrePrefixes.dustSmall, Materials.Neodymium), MatUnifier.get(OrePrefixes.nugget, Materials.Neodymium), new int[]{10000, 4000, 2000}, 400, 24);
        }
        ...
        if (aDustSmeltInto != null && !aNoSmelting) {
            if (aMaterial.mBlastFurnaceRequired) {
                ...
                GT_Values.RA.addBlastRecipe(GT_Utility.copyAmount(1, aNormalDustStack), null, null, null, aMaterial.mBlastFurnaceTemp > 1750 ? MatUnifier.get(OrePrefixes.ingotHot, aMaterial.mSmeltInto, aDustSmeltInto) : GT_Utility.copyAmount(1, aDustSmeltInto), null, aBlastDuration, 120, aMaterial.mBlastFurnaceTemp);
            ...
            if (((OrePrefixes.block.isIgnored(aMaterial)) || (null == MatUnifier.get(OrePrefixes.block, aMaterial))) && (aMaterial != Materials.GraniteRed) && (aMaterial != Materials.GraniteBlack) && (aMaterial != Materials.Glass) && (aMaterial != Materials.Obsidian) && (aMaterial != Materials.Glowstone) && (aMaterial != Materials.Paper)) {
                GT_ModHandler.addCompressionRecipe(GT_Utility.copyAmount(1, aNormalDustStack), MatUnifier.get(OrePrefixes.plate, aMaterial));
            }
        }
        if (aMaterial.mMaterialList.size() > 0 && aMaterial.hasFlag(MaterialFlags.CENT.bit) && aMaterial.hasFlag(MaterialFlags.ELEC.bit)) {
            ...
            for (MaterialStack tMat : aMaterial.mMaterialList) {
                if (tMat.mAmount > 0L) {
                    if (tMat.mMaterial == Materials.Air) {
                        tDustStack = ItemList.Cell_Air.get((int)tMat.mAmount / 2);//TODO REMOVE CAST TO INT
                    } else {
    ...
    public void addMaterialSpecificRecipes() {
        ...
        //TODO FIX RICH?
        GT_Values.RA.addCentrifugeRecipe(MatUnifier.get(OrePrefixes.ore, Materials.Oilsands, 1), null, null, Materials.Oil.getFluid(/*tIsRich ? 1000L : */500L), new ItemStack(net.minecraft.init.Blocks.sand, 1, 0), null, null, null, null, null, new int[]{'?'}, /*tIsRich ? 2000 : */1000, 5);
        ...
        GT_Values.RA.addImplosionRecipe(GT_Utility.copyAmount(4, Materials.Diamond.getDust(1)), 32, ItemList.IC2_Industrial_Diamond.get(3), MatUnifier.get(OrePrefixes.dustTiny, Materials.DarkAsh, 16));

...
//        }
        ...
        // Custom Fluids go here
        GT_Mod.gregtechproxy.addFluid("animegirlbathwater", "molten.autogenerated", "Anime Girl Bathwater", Bathwater, Bathwater.mRGBa, 1, 305, GT_OreDictUnificator.get(OrePrefixes.cell, Bathwater, 1L), ItemList.Cell_Empty.get(1L, new Object[0]), 1000);
        GT_Mod.gregtechproxy.addFluid("human_sweat", "molten.autogenerated", "Human Sweat", Sweat, Sweat.mRGBa, 1, 310, GT_OreDictUnificator.get(OrePrefixes.cell, Sweat, 1L), ItemList.Cell_Empty.get(1L, new Object[0]), 1000);
        GT_Mod.gregtechproxy.addFluid("human_urine", "molten.autogenerated", "Human Urine", Urine, Urine.mRGBa, 1, 310, GT_OreDictUnificator.get(OrePrefixes.cell, Urine, 1L), ItemList.Cell_Empty.get(1L, new Object[0]), 1000);
        GT_Mod.gregtechproxy.addFluid("gg_essence", "molten.autogenerated", "Gamer girl Essence", AGEssence, AGEssence.mRGBa, 1, 310, GT_OreDictUnificator.get(OrePrefixes.cell, AGEssence, 1L), ItemList.Cell_Empty.get(1L, new Object[0]), 1000);
        GT_Mod.gregtechproxy.addFluid("pm_slurry", "molten.autogenerated", "Puella Magium Slurry", PMSlurry, PMSlurry.mRGBa, 1, 310, GT_OreDictUnificator.get(OrePrefixes.cell, PMSlurry, 1L), ItemList.Cell_Empty.get(1L, new Object[0]), 144);
        GT_Mod.gregtechproxy.addFluid("red_pm_slurry", "molten.autogenerated", "Reduced Puella Magium Slurry", RedPMSlurry, RedPMSlurry.mRGBa, 1, 310, GT_OreDictUnificator.get(OrePrefixes.cell, RedPMSlurry, 1L), ItemList.Cell_Empty.get(1L, new Object[0]), 144);
        GT_Mod.gregtechproxy.addFluid("ref_pmagium", "molten.autogenerated", "Refined Puella Magium", RefPMagium, RefPMagium.mRGBa, 1, 310, GT_OreDictUnificator.get(OrePrefixes.cell, RefPMagium, 1L), ItemList.Cell_Empty.get(1L, new Object[0]), 144);
        GT_Mod.gregtechproxy.addFluid("InfinityFuelBooster", "molten.autogenerated", "Infinity Fuel Booster", InfiniteDiesel, InfiniteDiesel.mRGBa, 1, 310, GT_OreDictUnificator.get(OrePrefixes.cell, InfiniteDiesel, 1L), ItemList.Cell_Empty.get(1L, new Object[0]), 1000);

...
public class GT_Loader_Item_Block_And_Fluid
    ...
    public void run() {
        ...
        GT_Mod.gregtechproxy.addFluid("potion.purpledrink", "Purple Drink", null, 1, 275, ItemList.Bottle_Purple_Drink.get(1L, new Object[0]), new ItemStack(Items.glass_bottle, 1), 250);
        GT_Mod.gregtechproxy.addFluid("potion.dragonblood", "Dragon Blood", null, 1, 375, ItemList.Bottle_Dragon_Blood.get(1L, new Object[0]), new ItemStack(Items.glass_bottle, 1), 250);

...
public class GT_FuelLoader
    ...
    public void run() {
        ...
        ItemList.sNitricAcid = GT_Mod.gregtechproxy.addFluid("nitricacid", "Nitric Acid ", Materials.NitricAcid, 1, 295, MatUnifier.get(OrePrefixes.cell, Materials.NitricAcid), ItemList.Cell_Empty.get(1), 1000);

...
public class GT_FuelLoader
    ...
    public void run() {
        ...
        GT_Recipe.GT_Recipe_Map.sRidiculousNaquadahReactorFuels.addRecipe(true, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.stick, GTNH_ExtraMaterials.CursedEntropy, 1L)}, new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.bolt, GTNH_ExtraMaterials.SoulGem, 1L)}, null, null, null, 0, 0, 500000);

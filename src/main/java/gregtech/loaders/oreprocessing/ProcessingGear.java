    ...
    public void registerOre(OrePrefixes aPrefix, Materials aMaterial, String aOreDictName, String aModName, ItemStack aStack) {
        switch (aPrefix) {
            case gearGt:
                ...
                if (aMaterial.mUnificatable && (aMaterial.mMaterialInto == aMaterial) && !aMaterial.contains(SubTag.NO_WORKING) && !aMaterial.contains(SubTag.NO_GEAR_RECIPE_GEN)) {
                ...
                break;
            case gearGtSmall:
                if (aMaterial.mStandardMoltenFluid != null && !aMaterial.contains(SubTag.NO_GEAR_RECIPE_GEN))
                    if (!(aMaterial == Materials.AnnealedCopper || aMaterial == Materials.WroughtIron)) {

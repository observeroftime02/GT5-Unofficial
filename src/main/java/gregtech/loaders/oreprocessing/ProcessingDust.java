        ...
        switch (aPrefix) {
            case dust:
                ...
                switch (aMaterial.mName) {
                    ...
                    case "Pentlandite":
                        ...
                        break;
                    case "Garnierite":
                        GT_ModHandler.addSmeltingRecipe(GT_Utility.copyAmount(1L, aStack), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Nickel, 1L));
                        break;
                    case "Cassiterite": case "CassiteriteSand":
                        GT_ModHandler.addSmeltingRecipe(GT_Utility.copyAmount(1L, aStack), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Tin, 1L));
                        break;
                    ...
                    case "YellowLimonite": case "BrownLimonite": case "BandedIron":
                        GT_ModHandler.addSmeltingRecipe(GT_Utility.copyAmount(1L, aStack), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Iron, 1L));
                        break;
                    case "Coal":
            ...
            case dustTiny:
                ...
                if (!aMaterial.contains(gregtech.api.enums.SubTag.NO_SMELTING)) {
                    if (aMaterial.mBlastFurnaceRequired) {
                        GT_Values.RA.addBlastRecipe(GT_Utility.copyAmount(9L, aStack), null, null, null, aMaterial.mBlastFurnaceTemp > 1750 ? GT_OreDictUnificator.get(OrePrefixes.ingotHot, aMaterial.mSmeltInto, GT_OreDictUnificator.get(OrePrefixes.ingot, aMaterial.mSmeltInto, 1L), 1L) : GT_OreDictUnificator.get(OrePrefixes.ingot, aMaterial.mSmeltInto, 1L), null, (int) Math.max(aMaterial.getMass() / 40L, 1L) * aMaterial.mBlastFurnaceTemp, 120, aMaterial.mBlastFurnaceTemp);
                        GT_ModHandler.removeFurnaceSmelting(aStack);
                    } else {

...
public class GT_CustomRecipeLoader implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.wireGt02, PMagium, 8L), CustomItemList.MicaInsulatorFoil.get(48L), Materials.Infinity.getMolten(144L), ItemList.Casing_Coil_Infinity.get(1L), 1000, 2000000);

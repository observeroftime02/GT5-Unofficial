...
public class GT_CustomRecipeLoader implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.addMultiblockChemicalRecipe( new ItemStack[]{GT_Utility.getIntegratedCircuit(2)}, new FluidStack[]{Materials.AntiKnock.getFluid(4000L), Materials.Infinity.getMolten(16L)}, new FluidStack[]{InfiniteDiesel.getFluid(4016L)}, new ItemStack[]{GT_OreDictUnificator.get(dustTiny, Materials.InfinityCatalyst, 1L)}, 120, 480);

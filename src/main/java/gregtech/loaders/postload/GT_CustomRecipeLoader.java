...
public class GT_CustomRecipeLoader implements Runnable {
    ...
    public void run() {
        ...
        GT_Values.RA.addMultiblockChemicalRecipe( new ItemStack[]{GT_Utility.getIntegratedCircuit(2), GT_OreDictUnificator.get(dustTiny, Materials.Infinity, 1L)}, new FluidStack[]{Materials.AntiKnock.getFluid(4000L)}, new FluidStack[]{InfiniteDiesel.getFluid(4016L)}, new ItemStack[]{GT_OreDictUnificator.get(dustTiny, Materials.InfinityCatalyst, 1L)}, 120, 480);
        ...
        GT_Values.RA.addCentrifugeRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, RedPMSlurry, 1L), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(dustSmall, RefPMagium, 1L), GT_OreDictUnificator.get(dustSmall, AGEssence, 1L), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, new int[]{6500,5500,0,0,0,0}, 120, 480);
        if (Loader.isModLoaded("bartworks")){

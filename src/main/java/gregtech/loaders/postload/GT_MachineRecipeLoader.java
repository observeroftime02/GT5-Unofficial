...
import static gregtech.api.enums.TC_Aspects.*;
...
//        GT_Values.RA.addAlloySmelterRecipe(MatUnifier.get(OrePrefixes.ingot, Materials.Rubber, 2), MatUnifier.get(OrePrefixes.wireGt01, Materials.Copper, 1), MatUnifier.get(OrePrefixes.cableGt01, Materials.Copper, 1), 100, 16);
        ...
        GT_Values.RA.addPrinterRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Paper, 3), FluidRegistry.getFluidStack("squidink", 144), ItemList.Tool_DataStick.getWithName(0, "With Scanned Book Data"), ItemList.Paper_Printed_Pages.get(1), 400, 2);
        ...
        for (OrePrefixes tPrefix : Arrays.asList(new OrePrefixes[]{OrePrefixes.dust, OrePrefixes.dustSmall, OrePrefixes.dustTiny})) {
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.EnderPearl), GT_OreDictUnificator.get(tPrefix, Materials.Blaze), GT_Values.NI, GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.EnderEye, tPrefix.mMaterialAmount), (int) (100L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Gold), GT_OreDictUnificator.get(tPrefix, Materials.Silver), GT_Values.NI, GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.Electrum, 2 * tPrefix.mMaterialAmount), (int) (200L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Iron, 2), GT_OreDictUnificator.get(tPrefix, Materials.Nickel), GT_Values.NI, GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.Invar, 3 * tPrefix.mMaterialAmount), (int) (300L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Iron, 4), GT_OreDictUnificator.get(tPrefix, Materials.Invar, 3), GT_OreDictUnificator.get(tPrefix, Materials.Manganese), GT_OreDictUnificator.get(tPrefix, Materials.Chrome), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.StainlessSteel, 9L * tPrefix.mMaterialAmount), (int) (900L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Iron), GT_OreDictUnificator.get(tPrefix, Materials.Aluminium), GT_OreDictUnificator.get(tPrefix, Materials.Chrome), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.Kanthal, 3 * tPrefix.mMaterialAmount), (int) (300L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Copper, 3), GT_OreDictUnificator.get(tPrefix, Materials.Barium, 2), GT_OreDictUnificator.get(tPrefix, Materials.Yttrium), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.YttriumBariumCuprate, 6L * tPrefix.mMaterialAmount), (int) (600L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Copper, 3), GT_OreDictUnificator.get(tPrefix, Materials.Zinc), GT_Values.NI, GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.Brass, 4 * tPrefix.mMaterialAmount), (int) (400L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Copper, 3), GT_OreDictUnificator.get(tPrefix, Materials.Tin), GT_Values.NI, GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.Bronze, 4 * tPrefix.mMaterialAmount), (int) (400L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Copper), GT_OreDictUnificator.get(tPrefix, Materials.Nickel, 1), GT_Values.NI, GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.Cupronickel, 2 * tPrefix.mMaterialAmount), (int) (200L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Copper), GT_OreDictUnificator.get(tPrefix, Materials.Gold, 4), GT_Values.NI, GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.RoseGold, 5 * tPrefix.mMaterialAmount), (int) (500L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Copper), GT_OreDictUnificator.get(tPrefix, Materials.Silver, 4), GT_Values.NI, GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.SterlingSilver, 5 * tPrefix.mMaterialAmount), (int) (500L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Copper, 3), GT_OreDictUnificator.get(tPrefix, Materials.Electrum, 2), GT_Values.NI, GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.BlackBronze, 5 * tPrefix.mMaterialAmount), (int) (500L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Bismuth), GT_OreDictUnificator.get(tPrefix, Materials.Brass, 4), GT_Values.NI, GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.BismuthBronze, 5 * tPrefix.mMaterialAmount), (int) (500L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.BlackBronze), GT_OreDictUnificator.get(tPrefix, Materials.Nickel), GT_OreDictUnificator.get(tPrefix, Materials.Steel, 3), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.BlackSteel, 5 * tPrefix.mMaterialAmount), (int) (500L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.SterlingSilver), GT_OreDictUnificator.get(tPrefix, Materials.BismuthBronze), GT_OreDictUnificator.get(tPrefix, Materials.BlackSteel, 4), GT_OreDictUnificator.get(tPrefix, Materials.Steel, 2), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.RedSteel, 8 * tPrefix.mMaterialAmount), (int) (800L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.RoseGold), GT_OreDictUnificator.get(tPrefix, Materials.Brass), GT_OreDictUnificator.get(tPrefix, Materials.BlackSteel, 4), GT_OreDictUnificator.get(tPrefix, Materials.Steel, 2), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.BlueSteel, 8 * tPrefix.mMaterialAmount), (int) (800L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Cobalt, 5), GT_OreDictUnificator.get(tPrefix, Materials.Chrome, 2), GT_OreDictUnificator.get(tPrefix, Materials.Nickel), GT_OreDictUnificator.get(tPrefix, Materials.Molybdenum), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.Ultimet, 9L * tPrefix.mMaterialAmount), (int) (900L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Brass, 7L), GT_OreDictUnificator.get(tPrefix, Materials.Aluminium), GT_OreDictUnificator.get(tPrefix, Materials.Cobalt), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.CobaltBrass, 9L * tPrefix.mMaterialAmount), (int) (900L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Saltpeter, 2), GT_OreDictUnificator.get(tPrefix, Materials.Sulfur), GT_OreDictUnificator.get(tPrefix, Materials.Coal, 3), GT_Values.NI, GT_Values.NF, GT_Values.NF, new ItemStack(Items.gunpowder, 6 * tPrefix.mMaterialAmount), (int) (600L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Saltpeter, 2), GT_OreDictUnificator.get(tPrefix, Materials.Sulfur), GT_OreDictUnificator.get(tPrefix, Materials.Charcoal, 3), GT_Values.NI, GT_Values.NF, GT_Values.NF, new ItemStack(Items.gunpowder, 6 * tPrefix.mMaterialAmount), (int) (600L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Saltpeter, 2), GT_OreDictUnificator.get(tPrefix, Materials.Sulfur), GT_OreDictUnificator.get(tPrefix, Materials.Carbon, 3), GT_Values.NI, GT_Values.NF, GT_Values.NF, new ItemStack(Items.gunpowder, 6 * tPrefix.mMaterialAmount), (int) (600L * tPrefix.mMaterialAmount / 3628800L), 8);

            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Indium), GT_OreDictUnificator.get(tPrefix, Materials.Gallium), GT_OreDictUnificator.get(tPrefix, Materials.Phosphor), null, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.IndiumGalliumPhosphide, 3 * tPrefix.mMaterialAmount), (int) (200L * tPrefix.mMaterialAmount / 3628800L), 8);

            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Brick), GT_OreDictUnificator.get(tPrefix, Materials.Clay), GT_Values.NI, GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.Fireclay, 2 * tPrefix.mMaterialAmount), (int) (200L * tPrefix.mMaterialAmount / 3628800L), 8);

            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Nickel), GT_OreDictUnificator.get(tPrefix, Materials.Zinc), GT_OreDictUnificator.get(tPrefix, Materials.Iron, 4), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.FerriteMixture, 6L * tPrefix.mMaterialAmount), (int) (200L * tPrefix.mMaterialAmount / 3628800L), 8);
            GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(tPrefix, Materials.Boron), GT_OreDictUnificator.get(tPrefix, Materials.Glass), GT_Values.NI, GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.getDust(Materials.BorosilicateGlass, 8 * tPrefix.mMaterialAmount), (int) (200L * tPrefix.mMaterialAmount / 3628800L), 8);
        }
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Clay), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Stone, 3), GT_Values.NI, GT_Values.NI, Materials.Water.getFluid(500), Materials.Concrete.getMolten(576), GT_Values.NI, 20, 16);
        GT_Values.RA.addMixerRecipe(new ItemStack(Items.sugar, 1), new ItemStack(Blocks.brown_mushroom, 1), new ItemStack(Items.spider_eye, 1), GT_Values.NI, GT_Values.NF, GT_Values.NF, new ItemStack(Items.fermented_spider_eye, 1), 100, 8);
        GT_Values.RA.addMixerRecipe(GT_ModHandler.getModItem(aTextAE, aTextAEMM, 1, 1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone), GT_OreDictUnificator.get(OrePrefixes.gem, Materials.NetherQuartz), GT_Values.NI, Materials.Water.getFluid(500), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Fluix, 2), 20, 16);
        GT_Values.RA.addMixerRecipe(GT_ModHandler.getModItem(aTextAE, aTextAEMM, 1, 1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone), GT_OreDictUnificator.get(OrePrefixes.gem, Materials.NetherQuartz), GT_Values.NI, GT_ModHandler.getDistilledWater(500), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Fluix, 2), 20, 16);
        ...
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.LightFuel, 5), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.HeavyFuel), null, null, null, null, GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Fuel, 6L), 16, 16);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Water, 5), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Stone), null, null, Materials.Lubricant.getFluid(20), new FluidStack(ItemList.sDrillingFluid, 5000), ItemList.Cell_Empty.get(5), 64, 16);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Lapis), null, null, null, Materials.Water.getFluid(125), FluidRegistry.getFluidStack("ic2coolant", 125), null, 256, 48);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Lapis), null, null, null, GT_ModHandler.getDistilledWater(1000), FluidRegistry.getFluidStack("ic2coolant", 1000), null, 256, 48);


        ItemStack aSulfurDust = GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur);
        ItemStack aWoodDust = GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Wood, 4);
        GT_Values.RA.addMixerRecipe(aSulfurDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sodium), aWoodDust, null, Materials.Creosote.getFluid(1000), null, ItemList.SFMixture.get(8), 1600, 16);
        GT_Values.RA.addMixerRecipe(aSulfurDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Lithium), aWoodDust, null, Materials.Creosote.getFluid(1000), null, ItemList.SFMixture.get(8), 1600, 16);
        GT_Values.RA.addMixerRecipe(aSulfurDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Caesium), aWoodDust, null, Materials.Creosote.getFluid(1000), null, ItemList.SFMixture.get(12), 1600, 16);
        GT_Values.RA.addMixerRecipe(aSulfurDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sodium), aWoodDust, null, Materials.Lubricant.getFluid(300), null, ItemList.SFMixture.get(8), 1200, 16);
        GT_Values.RA.addMixerRecipe(aSulfurDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Lithium), aWoodDust, null, Materials.Lubricant.getFluid(300), null, ItemList.SFMixture.get(8), 1200, 16);
        GT_Values.RA.addMixerRecipe(aSulfurDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Caesium), aWoodDust, null, Materials.Lubricant.getFluid(300), null, ItemList.SFMixture.get(12), 1200, 16);
        GT_Values.RA.addMixerRecipe(aSulfurDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sodium), aWoodDust, null, Materials.Glue.getFluid(333), null, ItemList.SFMixture.get(8), 800, 16);
        GT_Values.RA.addMixerRecipe(aSulfurDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Lithium), aWoodDust, null, Materials.Glue.getFluid(333), null, ItemList.SFMixture.get(8), 800, 16);
        GT_Values.RA.addMixerRecipe(aSulfurDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Caesium), aWoodDust, null, Materials.Glue.getFluid(333), null, ItemList.SFMixture.get(12), 800, 16);
        
        GT_Values.RA.addMixerRecipe(ItemList.SFMixture.get(2), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.EnderEye), null, null, Materials.Mercury.getFluid(50), null, ItemList.MSFMixture.get(2), 100, 64);
        GT_Values.RA.addMixerRecipe(ItemList.SFMixture.get(2), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Blaze), null, null, Materials.Mercury.getFluid(50), null, ItemList.MSFMixture.get(2), 100, 64);

        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Lignite), ItemList.MSFMixture.get(6),  GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Diamond), null, Materials.NitroFuel.getFluid(1000), null, ItemList.Block_MSSFUEL.get(1), 120, 96);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Charcoal), ItemList.MSFMixture.get(4), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Diamond), null, Materials.NitroFuel.getFluid(800), null, ItemList.Block_MSSFUEL.get(1), 120, 96);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Coal), ItemList.MSFMixture.get(2),     GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Diamond), null, Materials.NitroFuel.getFluid(500), null, ItemList.Block_MSSFUEL.get(1), 120, 96);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Lignite), ItemList.MSFMixture.get(6),  GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Emerald), null, Materials.NitroFuel.getFluid(1000), null, ItemList.Block_MSSFUEL.get(1), 120, 96);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Charcoal), ItemList.MSFMixture.get(4), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Emerald), null, Materials.NitroFuel.getFluid(800), null, ItemList.Block_MSSFUEL.get(1), 120, 96);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Coal), ItemList.MSFMixture.get(2),     GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Emerald), null, Materials.NitroFuel.getFluid(500), null, ItemList.Block_MSSFUEL.get(1), 120, 96);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Lignite), ItemList.MSFMixture.get(6),  GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Sapphire), null, Materials.NitroFuel.getFluid(1000), null, ItemList.Block_MSSFUEL.get(1), 120, 96);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Charcoal), ItemList.MSFMixture.get(4), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Sapphire), null, Materials.NitroFuel.getFluid(800), null, ItemList.Block_MSSFUEL.get(1), 120, 96);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Coal), ItemList.MSFMixture.get(2),     GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Sapphire), null, Materials.NitroFuel.getFluid(500), null, ItemList.Block_MSSFUEL.get(1), 120, 96);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Lignite), ItemList.MSFMixture.get(6),  GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.GreenSapphire), null, Materials.NitroFuel.getFluid(1000), null, ItemList.Block_MSSFUEL.get(1), 120, 96);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Charcoal), ItemList.MSFMixture.get(4), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.GreenSapphire), null, Materials.NitroFuel.getFluid(800), null, ItemList.Block_MSSFUEL.get(1), 120, 96);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Coal), ItemList.MSFMixture.get(2),     GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.GreenSapphire), null, Materials.NitroFuel.getFluid(500), null, ItemList.Block_MSSFUEL.get(1), 120, 96);


        if(Loader.isModLoaded("Thaumcraft")) {
            GT_Values.RA.addMixerRecipe(ItemList.SFMixture.get(2), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.InfusedAir), null, null, Materials.Mercury.getFluid(50), null, ItemList.MSFMixture.get(2), 100, 64);
            GT_Values.RA.addMixerRecipe(ItemList.SFMixture.get(2), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.InfusedEarth), null, null, Materials.Mercury.getFluid(50), null, ItemList.MSFMixture.get(2), 100, 64);
            GT_Values.RA.addMixerRecipe(ItemList.SFMixture.get(2), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.InfusedEntropy), null, null, Materials.Mercury.getFluid(50), null, ItemList.MSFMixture.get(2), 100, 64);
            GT_Values.RA.addMixerRecipe(ItemList.SFMixture.get(2), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.InfusedFire), null, null, Materials.Mercury.getFluid(50), null, ItemList.MSFMixture.get(2), 100, 64);
            GT_Values.RA.addMixerRecipe(ItemList.SFMixture.get(2), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.InfusedOrder), null, null, Materials.Mercury.getFluid(50), null, ItemList.MSFMixture.get(2), 100, 64);
            GT_Values.RA.addMixerRecipe(ItemList.SFMixture.get(2), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.InfusedWater), null, null, Materials.Mercury.getFluid(50), null, ItemList.MSFMixture.get(2), 100, 64);

            FluidStack tFD = FluidRegistry.getFluidStack("fluiddeath", 10);
            if(tFD!=null&&tFD.getFluid()!=null&&tFD.amount>0){

                GT_Values.RA.addMixerRecipe(ItemList.SFMixture.get(8), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.InfusedAir), null, null,tFD , null, ItemList.MSFMixture.get(8), 100, 64);
                GT_Values.RA.addMixerRecipe(ItemList.SFMixture.get(8), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.InfusedEarth), null, null, tFD, null, ItemList.MSFMixture.get(8), 100, 64);
                GT_Values.RA.addMixerRecipe(ItemList.SFMixture.get(8), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.InfusedEntropy), null, null, tFD, null, ItemList.MSFMixture.get(8), 100, 64);
                GT_Values.RA.addMixerRecipe(ItemList.SFMixture.get(8), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.InfusedFire), null, null, tFD, null, ItemList.MSFMixture.get(8), 100, 64);
                GT_Values.RA.addMixerRecipe(ItemList.SFMixture.get(8), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.InfusedOrder), null, null, tFD, null, ItemList.MSFMixture.get(8), 100, 64);
                GT_Values.RA.addMixerRecipe(ItemList.SFMixture.get(8), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.InfusedWater), null, null, tFD, null, ItemList.MSFMixture.get(8), 100, 64);

                GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Lignite), ItemList.MSFMixture.get(6), GT_ModHandler.getModItem("Thaumcraft", "ItemResource", 4), null, Materials.NitroFuel.getFluid(1000), null, ItemList.Block_MSSFUEL.get(1), 120, 96);
                GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Charcoal), ItemList.MSFMixture.get(4), GT_ModHandler.getModItem("Thaumcraft", "ItemResource", 4), null, Materials.NitroFuel.getFluid(800), null, ItemList.Block_MSSFUEL.get(1), 120, 96);
                GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Coal), ItemList.MSFMixture.get(2), GT_ModHandler.getModItem("Thaumcraft", "ItemResource", 4), null, Materials.NitroFuel.getFluid(500), null, ItemList.Block_MSSFUEL.get(1), 120, 96);

                GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Lignite), ItemList.MSFMixture.get(6), GT_ModHandler.getModItem("Thaumcraft", "ItemResource", 4), null, Materials.HeavyFuel.getFluid(1500), null, ItemList.Block_MSSFUEL.get(1), 120, 96);
                GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Charcoal), ItemList.MSFMixture.get(4), GT_ModHandler.getModItem("Thaumcraft", "ItemResource", 4), null, Materials.HeavyFuel.getFluid(1200), null, ItemList.Block_MSSFUEL.get(1), 120, 96);
                GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Coal), ItemList.MSFMixture.get(2), GT_ModHandler.getModItem("Thaumcraft", "ItemResource", 4), null, Materials.HeavyFuel.getFluid(750), null, ItemList.Block_MSSFUEL.get(1), 120, 96);

                GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Lignite), ItemList.MSFMixture.get(6), GT_ModHandler.getModItem("Thaumcraft", "ItemResource", 4), null, Materials.LPG.getFluid(1500), null, ItemList.Block_MSSFUEL.get(1), 120, 96);
                GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Charcoal), ItemList.MSFMixture.get(4), GT_ModHandler.getModItem("Thaumcraft", "ItemResource", 4), null, Materials.LPG.getFluid(1200), null, ItemList.Block_MSSFUEL.get(1), 120, 96);
                GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Coal), ItemList.MSFMixture.get(2), GT_ModHandler.getModItem("Thaumcraft", "ItemResource", 4), null, Materials.LPG.getFluid(750), null, ItemList.Block_MSSFUEL.get(1), 120, 96);

            }}

        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Lignite), ItemList.SFMixture.get(6), null, null, Materials.NitroFuel.getFluid(1000), null, ItemList.Block_SSFUEL.get(1), 120, 96);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Charcoal), ItemList.SFMixture.get(4), null, null, Materials.NitroFuel.getFluid(800), null, ItemList.Block_SSFUEL.get(1), 120, 96);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Coal), ItemList.SFMixture.get(2), null, null, Materials.NitroFuel.getFluid(500), null, ItemList.Block_SSFUEL.get(1), 120, 96);

        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Lignite), ItemList.SFMixture.get(6), null, null, Materials.HeavyFuel.getFluid(1500), null, ItemList.Block_SSFUEL.get(1), 120, 96);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Charcoal), ItemList.SFMixture.get(4), null, null, Materials.HeavyFuel.getFluid(1200), null, ItemList.Block_SSFUEL.get(1), 120, 96);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Coal), ItemList.SFMixture.get(2), null, null, Materials.HeavyFuel.getFluid(750), null, ItemList.Block_SSFUEL.get(1), 120, 96);

        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Lignite), ItemList.SFMixture.get(6), null, null, Materials.LPG.getFluid(1500), null, ItemList.Block_SSFUEL.get(1), 120, 96);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Charcoal), ItemList.SFMixture.get(4), null, null, Materials.LPG.getFluid(1200), null, ItemList.Block_SSFUEL.get(1), 120, 96);
        GT_Values.RA.addMixerRecipe(GT_OreDictUnificator.get(OrePrefixes.block,Materials.Coal), ItemList.SFMixture.get(2), null, null, Materials.LPG.getFluid(750), null, ItemList.Block_SSFUEL.get(1), 120, 96);
        ...
        GT_Values.RA.addFluidSolidifierRecipe(ItemList.Shape_Mold_Ball.get(0), Materials.Mercury.getFluid(1000), GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Mercury, 1), 128, 4);
        ...
        GT_Values.RA.addFluidSolidifierRecipe(ItemList.Shape_Mold_Plate.get(0), Materials.Glass.getMolten(144), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Glass), 12, 4);
        ...
        GT_Values.RA.addChemicalBathRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Wood), Materials.Water.getFluid(100), new ItemStack(Items.paper, 1, 0), GT_Values.NI, GT_Values.NI, null, 200, 4);
        GT_Values.RA.addChemicalBathRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Paper), Materials.Water.getFluid(100), new ItemStack(Items.paper, 1, 0), GT_Values.NI, GT_Values.NI, null, 100, 4);
        ...
        GT_Values.RA.addChemicalBathRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Wood), GT_ModHandler.getDistilledWater(100), new ItemStack(Items.paper, 1, 0), GT_Values.NI, GT_Values.NI, null, 200, 4);
        GT_Values.RA.addChemicalBathRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Paper), GT_ModHandler.getDistilledWater(100), new ItemStack(Items.paper, 1, 0), GT_Values.NI, GT_Values.NI, null, 100, 4);
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.BlackSteel), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Plastic), Materials.Concrete.getMolten(144), ItemList.Block_Plascrete.get(1), 200, 48);
        GT_Values.RA.addChemicalBathRecipe(GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.TungstenSteel), Materials.Concrete.getMolten(144), ItemList.Block_TungstenSteelReinforced.get(1), GT_Values.NI, GT_Values.NI, null, 200, 4);
        ...
        GT_Values.RA.addFluidExtractionRecipe(ItemList.Crop_Drop_MilkWart.get(1), GT_Values.NI, GT_ModHandler.getMilk(150), 1000, 128, 4);
        ...
        GT_Values.RA.addFluidExtractionRecipe(new ItemStack(Items.coal, 1, 1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Ash), Materials.WoodTar.getFluid(100), 1000, 128, 4);
        GT_Values.RA.addFluidExtractionRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Wood), ItemList.Plantball.get(1), Materials.Creosote.getFluid(5), 100, 16, 4);
        ...
        GT_Values.RA.addFluidExtractionRecipe(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Mercury), GT_Values.NI, Materials.Mercury.getFluid(1000), 10000, 128, 4);
        GT_Values.RA.addFluidExtractionRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Monazite), GT_Values.NI, Materials.Helium.getGas(200), 10000, 64, 64);
        ...
        GT_Values.RA.addFluidSmelterRecipe(GT_ModHandler.getModItem(aTextForestry, "phosphor", 1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Phosphor), Materials.Lava.getFluid(800), 1000, 256, 128);
        ...
        GT_Values.RA.addAutoclaveRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Carbon, 16), Materials.Palladium.getMolten(4), ItemList.RawCarbonFibers.get(8), 9000, 600, 5);
        GT_Values.RA.addAutoclaveRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Carbon, 16), Materials.Platinum.getMolten(4), ItemList.RawCarbonFibers.get(8), 5000, 600, 5);
        GT_Values.RA.addAutoclaveRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Carbon, 16), Materials.Lutetium.getMolten(4), ItemList.RawCarbonFibers.get(8), 3333, 600, 5);
        GT_Values.RA.addAutoclaveRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.NetherStar), Materials.UUMatter.getFluid(576), GT_OreDictUnificator.get(OrePrefixes.gem, Materials.NetherStar), 3333, 72000, 480);

        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.EnderPearl), OrePrefixes.circuit.get(Materials.Basic), 4, Materials.Osmium.getMolten(288), ItemList.Field_Generator_LV.get(1), 1800, 30);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.EnderEye), OrePrefixes.circuit.get(Materials.Good), 4, Materials.Osmium.getMolten(576), ItemList.Field_Generator_MV.get(1), 1800, 120);
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.NetherStar), OrePrefixes.circuit.get(Materials.Data), 4, Materials.Osmium.getMolten(2304), ItemList.Field_Generator_EV.get(1), 1800, 1920);
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Graphite, 8), GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Silicon), Materials.Glue.getFluid(250), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Graphene), 480, 240);
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.StainlessSteel, 2L), OrePrefixes.circuit.get(Materials.Good), 4,GT_Values.NF, ItemList.Schematic.get(1), 3200, 4);
        ...
        //Circuit Recipes!!!
        GT_ModHandler.addBasicShapedRecipe(ItemList.Circuit_Board_Coated.get(3), " R ","PPP"," R ",'P',GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Wood, 1),'R',ItemList.Resin.get(1));
        ...
        GT_ModHandler.addBasicShapedRecipe(ItemList.Circuit_Board_Phenolic.get(8), "PRP","PPP","PPP",'P',GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Wood, 1),'R',GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Glue, 1));
        GT_ModHandler.addBasicShapedRecipe(ItemList.Circuit_Board_Phenolic.get(32), "PRP","PPP","PPP",'P',GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Wood, 1),'R',GT_OreDictUnificator.get(OrePrefixes.cell, Materials.BisphenolA, 1));
        ...
        GT_ModHandler.addBasicShapedRecipe(ItemList.Circuit_Parts_Resistor.get(3), " P ","FCF"," P ",'P',new ItemStack(Items.paper),'F',GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Copper),'C',GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Coal));
        GT_ModHandler.addBasicShapedRecipe(ItemList.Circuit_Parts_Resistor.get(3), " P ","FCF"," P ",'P',new ItemStack(Items.paper),'F',GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Copper),'C',GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Coal));
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Coal), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Copper, 4), ItemList.Circuit_Parts_Resistor.get(12), 160, 6);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Carbon), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Electrum, 4),Materials.Plastic.getMolten(144), ItemList.Circuit_Parts_ResistorSMD.get(24), 80, 96);
        GT_Values.RA.addAlloySmelterRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Glass), ItemList.Shape_Mold_Ball.get(0), ItemList.Circuit_Parts_Glass_Tube.get(1), 160, 8);
        GT_ModHandler.addBasicShapedRecipe(ItemList.Circuit_Parts_Vacuum_Tube.get(1), "PGP","FFF","   ",'G',ItemList.Circuit_Parts_Glass_Tube.get(1),'P',new ItemStack(Items.paper),'F',GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Copper));
        GT_ModHandler.addBasicShapedRecipe(ItemList.Circuit_Parts_Vacuum_Tube.get(1), "PGP","FFF","   ",'G',ItemList.Circuit_Parts_Glass_Tube.get(1),'P',new ItemStack(Items.paper),'F',GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Copper));
        ...
        GT_ModHandler.addCraftingRecipe(ItemList.Circuit_Parts_Diode.get(1), "BG ","WDW","BG ",'B',OrePrefixes.dye.get(Materials.Black),'G',new ItemStack(Blocks.glass_pane),'D',ItemList.Circuit_Silicon_Wafer.get(1),'W',OrePrefixes.wireGt01.get(Materials.Tin));
        GT_ModHandler.addCraftingRecipe(ItemList.Circuit_Parts_Diode.get(1), "BG ","WDW","BG ",'B',OrePrefixes.dye.get(Materials.Black),'G',new ItemStack(Blocks.glass_pane),'D',ItemList.Circuit_Silicon_Wafer.get(1),'W',OrePrefixes.wireFine.get(Materials.Tin));
        GT_ModHandler.addCraftingRecipe(ItemList.Circuit_Parts_Diode.get(4), "BG ","WDW","BG ",'B',OrePrefixes.dye.get(Materials.Black),'G',new ItemStack(Blocks.glass_pane),'D', GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Gallium),'W',OrePrefixes.wireGt01.get(Materials.Tin));
        GT_ModHandler.addCraftingRecipe(ItemList.Circuit_Parts_Diode.get(4), "BG ","WDW","BG ",'B',OrePrefixes.dye.get(Materials.Black),'G',new ItemStack(Blocks.glass_pane),'D', GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Gallium),'W',OrePrefixes.wireFine.get(Materials.Tin));
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.AnnealedCopper, 4), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Gallium), Materials.Plastic.getMolten(288), ItemList.Circuit_Parts_Diode.get(16), 400, 48);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Platinum, 4), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Gallium), Materials.Plastic.getMolten(288), ItemList.Circuit_Parts_DiodeSMD.get(32), 400, 120);
        GT_ModHandler.addCraftingRecipe(ItemList.Circuit_Parts_Coil.get(2), "WWW","WDW","WWW",'G',new ItemStack(Blocks.glass_pane),'D',OrePrefixes.bolt.get(Materials.Steel),'W',OrePrefixes.wireFine.get(Materials.AnyCopper));
        GT_ModHandler.addCraftingRecipe(ItemList.Circuit_Parts_Coil.get(4), "WWW","WDW","WWW",'G',new ItemStack(Blocks.glass_pane),'D',OrePrefixes.bolt.get(Materials.NickelZincFerrite),'W',OrePrefixes.wireFine.get(Materials.AnyCopper));
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Copper, 8), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel), ItemList.Circuit_Parts_Coil.get(2), 80, 8);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Copper, 8), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.NickelZincFerrite), ItemList.Circuit_Parts_Coil.get(4), 80, 8);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.AnnealedCopper, 8), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.Steel), ItemList.Circuit_Parts_Coil.get(2), 80, 8);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.AnnealedCopper, 8), GT_OreDictUnificator.get(OrePrefixes.bolt, Materials.NickelZincFerrite), ItemList.Circuit_Parts_Coil.get(4), 80, 8);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Silicon), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Tin, 6),Materials.Plastic.getMolten(144), ItemList.Circuit_Parts_Transistor.get(8), 80, 24);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Gallium), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.AnnealedCopper, 6),Materials.Plastic.getMolten(288), ItemList.Circuit_Parts_TransistorSMD.get(32), 80, 96);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Plastic), GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Aluminium, 2), ItemList.Circuit_Parts_Capacitor.get(2), 80, 96);
        ...
        GT_Values.RA.addLaserEngraverRecipe(ItemList.Circuit_Silicon_Wafer2.get(1), GT_Utility.copyAmount(0, GT_OreDictUnificator.get(OrePrefixes.lens, Materials.EnderPearl)), ItemList.Circuit_Wafer_NAND.get(1), 500, 480, true);
        GT_Values.RA.addLaserEngraverRecipe(ItemList.Circuit_Silicon_Wafer3.get(1), GT_Utility.copyAmount(0, GT_OreDictUnificator.get(OrePrefixes.lens, Materials.EnderPearl)), ItemList.Circuit_Wafer_NAND.get(4), 200, 1920, true);
        GT_Values.RA.addLaserEngraverRecipe(ItemList.Circuit_Silicon_Wafer2.get(1), GT_Utility.copyAmount(0, GT_OreDictUnificator.get(OrePrefixes.lens, Materials.EnderEye)), ItemList.Circuit_Wafer_NOR.get(1), 500, 480, true);
        GT_Values.RA.addLaserEngraverRecipe(ItemList.Circuit_Silicon_Wafer3.get(1), GT_Utility.copyAmount(0, GT_OreDictUnificator.get(OrePrefixes.lens, Materials.EnderEye)), ItemList.Circuit_Wafer_NOR.get(4), 200, 1920, true);
        ...
        GT_Values.RA.addChemicalRecipe(ItemList.Circuit_Wafer_NanoCPU.get(1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.IndiumGalliumPhosphide), Materials.Radon.getGas(50), null, ItemList.Circuit_Wafer_QuantumCPU.get(1), 600, 1920);
        ...
        GT_Values.RA.addAutoclaveRecipe(GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.Emerald), Materials.Europium.getMolten(16), ItemList.Circuit_Parts_RawCrystalChip.get(1), 1000, 12000, 320, true);
        GT_Values.RA.addAutoclaveRecipe(GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.Olivine), Materials.Europium.getMolten(16), ItemList.Circuit_Parts_RawCrystalChip.get(1), 1000, 12000, 320, true);
        GT_Values.RA.addAutoclaveRecipe(GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.Emerald, 8), Materials.UUMatter.getFluid(100), ItemList.Tool_DataOrb.get(1), 10000, 12000, 320, true);
        GT_Values.RA.addAutoclaveRecipe(GT_OreDictUnificator.get(OrePrefixes.gemExquisite, Materials.Olivine, 8), Materials.UUMatter.getFluid(100), ItemList.Tool_DataOrb.get(1), 10000, 12000, 320, true);
        GT_ModHandler.addBasicShapelessRecipe(ItemList.Circuit_Parts_RawCrystalChip.get(9), ItemList.Circuit_Chip_CrystalCPU.get(1));
        GT_Values.RA.addBlastRecipe(ItemList.Circuit_Parts_RawCrystalChip.get(1), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Emerald), Materials.Helium.getGas(1000), null, ItemList.Circuit_Parts_Crystal_Chip_Elite.get(1), null, 900, 480, 5000);
        GT_Values.RA.addBlastRecipe(ItemList.Circuit_Parts_RawCrystalChip.get(1), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Olivine), Materials.Helium.getGas(1000), null, ItemList.Circuit_Parts_Crystal_Chip_Elite.get(1), null, 900, 480, 5000);
        GT_Values.RA.addFormingPressRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.CertusQuartz), GT_ModHandler.getModItem(aTextAE, aTextAEMM, 0, 13), GT_ModHandler.getModItem(aTextAE, aTextAEMM, 1, 16), 200, 16);
        ...
        for (Materials tMat : Materials.MATERIALS_ALL) {
            if (tMat.mStandardMoltenFluid != null && tMat.contains(SubTag.SOLDERING_MATERIAL) && !(GregTech_API.mUseOnlyGoodSolderingMaterials && !tMat.contains(SubTag.SOLDERING_MATERIAL_GOOD))) {
                ...
                //Circuit soldering
                //Integraded Circuits
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Phenolic.get(1),ItemList.Circuit_Chip_ILC.get(1),ItemList.Circuit_Parts_Resistor.get(2), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Copper, 4)},tMat.getMolten(144 * tMultiplier / 2), ItemList.Circuit_Basic.get(1), 200, 8);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Phenolic.get(1),ItemList.Circuit_Chip_ILC.get(1),ItemList.Circuit_Parts_ResistorSMD.get(2), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Copper, 4)},tMat.getMolten(144 * tMultiplier / 2), ItemList.Circuit_Basic.get(1), 200, 8);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Phenolic.get(1),ItemList.Circuit_Basic.get(3),ItemList.Circuit_Parts_Resistor.get(4), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Gold, 8)},tMat.getMolten(144 * tMultiplier / 2), ItemList.Circuit_Integrated_Good.get(1), 400, 16);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Phenolic.get(1),ItemList.Circuit_Basic.get(3),ItemList.Circuit_Parts_ResistorSMD.get(4), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Gold, 8)},tMat.getMolten(144 * tMultiplier / 2), ItemList.Circuit_Integrated_Good.get(1), 400, 16);

                //Integrated Processors
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Plastic.get(1),ItemList.Circuit_Chip_CPU.get(4),ItemList.Circuit_Parts_Resistor.get(4),ItemList.Circuit_Parts_Capacitor.get(4),ItemList.Circuit_Parts_Transistor.get(4), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Copper, 2)},tMat.getMolten(144 * tMultiplier / 2), ItemList.Circuit_Microprocessor.get(4), 200, 60);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Plastic.get(1),ItemList.Circuit_Chip_CPU.get(1),ItemList.Circuit_Parts_Resistor.get(2),ItemList.Circuit_Parts_Capacitor.get(2),ItemList.Circuit_Parts_Transistor.get(2), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.RedAlloy, 2)},tMat.getMolten(144 * tMultiplier / 2), ItemList.Circuit_Processor.get(1), 200, 60);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Plastic.get(1),ItemList.Circuit_Processor.get(2),ItemList.Circuit_Parts_Coil.get(4),ItemList.Circuit_Parts_Capacitor.get(4),ItemList.Circuit_Chip_Ram.get(4), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.RedAlloy, 12)},tMat.getMolten(144 * tMultiplier), ItemList.Circuit_Computer.get(1), 400, 90);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Plastic.get(1),ItemList.Circuit_Processor.get(1),ItemList.Circuit_Chip_NAND.get(32),ItemList.Circuit_Chip_Ram.get(4), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.RedAlloy, 8), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Plastic, 4)},tMat.getMolten(144 * tMultiplier), ItemList.Tool_DataStick.get(1), 400, 90);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Plastic.get(2),ItemList.Circuit_Advanced.get(3),ItemList.Circuit_Parts_Diode.get(4),ItemList.Circuit_Chip_Ram.get(4), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Electrum, 6)},tMat.getMolten(144 * tMultiplier), ItemList.Circuit_Data.get(1), 400, 90);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Aluminium),ItemList.Circuit_Data.get(4),ItemList.Circuit_Parts_Coil.get(4),ItemList.Circuit_Parts_Capacitor.get(24),ItemList.Circuit_Chip_Ram.get(16), GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.AnnealedCopper, 12)},tMat.getMolten(144 * tMultiplier*2), ItemList.Circuit_Elite.get(1), 1600, 480);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Plastic.get(1),ItemList.Circuit_Chip_CPU.get(4),ItemList.Circuit_Parts_ResistorSMD.get(4),ItemList.Circuit_Parts_CapacitorSMD.get(4),ItemList.Circuit_Parts_TransistorSMD.get(4), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Copper, 2)},tMat.getMolten(144 * tMultiplier / 2), ItemList.Circuit_Microprocessor.get(4), 200, 60);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Plastic.get(1),ItemList.Circuit_Chip_CPU.get(1),ItemList.Circuit_Parts_ResistorSMD.get(2),ItemList.Circuit_Parts_CapacitorSMD.get(2),ItemList.Circuit_Parts_TransistorSMD.get(2), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.RedAlloy, 2)},tMat.getMolten(144 * tMultiplier / 2), ItemList.Circuit_Processor.get(1), 200, 60);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Plastic.get(1),ItemList.Circuit_Processor.get(2),ItemList.Circuit_Parts_Coil.get(4),ItemList.Circuit_Parts_CapacitorSMD.get(4),ItemList.Circuit_Chip_Ram.get(4), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.RedAlloy, 12)},tMat.getMolten(144 * tMultiplier), ItemList.Circuit_Computer.get(1), 400, 80);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Plastic.get(2),ItemList.Circuit_Advanced.get(3),ItemList.Circuit_Parts_DiodeSMD.get(4),ItemList.Circuit_Chip_Ram.get(4), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Electrum, 6)},tMat.getMolten(144 * tMultiplier), ItemList.Circuit_Data.get(1), 400, 90);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Aluminium),ItemList.Circuit_Data.get(4),ItemList.Circuit_Parts_Coil.get(4),ItemList.Circuit_Parts_CapacitorSMD.get(24),ItemList.Circuit_Chip_Ram.get(16), GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.AnnealedCopper, 12)},tMat.getMolten(144 * tMultiplier*2), ItemList.Circuit_Elite.get(1), 1600, 480);
                //Nanotech Circuits
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Epoxy.get(1),ItemList.Circuit_Chip_NanoCPU.get(1),ItemList.Circuit_Parts_ResistorSMD.get(2),ItemList.Circuit_Parts_CapacitorSMD.get(2),ItemList.Circuit_Parts_TransistorSMD.get(2), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Electrum, 2)},tMat.getMolten(144 * tMultiplier / 2), ItemList.Circuit_Nanoprocessor.get(1), 200, 600);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Epoxy.get(1),ItemList.Circuit_Nanoprocessor.get(2),ItemList.Circuit_Parts_Coil.get(4),ItemList.Circuit_Parts_CapacitorSMD.get(4),ItemList.Circuit_Chip_Ram.get(4), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Electrum, 6)},tMat.getMolten(144 * tMultiplier), ItemList.Circuit_Nanocomputer.get(1), 400, 600);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Epoxy.get(1),ItemList.Circuit_Nanoprocessor.get(1),ItemList.Circuit_Chip_Ram.get(4),ItemList.Circuit_Chip_NOR.get(32),ItemList.Circuit_Chip_NAND.get(64), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Platinum, 32)},tMat.getMolten(144 * tMultiplier), ItemList.Tool_DataOrb.get(1), 400, 1200);
                ...
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Aluminium),ItemList.Circuit_Elitenanocomputer.get(4),ItemList.Circuit_Parts_Coil.get(4),ItemList.Circuit_Parts_CapacitorSMD.get(24),ItemList.Circuit_Chip_Ram.get(16), GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.AnnealedCopper, 12)},tMat.getMolten(144 * tMultiplier*2), ItemList.Circuit_Master.get(1), 1600, 1920);
                //Quantum Circuits
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Fiberglass.get(1),ItemList.Circuit_Chip_QuantumCPU.get(1),ItemList.Circuit_Chip_NanoCPU.get(1),ItemList.Circuit_Parts_CapacitorSMD.get(2),ItemList.Circuit_Parts_TransistorSMD.get(2), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Platinum, 2)},tMat.getMolten(144 * tMultiplier / 2), ItemList.Circuit_Quantumprocessor.get(1), 200, 2400);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Fiberglass.get(1),ItemList.Circuit_Quantumprocessor.get(2),ItemList.Circuit_Parts_Coil.get(4),ItemList.Circuit_Parts_CapacitorSMD.get(4),ItemList.Circuit_Chip_Ram.get(4), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Platinum, 6)},tMat.getMolten(144 * tMultiplier), ItemList.Circuit_Quantumcomputer.get(1), 400, 2400);
                ...
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Aluminium),ItemList.Circuit_Masterquantumcomputer.get(4),ItemList.Circuit_Parts_Coil.get(4),ItemList.Circuit_Parts_CapacitorSMD.get(24),ItemList.Circuit_Chip_Ram.get(16), GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.AnnealedCopper, 12)},tMat.getMolten(144 * tMultiplier*2), ItemList.Circuit_Quantummainframe.get(1), 1600, 7680);
                //Crystallized Circuits
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Multifiberglass.get(1),ItemList.Circuit_Chip_CrystalCPU.get(1),ItemList.Circuit_Chip_NanoCPU.get(1),ItemList.Circuit_Parts_CapacitorSMD.get(2),ItemList.Circuit_Parts_TransistorSMD.get(2), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.NiobiumTitanium, 2)},tMat.getMolten(144 * tMultiplier / 2), ItemList.Circuit_Crystalprocessor.get(1), 200, 9600);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Multifiberglass.get(1),ItemList.Circuit_Crystalprocessor.get(2),ItemList.Circuit_Parts_Coil.get(4),ItemList.Circuit_Parts_CapacitorSMD.get(4),ItemList.Circuit_Chip_Ram.get(4), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.NiobiumTitanium, 6)},tMat.getMolten(144 * tMultiplier), ItemList.Circuit_Crystalcomputer.get(1), 400, 9600);
                ...
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Aluminium),ItemList.Circuit_Ultimatecrystalcomputer.get(4),ItemList.Circuit_Parts_Coil.get(4),ItemList.Circuit_Parts_CapacitorSMD.get(24),ItemList.Circuit_Chip_Ram.get(16), GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Superconductor, 12)},tMat.getMolten(144 * tMultiplier*2), ItemList.Circuit_Crystalmainframe.get(1), 1600, 30720);
                //Wetware Circuits
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Chip_NeuroCPU.get(1),ItemList.Circuit_Chip_CrystalCPU.get(1), ItemList.Circuit_Chip_NanoCPU.get(1), ItemList.Circuit_Parts_CapacitorSMD.get(2),ItemList.Circuit_Parts_TransistorSMD.get(2), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.YttriumBariumCuprate, 2)},tMat.getMolten(144 * tMultiplier / 2), ItemList.Circuit_Neuroprocessor.get(1), 200, 38400);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Wetware.get(1),ItemList.Circuit_Neuroprocessor.get(2),ItemList.Circuit_Parts_Coil.get(4),ItemList.Circuit_Parts_CapacitorSMD.get(4),ItemList.Circuit_Chip_Ram.get(4), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.YttriumBariumCuprate, 6)},tMat.getMolten(144 * tMultiplier), ItemList.Circuit_Wetwarecomputer.get(1), 400, 38400);
                ...
                //SoC
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Plastic.get(1),ItemList.Circuit_Chip_SoC.get(4), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Copper, 2)},tMat.getMolten(144 * tMultiplier / 2), ItemList.Circuit_Microprocessor.get(4), 50, 600);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Plastic.get(1),ItemList.Circuit_Chip_SoC.get(1), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.RedAlloy, 2)},tMat.getMolten(144 * tMultiplier / 2), ItemList.Circuit_Processor.get(1), 50, 2400);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Epoxy.get(1),ItemList.Circuit_Chip_SoC2.get(1), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Electrum, 2)},tMat.getMolten(144 * tMultiplier / 2), ItemList.Circuit_Nanoprocessor.get(1), 50, 9600);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Fiberglass.get(1),ItemList.Circuit_Chip_SoC2.get(1), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Platinum, 2)},tMat.getMolten(144 * tMultiplier / 2), ItemList.Circuit_Quantumprocessor.get(1), 50, 38400);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Multifiberglass.get(1),ItemList.Circuit_Chip_CrystalSoC.get(1), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.NiobiumTitanium, 2)},tMat.getMolten(144 * tMultiplier / 2), ItemList.Circuit_Crystalprocessor.get(1), 50, 153600);

                //Lapoorbs
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Fiberglass.get(1),ItemList.Circuit_Chip_PIC.get(4), ItemList.Circuit_Parts_Crystal_Chip_Master.get(18),ItemList.Circuit_Chip_NanoCPU.get(1), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Platinum, 16)},tMat.getMolten(144 * tMultiplier), ItemList.Energy_LapotronicOrb.get(1), 512, 1024);
                GT_Values.RA.addCircuitAssemblerRecipe(new ItemStack[]{ItemList.Circuit_Board_Fiberglass.get(1),ItemList.Circuit_Chip_HPIC.get(4), ItemList.Energy_LapotronicOrb.get(8),ItemList.Circuit_Chip_QuantumCPU.get(1), GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Platinum, 16), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Europium, 4)},tMat.getMolten(144 * tMultiplier), ItemList.Energy_LapotronicOrb2.get(1), 1024, 4096);

                for (ItemStack tPlate : new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iron), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.WroughtIron), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium)}) {
        ...
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Silicon, 32), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Gallium), null, null, ItemList.Circuit_Silicon_Ingot.get(1), null, 9000, 120, 1784);
        ...
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.block, Materials.Silicon, 16), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Naquadah), Materials.Argon.getGas(8000), null, ItemList.Circuit_Silicon_Ingot3.get(1), null, 1500, 1920, 5400);
        GT_Values.RA.addCutterRecipe(ItemList.Circuit_Silicon_Ingot3.get(1), ItemList.Circuit_Silicon_Wafer3.get(64),null, 800, 384);


        GT_Values.RA.addAssemblerRecipe(new ItemStack(Blocks.redstone_torch, 2, 32767), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone), Materials.Concrete.getMolten(144), new ItemStack(Items.repeater, 1, 0), 800, 1);
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Paper, 8), new ItemStack(Items.compass, 1, 32767), GT_Values.NF, new ItemStack(Items.map, 1, 0), 100, 8);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Tantalum), GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Manganese), Materials.Plastic.getMolten(144), ItemList.Battery_RE_ULV_Tantalum.get(8), 100, 4);
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.CertusQuartz), new ItemStack(Blocks.sand, 1, 32767), GT_Values.NF, GT_ModHandler.getModItem(aTextAE, "item.ItemCrystalSeed", 2, 0), 64, 8);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.NetherQuartz), new ItemStack(Blocks.sand, 1, 32767), GT_Values.NF, GT_ModHandler.getModItem(aTextAE, "item.ItemCrystalSeed", 2, 600), 64, 8);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Fluix), new ItemStack(Blocks.sand, 1, 32767), GT_Values.NF, GT_ModHandler.getModItem(aTextAE, "item.ItemCrystalSeed", 2, 1200), 64, 8);
        ...
        GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem(aTextForestry, "sturdyMachine", 1, 0), GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Diamond, 4), Materials.Water.getFluid(5000), ItemList.FR_Casing_Hardened.get(1), 64, 32);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Bronze, 8), ItemList.Circuit_Integrated.getWithDamage(0, 8), GT_Values.NF, ItemList.FR_Casing_Sturdy.get(1), 32, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Tin), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone, 6L), Materials.Water.getFluid(1000), GT_ModHandler.getModItem(aTextForestry, "chipsets", 1, 0), 16, 8);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Bronze, 3), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone, 6L), Materials.Water.getFluid(1000), GT_ModHandler.getModItem(aTextForestry, "chipsets", 1, 1), 32, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Iron, 3), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone, 6L), Materials.Water.getFluid(1000), GT_ModHandler.getModItem(aTextForestry, "chipsets", 1, 2), 48, 24);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.WroughtIron, 3), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone, 6L), Materials.Water.getFluid(1000), GT_ModHandler.getModItem(aTextForestry, "chipsets", 1, 2), 48, 24);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Gold, 3), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone, 6L), Materials.Water.getFluid(1000), GT_ModHandler.getModItem(aTextForestry, "chipsets", 1, 3), 64, 32);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood), new ItemStack(Blocks.wool, 1, 32767), Materials.Creosote.getFluid(1000), new ItemStack(Blocks.torch, 6, 0), 400, 1);
        GT_Values.RA.addAssemblerRecipe(GT_ModHandler.getModItem(aTextForestry, "craftingMaterial", 5, 1), ItemList.Circuit_Integrated.getWithDamage(0, 5), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.gem, Materials.EnderPearl), 64, 8);
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Rubber, 3), ItemList.RawCarbonMesh.get(3), Materials.Glue.getFluid(300), ItemList.Duct_Tape.get(1), 100, 64);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Paper, 3), new ItemStack(Items.leather, 1, 32767), Materials.Glue.getFluid(20), new ItemStack(Items.book, 1, 0), 32, 8);
        ...
        ItemStack aRedstoneDustx2 = GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone, 2);
        FluidStack aMoltenGlass =  Materials.Glass.getMolten(72);
        GT_Values.RA.addAssemblerRecipe(aRedstoneDustx2, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Copper, 5), aMoltenGlass, GT_ModHandler.getModItem(aTextForestry, "thermionicTubes", 4, 0), 64, 32);
        GT_Values.RA.addAssemblerRecipe(aRedstoneDustx2, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.AnnealedCopper, 5), aMoltenGlass, GT_ModHandler.getModItem(aTextForestry, "thermionicTubes", 4, 0), 64, 32);
        GT_Values.RA.addAssemblerRecipe(aRedstoneDustx2, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Tin, 5), aMoltenGlass, GT_ModHandler.getModItem(aTextForestry, "thermionicTubes", 4, 1), 64, 32);
        GT_Values.RA.addAssemblerRecipe(aRedstoneDustx2, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Bronze, 5), aMoltenGlass, GT_ModHandler.getModItem(aTextForestry, "thermionicTubes", 4, 2), 64, 32);
        GT_Values.RA.addAssemblerRecipe(aRedstoneDustx2, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Iron, 5), aMoltenGlass, GT_ModHandler.getModItem(aTextForestry, "thermionicTubes", 4, 3), 64, 32);
        GT_Values.RA.addAssemblerRecipe(aRedstoneDustx2, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.WroughtIron, 5), aMoltenGlass, GT_ModHandler.getModItem(aTextForestry, "thermionicTubes", 4, 3), 64, 32);
        GT_Values.RA.addAssemblerRecipe(aRedstoneDustx2, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Gold, 5), aMoltenGlass, GT_ModHandler.getModItem(aTextForestry, "thermionicTubes", 4, 4), 64, 32);
        GT_Values.RA.addAssemblerRecipe(aRedstoneDustx2, GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Diamond, 5), aMoltenGlass, GT_ModHandler.getModItem(aTextForestry, "thermionicTubes", 4, 5), 64, 32);
        GT_Values.RA.addAssemblerRecipe(aRedstoneDustx2, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Blaze, 5), aMoltenGlass, GT_ModHandler.getModItem(aTextForestry, "thermionicTubes", 4, 7), 64, 32);
        GT_Values.RA.addAssemblerRecipe(aRedstoneDustx2, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Rubber, 5), aMoltenGlass, GT_ModHandler.getModItem(aTextForestry, "thermionicTubes", 4, 8), 64, 32);
        GT_Values.RA.addAssemblerRecipe(aRedstoneDustx2, GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Emerald, 5), aMoltenGlass, GT_ModHandler.getModItem(aTextForestry, "thermionicTubes", 4, 9), 64, 32);
        GT_Values.RA.addAssemblerRecipe(aRedstoneDustx2, GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Apatite, 5), aMoltenGlass, GT_ModHandler.getModItem(aTextForestry, "thermionicTubes", 4, 10), 64, 32);
        GT_Values.RA.addAssemblerRecipe(aRedstoneDustx2, GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Lapis, 5), aMoltenGlass, GT_ModHandler.getModItem(aTextForestry, "thermionicTubes", 4, 11), 64, 32);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 2), new ItemStack(Items.iron_door, 1), ItemList.Cover_Shutter.get(2), 800, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iron, 2), new ItemStack(Items.iron_door, 1), ItemList.Cover_Shutter.get(2), 800, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.WroughtIron, 2), new ItemStack(Items.iron_door, 1), ItemList.Cover_Shutter.get(2), 800, 16);
        ...
        GT_Values.RA.addChemicalRecipe(new ItemStack(Items.sugar), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Plastic), new FluidStack(ItemList.sToluene, 133), GT_Values.NF, ItemList.GelledToluene.get(2), 140, 192);
        ...
        GT_Values.RA.addChemicalRecipe(ItemList.GelledToluene.get(4), GT_Values.NI, new FluidStack(ItemList.sNitrationMixture,200), Materials.DilutedSulfuricAcid.getFluid(200), ItemList.IndustrialExplosive.get(1), 80, 480);

        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 2),           GT_Utility.getIntegratedCircuit(4), Materials.NaturalGas.getGas(16000),         Materials.RefineryGas.getGas(16000),          GT_OreDictUnificator.get(OrePrefixes.cell, Materials.HydricSulfide), ItemList.Cell_Empty.get(1), 160);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.NaturalGas, 16),       GT_Utility.getIntegratedCircuit(4), Materials.Hydrogen.getGas(2000),             Materials.HydricSulfide.getGas(1000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.RefineryGas, 16), 160);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 2),           GT_Utility.getIntegratedCircuit(4), Materials.SulfuricGas.getGas(16000),         Materials.RefineryGas.getGas(16000),          GT_OreDictUnificator.get(OrePrefixes.cell, Materials.HydricSulfide), ItemList.Cell_Empty.get(1), 160);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.SulfuricGas, 16),       GT_Utility.getIntegratedCircuit(4), Materials.Hydrogen.getGas(2000),             Materials.HydricSulfide.getGas(1000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.RefineryGas, 16), 160);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 2),           GT_Utility.getIntegratedCircuit(4), Materials.SulfuricNaphtha.getFluid(12000),   Materials.Naphtha.getFluid(12000),    GT_OreDictUnificator.get(OrePrefixes.cell, Materials.HydricSulfide), ItemList.Cell_Empty.get(1), 160);
        ...
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 2),           GT_Utility.getIntegratedCircuit(4), Materials.SulfuricHeavyFuel.getFluid(8000),  Materials.HeavyFuel.getFluid(8000),   GT_OreDictUnificator.get(OrePrefixes.cell, Materials.HydricSulfide), ItemList.Cell_Empty.get(1), 160);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.SulfuricHeavyFuel, 8),  GT_Utility.getIntegratedCircuit(4), Materials.Hydrogen.getGas(2000),             Materials.HydricSulfide.getGas(1000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.HeavyFuel, 8), 160);

        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Saltpeter), null, Materials.Naphtha.getFluid(576), Materials.Polycaprolactam.getMolten(1296), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Potassium), 640);
        GT_Values.RA.addWiremillRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Polycaprolactam), new ItemStack(Items.string, 32), 80, 48);
        ...
        GT_Values.RA.addBrewingRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Talc), FluidRegistry.getFluid("oil"), FluidRegistry.getFluid("lubricant"), false);
        GT_Values.RA.addBrewingRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Soapstone), FluidRegistry.getFluid("oil"), FluidRegistry.getFluid("lubricant"), false);
        GT_Values.RA.addBrewingRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone), FluidRegistry.getFluid("oil"), FluidRegistry.getFluid("lubricant"), false);
        GT_Values.RA.addBrewingRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Talc), FluidRegistry.getFluid("creosote"), FluidRegistry.getFluid("lubricant"), false);
        GT_Values.RA.addBrewingRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Soapstone), FluidRegistry.getFluid("creosote"), FluidRegistry.getFluid("lubricant"), false);
        GT_Values.RA.addBrewingRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone), FluidRegistry.getFluid("creosote"), FluidRegistry.getFluid("lubricant"), false);
        GT_Values.RA.addBrewingRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Talc), FluidRegistry.getFluid("seedoil"), FluidRegistry.getFluid("lubricant"), false);
        GT_Values.RA.addBrewingRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Soapstone), FluidRegistry.getFluid("seedoil"), FluidRegistry.getFluid("lubricant"), false);
        GT_Values.RA.addBrewingRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone), FluidRegistry.getFluid("seedoil"), FluidRegistry.getFluid("lubricant"), false);

        for (Fluid tFluid : new Fluid[]{FluidRegistry.WATER, GT_ModHandler.getDistilledWater(1).getFluid()}) {
            ItemStack aCalciteDust = GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Calcite);
            ItemStack aCalciumDust = GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Calcium);
            ItemStack aApatiteDust = GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Apatite);
            ItemStack aGlauconiteDust = GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Glauconite);
            ItemStack aGlauconiteSandDust = GT_OreDictUnificator.get(OrePrefixes.dust, Materials.GlauconiteSand);
            FluidStack aFluidStack = new FluidStack(tFluid, 1000);
            GT_Values.RA.addChemicalRecipe(aCalciteDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(2), 200);
            GT_Values.RA.addChemicalRecipe(aCalciteDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Phosphorus), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(3), 300);
            GT_Values.RA.addChemicalRecipe(aCalciteDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Phosphate), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(2), 200);
            GT_Values.RA.addChemicalRecipe(aCalciteDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Ash, 3), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(1), 100);
            GT_Values.RA.addChemicalRecipe(aCalciteDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.DarkAsh), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(1), 100);
            GT_Values.RA.addChemicalRecipe(aCalciumDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(3), 300);
            GT_Values.RA.addChemicalRecipe(aCalciumDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Phosphorus), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(4), 400);
            GT_Values.RA.addChemicalRecipe(aCalciumDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Phosphate), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(3), 300);
            GT_Values.RA.addChemicalRecipe(aCalciumDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Ash, 3), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(2), 200);
            GT_Values.RA.addChemicalRecipe(aCalciumDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.DarkAsh), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(2), 200);
            GT_Values.RA.addChemicalRecipe(aApatiteDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(3), 300);
            GT_Values.RA.addChemicalRecipe(aApatiteDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Phosphorus), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(4), 400);
            GT_Values.RA.addChemicalRecipe(aApatiteDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Phosphate), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(3), 300);
            GT_Values.RA.addChemicalRecipe(aApatiteDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Ash, 3), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(2), 200);
            GT_Values.RA.addChemicalRecipe(aApatiteDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.DarkAsh), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(2), 200);
            GT_Values.RA.addChemicalRecipe(aGlauconiteDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(3), 300);
            GT_Values.RA.addChemicalRecipe(aGlauconiteDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Phosphorus), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(4), 400);
            GT_Values.RA.addChemicalRecipe(aGlauconiteDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Phosphate), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(3), 300);
            GT_Values.RA.addChemicalRecipe(aGlauconiteDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Ash, 3), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(2), 200);
            GT_Values.RA.addChemicalRecipe(aGlauconiteDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.DarkAsh), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(2), 200);
            GT_Values.RA.addChemicalRecipe(aGlauconiteSandDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(3), 300);
            GT_Values.RA.addChemicalRecipe(aGlauconiteSandDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Phosphorus), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(4), 400);
            GT_Values.RA.addChemicalRecipe(aGlauconiteSandDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Phosphate), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(3), 300);
            GT_Values.RA.addChemicalRecipe(aGlauconiteSandDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Ash, 3), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(2), 200);
            GT_Values.RA.addChemicalRecipe(aGlauconiteSandDust, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.DarkAsh), aFluidStack, GT_Values.NF, ItemList.Fertilizer.get(2), 200);
        }
        ...
        GT_ModHandler.addExtractionRecipe(new ItemStack(Items.slime_ball, 1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.RawRubber, 2));
        GT_ModHandler.addExtractionRecipe(ItemList.Resin.get(1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.RawRubber, 3));
        ...
        GT_ModHandler.addCompressionRecipe(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.CertusQuartz, 4), GT_ModHandler.getModItem(aTextAE, "tile.BlockQuartz", 1));
        ...
        GT_ModHandler.addCompressionRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Glowstone, 4), new ItemStack(Blocks.glowstone, 1));
        ...
        GT_Values.RA.addCutterRecipe(GT_OreDictUnificator.get(OrePrefixes.block, Materials.Graphite), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Graphite, 9L), GT_Values.NI, 500, 48);
        GT_ModHandler.removeFurnaceSmelting(GT_OreDictUnificator.get(OrePrefixes.ore, Materials.Graphite));
        GT_ModHandler.addSmeltingRecipe(GT_OreDictUnificator.get(OrePrefixes.ore, Materials.Graphite), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Graphite));
        GT_ModHandler.removeFurnaceSmelting(GT_OreDictUnificator.get(OrePrefixes.oreBlackgranite, Materials.Graphite));
        GT_ModHandler.addSmeltingRecipe(GT_OreDictUnificator.get(OrePrefixes.oreBlackgranite, Materials.Graphite), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Graphite));
        GT_ModHandler.removeFurnaceSmelting(GT_OreDictUnificator.get(OrePrefixes.oreEndstone, Materials.Graphite));
        GT_ModHandler.addSmeltingRecipe(GT_OreDictUnificator.get(OrePrefixes.oreEndstone, Materials.Graphite), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Graphite));
        GT_ModHandler.removeFurnaceSmelting(GT_OreDictUnificator.get(OrePrefixes.oreNetherrack, Materials.Graphite));
        GT_ModHandler.addSmeltingRecipe(GT_OreDictUnificator.get(OrePrefixes.oreNetherrack, Materials.Graphite), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Graphite));
        GT_ModHandler.removeFurnaceSmelting(GT_OreDictUnificator.get(OrePrefixes.oreRedgranite, Materials.Graphite));
        GT_ModHandler.addSmeltingRecipe(GT_OreDictUnificator.get(OrePrefixes.oreRedgranite, Materials.Graphite), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Graphite));
        ...
        GT_ModHandler.addPulverisationRecipe(GT_ModHandler.getModItem("Railcraft", "cube.crushed.obsidian", 1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Obsidian), GT_Values.NI, 0, true);
        GT_ModHandler.addPulverisationRecipe(new ItemStack(Items.flint, 1, 32767), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Flint, 4), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Flint), 40, true);
        ...
        GT_Values.RA.addForgeHammerRecipe(new ItemStack(Blocks.hardened_clay, 1, 0), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Clay), 10, 16);
        GT_Values.RA.addForgeHammerRecipe(new ItemStack(Blocks.stained_hardened_clay, 1, 32767), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Clay), 10, 16);
        ...
        GT_Values.RA.addForgeHammerRecipe(new ItemStack(Blocks.stained_glass, 1, 32767), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Glass), 10, 16);
        GT_Values.RA.addForgeHammerRecipe(new ItemStack(Blocks.glass, 1, 32767), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Glass), 10, 16);
        GT_Values.RA.addForgeHammerRecipe(new ItemStack(Blocks.stained_glass_pane, 1, 32767), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Glass, 3), 10, 16);
        GT_Values.RA.addForgeHammerRecipe(new ItemStack(Blocks.glass_pane, 1, 32767), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Glass, 3), 10, 16);
        ...
        GT_Values.RA.addAlloySmelterRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Silicon), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.RedAlloy), 400, 24);

        if (Loader.isModLoaded("EnderIO")) {
            /*TODO
            GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel, 3), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Silicon), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.ElectricalSteel, 4), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.DarkAsh, 2), (int) Math.max(Materials.ElectricalSteel.getMass() / 40L, 1) * Materials.ElectricalSteel.mBlastFurnaceTemp, 120, Materials.ElectricalSteel.mBlastFurnaceTemp);
            GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Gold), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Glowstone), Materials.Redstone.getMolten(144), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.EnergeticAlloy), null, Materials.EnergeticAlloy.mBlastFurnaceTemp / 10, 120, Materials.EnergeticAlloy.mBlastFurnaceTemp);
            GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.EnergeticAlloy), GT_OreDictUnificator.get(OrePrefixes.gem, Materials.EnderPearl), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.PhasedGold), null, Materials.VibrantAlloy.mBlastFurnaceTemp / 10, 480, Materials.VibrantAlloy.mBlastFurnaceTemp);
            GT_Values.RA.addAlloySmelterRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Iron), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.ConductiveIron), 400, 24);
            GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Iron), GT_OreDictUnificator.get(OrePrefixes.gem, Materials.EnderPearl), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.PhasedIron), null, Materials.PulsatingIron.mBlastFurnaceTemp / 10, 120, Materials.PulsatingIron.mBlastFurnaceTemp);
            GT_Values.RA.addAlloySmelterRecipe(new ItemStack(Blocks.soul_sand), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Gold), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Soularium), 400, 24);
            */
        }

        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Tungsten), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.TungstenSteel, 2), GT_Values.NI, (int) Math.max(Materials.TungstenSteel.getMass() / 80L, 1) * Materials.TungstenSteel.mBlastFurnaceTemp, 480, Materials.TungstenSteel.mBlastFurnaceTemp);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Tungsten), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Carbon), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.TungstenCarbide, 2), GT_Values.NI, (int) Math.max(Materials.TungstenCarbide.getMass() / 40L, 1) * Materials.TungstenCarbide.mBlastFurnaceTemp, 480, Materials.TungstenCarbide.mBlastFurnaceTemp);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Vanadium, 3), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Gallium), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.VanadiumGallium, 4), GT_Values.NI, (int) Math.max(Materials.VanadiumGallium.getMass() / 40L, 1) * Materials.VanadiumGallium.mBlastFurnaceTemp, 480, Materials.VanadiumGallium.mBlastFurnaceTemp);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Niobium), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Titanium), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.NiobiumTitanium, 2), GT_Values.NI, (int) Math.max(Materials.NiobiumTitanium.getMass() / 80L, 1) * Materials.NiobiumTitanium.mBlastFurnaceTemp, 480, Materials.NiobiumTitanium.mBlastFurnaceTemp);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Nickel, 4), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Chrome), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Nichrome, 5), GT_Values.NI, (int) Math.max(Materials.Nichrome.getMass() / 32L, 1) * Materials.Nichrome.mBlastFurnaceTemp, 480, Materials.Nichrome.mBlastFurnaceTemp);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Ruby), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Aluminium, 3), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.DarkAsh), 400, 100, 1200);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Ruby), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Aluminium, 3), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.DarkAsh), 320, 100, 1200);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.GreenSapphire), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Aluminium, 3), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.DarkAsh), 400, 100, 1200);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.GreenSapphire), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Aluminium, 3), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.DarkAsh), 320, 100, 1200);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sapphire), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Aluminium, 3), GT_Values.NI, 400, 100, 1200);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Sapphire), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Aluminium, 3), GT_Values.NI, 320, 100, 1200);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Ilmenite), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Carbon), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.WroughtIron, 4), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Rutile, 4), 800, 500, 1700);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Ilmenite), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Carbon), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.WroughtIron, 4), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Rutile, 4), 800, 500, 1700);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Magnesium, 2), GT_Values.NI, Materials.Titaniumtetrachloride.getFluid(1000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Titanium), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Magnesiumchloride, 2), 800, 480, Materials.Titanium.mBlastFurnaceTemp + 200);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Iron), GT_Values.NI, Materials.Oxygen.getGas(1000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel), Materials.Ash.getDustTiny(1), 500, 120, 1000);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.PigIron), GT_Values.NI, Materials.Oxygen.getGas(1000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel), Materials.Ash.getDustTiny(1), 100, 120, 1000);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.WroughtIron), GT_Values.NI, Materials.Oxygen.getGas(1000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Steel), Materials.Ash.getDustTiny(1), 100, 120, 1000);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.MeteoricIron), GT_Values.NI, Materials.Oxygen.getGas(1000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.MeteoricSteel), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.DarkAsh), 500, 120, 1200);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Copper), GT_Values.NI, Materials.Oxygen.getGas(1000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.AnnealedCopper), GT_Values.NI, 500, 120, 1200);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Copper), GT_Values.NI, Materials.Oxygen.getGas(1000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.AnnealedCopper), GT_Values.NI, 500, 120, 1200);
        //TODO GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.ElectricalSteel), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Obsidian), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.DarkSteel), GT_Values.NI, 4000, 120, 2000);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Iridium, 3), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Osmium), Materials.Helium.getGas(1000), null, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.Osmiridium, 4), null, 500, 1920, 2900);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Naquadah), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Osmiridium), Materials.Argon.getGas(1000), null, GT_OreDictUnificator.get(OrePrefixes.ingotHot, Materials.NaquadahAlloy, 2), null, 500, 30720, Materials.NaquadahAlloy.mBlastFurnaceTemp);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Gallium), GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Arsenic), null, null, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.GalliumArsenide, 2), null, 600, 120, Materials.GalliumArsenide.mBlastFurnaceTemp);
        GT_Values.RA.addBlastRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.FerriteMixture), GT_Values.NI, Materials.Oxygen.getGas(2000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.NickelZincFerrite), null, 600, 120, Materials.NickelZincFerrite.mBlastFurnaceTemp);
        ...
        GT_Values.RA.addImplosionRecipe(ItemList.Ingot_IridiumAlloy.get(1), 8, ItemList.Plate_IridiumAlloy.get(1), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.DarkAsh, 4));

        if (Loader.isModLoaded("GalacticraftMars")) {
            GT_ModHandler.addCraftingRecipe(ItemList.Ingot_Heavy1.get(1), "BhB", "CAS", "B B", 'B', OrePrefixes.bolt.get(Materials.StainlessSteel), 'C', OrePrefixes.compressed.get(Materials.Bronze), 'A', OrePrefixes.compressed.get(Materials.Aluminium), 'S', OrePrefixes.compressed.get(Materials.Steel));
            GT_ModHandler.addCraftingRecipe(ItemList.Ingot_Heavy2.get(1), " BB", "hPC", " BB", 'B', OrePrefixes.bolt.get(Materials.Tungsten), 'C', OrePrefixes.compressed.get(Materials.MeteoricIron), 'P', GT_ModHandler.getModItem("GalacticraftCore", "item.heavyPlating", 1));
            GT_ModHandler.addCraftingRecipe(ItemList.Ingot_Heavy3.get(1), " BB", "hPC", " BB", 'B', OrePrefixes.bolt.get(Materials.TungstenSteel), 'C', OrePrefixes.compressed.get(Materials.Desh), 'P', GT_ModHandler.getModItem("GalacticraftMars", "item.null", 1, 3));

            GT_Values.RA.addImplosionRecipe(ItemList.Ingot_Heavy1.get(1), 8, GT_ModHandler.getModItem("GalacticraftCore", "item.heavyPlating", 1), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.StainlessSteel, 2));
            GT_Values.RA.addImplosionRecipe(ItemList.Ingot_Heavy2.get(1), 8, GT_ModHandler.getModItem("GalacticraftMars", "item.null", 1, 3), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Tungsten, 2));
            GT_Values.RA.addImplosionRecipe(ItemList.Ingot_Heavy3.get(1), 8, GT_ModHandler.getModItem("GalacticraftMars", "item.itemBasicAsteroids", 1), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.TungstenSteel, 2));

            GT_Values.RA.addCentrifugeRecipe(GT_ModHandler.getModItem("GalacticraftCore", "tile.moonBlock", 1, 5), null, null, Materials.Helium3.getGas(33), new ItemStack(Blocks.sand,1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminium, 1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Calcite, 1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Iron, 1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Magnesium, 1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Rutile, 1), new int[]{5000,400,400,100,100,100}, 400, 8);
            ...
            GT_Values.RA.addCentrifugeRecipe(GT_ModHandler.getModItem("GalacticraftMars", "tile.asteroidsBlock", 1, 0), null, null, Materials.Nitrogen.getGas(33), new ItemStack(Blocks.sand,1), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminium), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Nickel), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Iron), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Gallium), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Platinum), new int[]{5000,400,400,100,100,100}, 400, 8);
        }

        GT_Values.RA.addFluidExtractionRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Quartzite), null, Materials.Glass.getMolten(72), 10000, 600, 28);
        ...
        GT_Values.RA.addDistillationTowerRecipe(Materials.Biomass.getFluid(600), new FluidStack[]{Materials.Ethanol.getFluid(240), Materials.Water.getFluid(240)}, GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Wood), 16, 400);
        ...
        GT_Values.RA.addElectrolyzerRecipe(GT_Values.NI, ItemList.Cell_Empty.get(1), Materials.Water.getFluid(3000), Materials.Hydrogen.getGas(2000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Oxygen), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, null, 2000, 30);
        GT_Values.RA.addElectrolyzerRecipe(GT_Values.NI, ItemList.Cell_Empty.get(1), GT_ModHandler.getDistilledWater(3000), Materials.Hydrogen.getGas(2000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Oxygen), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, null, 2000, 30);
        GT_Values.RA.addElectrolyzerRecipe(ItemList.Cell_Electrolyzed_Water.get(3), 0, GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 2), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Oxygen), GT_Values.NI, GT_Values.NI, GT_Values.NI, null, 30, 30);
        GT_Values.RA.addElectrolyzerRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Water), 0, ItemList.Cell_Electrolyzed_Water.get(1), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, 490, 30);
        GT_Values.RA.addElectrolyzerRecipe(ItemList.Dye_Bonemeal.get(3), 0, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Calcium), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, 98, 26);
        GT_Values.RA.addElectrolyzerRecipe(new ItemStack(Blocks.sand, 8), 0, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.SiliconDioxide), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, 500, 25);
        GT_Values.RA.addElectrolyzerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Tungstate, 7L), GT_Values.NI, Materials.Hydrogen.getGas(7000), Materials.Oxygen.getGas(4000), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Tungsten), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Lithium, 2), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, new int[]{10000, 10000, 0, 0, 0, 0}, 120, 1920);
        GT_Values.RA.addElectrolyzerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Scheelite, 7L), GT_Values.NI, Materials.Hydrogen.getGas(7000), Materials.Oxygen.getGas(4000), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Tungsten), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Calcium, 2), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, new int[]{10000, 10000, 0, 0, 0, 0}, 120, 1920);
        ...
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.NetherQuartz, 3), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sodium), Materials.Water.getFluid(1000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.gem, Materials.NetherQuartz, 3), 500);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.CertusQuartz, 3), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sodium), Materials.Water.getFluid(1000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.gem, Materials.CertusQuartz, 3), 500);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Quartzite, 3), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sodium), Materials.Water.getFluid(1000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Quartzite, 3), 500);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.NetherQuartz, 3), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sodium), GT_ModHandler.getDistilledWater(1000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.gem, Materials.NetherQuartz, 3), 500);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.CertusQuartz, 3), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sodium), GT_ModHandler.getDistilledWater(1000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.gem, Materials.CertusQuartz, 3), 500);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Quartzite, 3), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sodium), GT_ModHandler.getDistilledWater(1000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Quartzite, 3), 500);

        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Uraninite), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Aluminium), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Uranium), 1000);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Uraninite), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Magnesium), GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Uranium), 1000);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Calcium), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Carbon), Materials.Oxygen.getGas(3000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Calcite, 5), 500);
        ...
        GT_Values.RA.addChemicalRecipeForBasicMachineOnly(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Oxygen), GT_Values.NI, Materials.Hydrogen.getGas(2000), GT_ModHandler.getDistilledWater(1000), ItemList.Cell_Empty.get(1), GT_Values.NI, 10, 30);
        GT_Values.RA.addChemicalRecipeForBasicMachineOnly(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen), GT_Values.NI, Materials.Oxygen.getGas(500), GT_ModHandler.getDistilledWater(500), ItemList.Cell_Empty.get(1), GT_Values.NI, 5, 30);
        ...
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Rutile), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Carbon, 2), Materials.Chlorine.getGas(4000), Materials.Titaniumtetrachloride.getFluid(1000), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.CarbonMonoxide, 2), 500, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Rutile), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Carbon, 2), Materials.Chlorine.getGas(4000), Materials.Titaniumtetrachloride.getFluid(1000), GT_Values.NI, 500, 480);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sodium), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Magnesiumchloride, 2), GT_Values.NF, Materials.Chlorine.getGas(3000), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Magnesium, 6L), 300, 240);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.RawRubber, 9L), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur), GT_Values.NF, Materials.Rubber.getMolten(1296), GT_Values.NI, 600, 16);

        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Gold, 8), new ItemStack(Items.melon, 1, 32767), new ItemStack(Items.speckled_melon, 1, 0), 50);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Gold, 8), new ItemStack(Items.carrot, 1, 32767), new ItemStack(Items.golden_carrot, 1, 0), 50);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Gold, 8), new ItemStack(Items.apple, 1, 32767), new ItemStack(Items.golden_apple, 1, 0), 50);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.block, Materials.Gold, 8), new ItemStack(Items.apple, 1, 32767), new ItemStack(Items.golden_apple, 1, 1), 50);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Blaze), GT_OreDictUnificator.get(OrePrefixes.gem, Materials.EnderPearl), GT_OreDictUnificator.get(OrePrefixes.gem, Materials.EnderEye), 50);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Blaze), new ItemStack(Items.slime_ball, 1, 32767), new ItemStack(Items.magma_cream, 1, 0), 50);
        ...
        GT_Values.RA.addChemicalBathRecipe(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.EnderEye, 1), Materials.Radon.getGas(250), ItemList.QuantumEye.get(1), null, null, null, 480, 384);
        GT_Values.RA.addChemicalBathRecipe(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.NetherStar, 1), Materials.Radon.getGas(1250), ItemList.QuantumStar.get(1), null, null, null, 1920, 384);
        GT_Values.RA.addAutoclaveRecipe(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.NetherStar, 1), Materials.Neutronium.getMolten(288), ItemList.Gravistar.get(1), 10000, 480, 7680);
        
        GT_Values.RA.addBenderRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Tin, 12L), ItemList.Cell_Empty.get(6), 1200, 8);
        GT_Values.RA.addBenderRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 12L), ItemList.Cell_Empty.get(6), 1200, 8);
        GT_Values.RA.addBenderRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.SteelMagnetic, 12L), ItemList.Cell_Empty.get(6), 1200, 8);
        GT_Values.RA.addBenderRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Polytetrafluoroethylene, 12L), ItemList.Cell_Empty.get(6), 1200, 8);
        ...
        GT_Values.RA.addPulveriserRecipe(GT_OreDictUnificator.get(OrePrefixes.block, Materials.Marble), new ItemStack[]{GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Marble)}, null, 160, 4);

        GT_Values.RA.addVacuumFreezerRecipe(Materials.Air.getCells(1), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.LiquidAir), 25);
        ...
        GT_Values.RA.addCutterRecipe(new ItemStack(Blocks.glowstone, 1, 0), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Glowstone, 4), GT_Values.NI, 100, 16);
        ...
        GT_Values.RA.addLatheRecipe(GT_ModHandler.getModItem(aTextForestry, "slabs", 1, GT_Values.W), new ItemStack(Items.bowl,1), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Wood, 1), 50, 8);
        
        GT_Values.RA.addFormingPressRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Brass), ItemList.Shape_Mold_Credit.get(0), ItemList.Coin_Doge.get(4), 100, 16);
        
        GT_Values.RA.addWiremillRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Graphene), GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Graphene), 400, 2);
        if (!GregTech_API.sRecipeFile.get(ConfigCategories.Recipes.disabledrecipes, "torchesFromCoal", false)) {
            GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood), new ItemStack(Items.coal, 1, 32767), new ItemStack(Blocks.torch, 4), 400, 1);
        }
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Gold, 2), ItemList.Circuit_Integrated.getWithDamage(0, 2), new ItemStack(Blocks.light_weighted_pressure_plate, 1), 200, 4);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iron, 2), ItemList.Circuit_Integrated.getWithDamage(0, 2), new ItemStack(Blocks.heavy_weighted_pressure_plate, 1), 200, 4);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iron, 6L), ItemList.Circuit_Integrated.getWithDamage(0, 6), new ItemStack(Items.iron_door, 1), 600, 4);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iron, 7L), ItemList.Circuit_Integrated.getWithDamage(0, 7), new ItemStack(Items.cauldron, 1), 700, 4);
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Iron, 3), ItemList.Circuit_Integrated.getWithDamage(0, 3), new ItemStack(Blocks.iron_bars, 4), 300, 4);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.WroughtIron, 2), ItemList.Circuit_Integrated.getWithDamage(0, 2), new ItemStack(Blocks.heavy_weighted_pressure_plate, 1), 200, 4);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.WroughtIron, 6L), ItemList.Circuit_Integrated.getWithDamage(0, 6), new ItemStack(Items.iron_door, 1), 600, 4);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.WroughtIron, 7L), ItemList.Circuit_Integrated.getWithDamage(0, 7), new ItemStack(Items.cauldron, 1), 700, 4);
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.WroughtIron, 3), ItemList.Circuit_Integrated.getWithDamage(0, 3), new ItemStack(Blocks.iron_bars, 4), 300, 4);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 3), ItemList.Circuit_Integrated.getWithDamage(0, 3), new ItemStack(Blocks.fence, 1), 300, 4);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Iron, 2), new ItemStack(Blocks.tripwire_hook, 1), 400, 4);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), GT_OreDictUnificator.get(OrePrefixes.ring, Materials.WroughtIron, 2), new ItemStack(Blocks.tripwire_hook, 1), 400, 4);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 3), new ItemStack(Items.string, 3, 32767), new ItemStack(Items.bow, 1), 400, 4);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iron, 3), ItemList.Component_Minecart_Wheels_Iron.get(2), new ItemStack(Items.minecart, 1), 500, 2);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.WroughtIron, 3), ItemList.Component_Minecart_Wheels_Iron.get(2), new ItemStack(Items.minecart, 1), 400, 2);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 3), ItemList.Component_Minecart_Wheels_Steel.get(2), new ItemStack(Items.minecart, 1), 300, 2);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Iron), GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Iron, 2), ItemList.Component_Minecart_Wheels_Iron.get(1), 500, 2);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.WroughtIron), GT_OreDictUnificator.get(OrePrefixes.ring, Materials.WroughtIron, 2), ItemList.Component_Minecart_Wheels_Iron.get(1), 400, 2);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Steel), GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Steel, 2), ItemList.Component_Minecart_Wheels_Steel.get(1), 300, 2);
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.WroughtIron, 8), ItemList.Circuit_Integrated.getWithDamage(0, 8), ItemList.Casing_ULV.get(1), 25, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 8), ItemList.Circuit_Integrated.getWithDamage(0, 8), ItemList.Casing_LV.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 8), ItemList.Circuit_Integrated.getWithDamage(0, 8), ItemList.Casing_MV.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.StainlessSteel, 8), ItemList.Circuit_Integrated.getWithDamage(0, 8), ItemList.Casing_HV.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Titanium, 8), ItemList.Circuit_Integrated.getWithDamage(0, 8), ItemList.Casing_EV.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.TungstenSteel, 8), ItemList.Circuit_Integrated.getWithDamage(0, 8), ItemList.Casing_IV.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Chrome, 8), ItemList.Circuit_Integrated.getWithDamage(0, 8), ItemList.Casing_LuV.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iridium, 8), ItemList.Circuit_Integrated.getWithDamage(0, 8), ItemList.Casing_ZPM.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Osmium, 8), ItemList.Circuit_Integrated.getWithDamage(0, 8), ItemList.Casing_UV.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Neutronium, 8), ItemList.Circuit_Integrated.getWithDamage(0, 8), ItemList.Casing_MAX.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Invar, 6L), GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Invar), ItemList.Casing_HeatProof.get(2), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.wireGt02, Materials.Cupronickel, 8), ItemList.Circuit_Integrated.getWithDamage(0, 8), ItemList.Casing_Coil_Cupronickel.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.wireGt02, Materials.Kanthal, 8), ItemList.Circuit_Integrated.getWithDamage(0, 8), ItemList.Casing_Coil_Kanthal.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.wireGt02, Materials.Nichrome, 8), ItemList.Circuit_Integrated.getWithDamage(0, 8), ItemList.Casing_Coil_Nichrome.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.wireGt02, Materials.TungstenSteel, 8), ItemList.Circuit_Integrated.getWithDamage(0, 8), ItemList.Casing_Coil_TungstenSteel.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.wireGt02, Materials.HSSG, 8), ItemList.Circuit_Integrated.getWithDamage(0, 8), ItemList.Casing_Coil_HSSG.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.wireGt02, Materials.Naquadah, 8), ItemList.Circuit_Integrated.getWithDamage(0, 8), ItemList.Casing_Coil_Naquadah.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.wireGt02, Materials.NaquadahAlloy, 8), ItemList.Circuit_Integrated.getWithDamage(0, 8), ItemList.Casing_Coil_NaquadahAlloy.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.wireGt02, Materials.Superconductor, 8), ItemList.Circuit_Integrated.getWithDamage(0, 8), ItemList.Casing_Coil_Superconductor.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 6L), GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Steel), ItemList.Casing_SolidSteel.get(2), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 6L), GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Aluminium), ItemList.Casing_FrostProof.get(2), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.TungstenSteel, 6L), GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.TungstenSteel), ItemList.Casing_RobustTungstenSteel.get(2), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.StainlessSteel, 6L), GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.StainlessSteel), ItemList.Casing_CleanStainlessSteel.get(2), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Titanium, 6L), GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Titanium), ItemList.Casing_StableTitanium.get(2), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Osmiridium, 6L), GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.Osmiridium), ItemList.Casing_MiningOsmiridium.get(2), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.TungstenSteel, 6L), ItemList.Casing_LuV.get(1), ItemList.Casing_Fusion.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Magnalium, 6L), GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.BlueSteel), ItemList.Casing_Turbine.get(2), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.StainlessSteel, 6L), ItemList.Casing_Turbine.get(1), ItemList.Casing_Turbine1.get(2), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Titanium, 6L), ItemList.Casing_Turbine.get(1), ItemList.Casing_Turbine2.get(2), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.TungstenSteel, 6L), ItemList.Casing_Turbine.get(1), ItemList.Casing_Turbine3.get(2), 50, 16);
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Lead, 2), ItemList.Casing_ULV.get(1), Materials.Plastic.getMolten(288), ItemList.Hull_ULV.get(1), 25, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tin, 2), ItemList.Casing_LV.get(1), Materials.Plastic.getMolten(288), ItemList.Hull_LV.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Copper, 2), ItemList.Casing_MV.get(1), Materials.Plastic.getMolten(288), ItemList.Hull_MV.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.AnnealedCopper, 2), ItemList.Casing_MV.get(1), Materials.Plastic.getMolten(288), ItemList.Hull_MV.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Gold, 2), ItemList.Casing_HV.get(1), Materials.Plastic.getMolten(288), ItemList.Hull_HV.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Aluminium, 2), ItemList.Casing_EV.get(1), Materials.Plastic.getMolten(288), ItemList.Hull_EV.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tungsten, 2), ItemList.Casing_IV.get(1), Materials.Plastic.getMolten(288), ItemList.Hull_IV.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.VanadiumGallium, 2), ItemList.Casing_LuV.get(1), Materials.Plastic.getMolten(288), ItemList.Hull_LuV.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Naquadah, 2), ItemList.Casing_ZPM.get(1), Materials.Polytetrafluoroethylene.getMolten(288), ItemList.Hull_ZPM.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.wireGt04, Materials.NaquadahAlloy, 2), ItemList.Casing_UV.get(1), Materials.Polytetrafluoroethylene.getMolten(288), ItemList.Hull_UV.get(1), 50, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Superconductor, 2), ItemList.Casing_MAX.get(1), Materials.Polytetrafluoroethylene.getMolten(288), ItemList.Hull_MAX.get(1), 50, 16);

        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Tin), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.BatteryAlloy), Materials.Plastic.getMolten(144), ItemList.Battery_Hull_LV.get(1), 800, 1);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Copper, 2), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.BatteryAlloy, 3), Materials.Plastic.getMolten(432), ItemList.Battery_Hull_MV.get(1), 1600, 2);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.AnnealedCopper, 2), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.BatteryAlloy, 3), Materials.Plastic.getMolten(432), ItemList.Battery_Hull_MV.get(1), 1600, 2);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.Gold, 4), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.BatteryAlloy, 9L), Materials.Plastic.getMolten(1296), ItemList.Battery_Hull_HV.get(1), 3200, 4);
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iron, 5), new ItemStack(Blocks.chest, 1, 32767), new ItemStack(Blocks.hopper), 800, 2);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iron, 5), new ItemStack(Blocks.trapped_chest, 1, 32767), new ItemStack(Blocks.hopper), 800, 2);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.WroughtIron, 5), new ItemStack(Blocks.chest, 1, 32767), new ItemStack(Blocks.hopper), 800, 2);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.WroughtIron, 5), new ItemStack(Blocks.trapped_chest, 1, 32767), new ItemStack(Blocks.hopper), 800, 2);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.EnderPearl), new ItemStack(Items.blaze_powder, 1, 0), new ItemStack(Items.ender_eye, 1, 0), 400, 2);
        ...
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.gear, Materials.CobaltBrass), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Diamond), ItemList.Component_Sawblade_Diamond.get(1), 1600, 2);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone, 4), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Glowstone, 4), new ItemStack(Blocks.redstone_lamp, 1), 400, 1);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood), new ItemStack(Blocks.redstone_torch, 1), 400, 1);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iron, 4), new ItemStack(Items.compass, 1), 400, 4);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.WroughtIron, 4), new ItemStack(Items.compass, 1), 400, 4);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Redstone), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Gold, 4), new ItemStack(Items.clock, 1), 400, 4);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur), new ItemStack(Blocks.torch, 2), 400, 1);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Phosphorus), new ItemStack(Blocks.torch, 6), 400, 1);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood), ItemList.Resin.get(1), new ItemStack(Blocks.torch, 6), 400, 1);
        
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadSword, Materials.Wood), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood), new ItemStack(Items.wooden_sword, 1), 100, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadSword, Materials.Stone), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood), new ItemStack(Items.stone_sword, 1), 100, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadSword, Materials.Iron), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood), new ItemStack(Items.iron_sword, 1), 100, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadSword, Materials.Gold), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood), new ItemStack(Items.golden_sword, 1), 100, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadSword, Materials.Diamond), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood), new ItemStack(Items.diamond_sword, 1), 100, 16);

        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadPickaxe, Materials.Wood), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), new ItemStack(Items.wooden_pickaxe, 1), 100, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadPickaxe, Materials.Stone), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), new ItemStack(Items.stone_pickaxe, 1), 100, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadPickaxe, Materials.Iron), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), new ItemStack(Items.iron_pickaxe, 1), 100, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadPickaxe, Materials.Gold), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), new ItemStack(Items.golden_pickaxe, 1), 100, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadPickaxe, Materials.Diamond), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), new ItemStack(Items.diamond_pickaxe, 1), 100, 16);

        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadShovel, Materials.Wood), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), new ItemStack(Items.wooden_shovel, 1), 100, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadShovel, Materials.Stone), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), new ItemStack(Items.stone_shovel, 1), 100, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadShovel, Materials.Iron), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), new ItemStack(Items.iron_shovel, 1), 100, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadShovel, Materials.Gold), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), new ItemStack(Items.golden_shovel, 1), 100, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadShovel, Materials.Diamond), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), new ItemStack(Items.diamond_shovel, 1), 100, 16);

        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadAxe, Materials.Wood), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), new ItemStack(Items.wooden_axe, 1), 100, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadAxe, Materials.Stone), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), new ItemStack(Items.stone_axe, 1), 100, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadAxe, Materials.Iron), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), new ItemStack(Items.iron_axe, 1), 100, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadAxe, Materials.Gold), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), new ItemStack(Items.golden_axe, 1), 100, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadAxe, Materials.Diamond), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), new ItemStack(Items.diamond_axe, 1), 100, 16);

        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadHoe, Materials.Wood), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), new ItemStack(Items.wooden_hoe, 1), 100, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadHoe, Materials.Stone), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), new ItemStack(Items.stone_hoe, 1), 100, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadHoe, Materials.Iron), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), new ItemStack(Items.iron_hoe, 1), 100, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadHoe, Materials.Gold), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), new ItemStack(Items.golden_hoe, 1), 100, 16);
        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.toolHeadHoe, Materials.Diamond), GT_OreDictUnificator.get(OrePrefixes.stick, Materials.Wood, 2), new ItemStack(Items.diamond_hoe, 1), 100, 16);
        ...
        GT_Values.RA.addPyrolyseRecipe(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Coal, 16), null, 1, ItemList.CoalCoke.get(16), Materials.Creosote.getFluid(8000), 640, 64);
        GT_Values.RA.addPyrolyseRecipe(GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Coal, 16), Materials.Nitrogen.getGas(1000), 2, ItemList.CoalCoke.get(16), Materials.Creosote.getFluid(8000), 320, 96);
        ...
        for (MaterialStack[] tMats : this.mAlloySmelterList) {
            ...
            if (tOutputIngot != GT_Values.NI) {
                GT_ModHandler.addAlloySmelterRecipe(tIngot1, tDust2, tOutputIngot, tMats[2].mAmount * 50, 16, false);
                GT_ModHandler.addAlloySmelterRecipe(tIngot1, tIngot2, tOutputIngot, tMats[2].mAmount * 50, 16, false);
                GT_ModHandler.addAlloySmelterRecipe(tDust1, tIngot2, tOutputIngot, tMats[2].mAmount * 50, 16, false);
                GT_ModHandler.addAlloySmelterRecipe(tDust1, tDust2, tOutputIngot, tMats[2].mAmount * 50, 16, false);
            }
        }
        ...
        addProcess(tCrop,Materials.Sheldonite,40, false);
    ...
    public void addProcess(ItemStack tCrop, Materials aMaterial, int chance, boolean aMainOutput) {
        if(tCrop==null||aMaterial==null|| GT_OreDictUnificator.get(OrePrefixes.crushed, aMaterial)==null)return;
        if (GT_Mod.gregtechproxy.mNerfedCrops) {
            GT_Values.RA.addChemicalRecipe(GT_Utility.copyAmount(9, tCrop), GT_OreDictUnificator.get(OrePrefixes.crushed, aMaterial), Materials.Water.getFluid(1000), aMaterial.mByProducts.isEmpty() ? null : aMaterial.mByProducts.get(0).getMolten(144), GT_OreDictUnificator.get(OrePrefixes.crushedPurified, aMaterial, 4), 96, 24);
            GT_Values.RA.addAutoclaveRecipe(GT_Utility.copyAmount(16, tCrop), Materials.UUMatter.getFluid(Math.max(1, ((aMaterial.getMass()+9)/10))), GT_OreDictUnificator.get(OrePrefixes.crushedPurified, aMaterial), 10000, aMaterial.getMass() * 128, 384);
        } else {
            if (aMainOutput) GT_ModHandler.addExtractionRecipe(tCrop, GT_OreDictUnificator.get(OrePrefixes.dustTiny, aMaterial));
        }
    }
    ...
    public void addProcess(ItemStack tCrop, Materials aMaterial, int chance){
        ...
        if (GT_Mod.gregtechproxy.mNerfedCrops) {
            ...
            GT_ModHandler.addExtractionRecipe(tCrop, GT_OreDictUnificator.get(OrePrefixes.dustTiny, aMaterial));
        }
    }
    ...
    public void addProcess(ItemStack tCrop, Materials aMaterial, Materials aMaterialOut, int chance, boolean aMainOutput){
        if(tCrop==null||aMaterial==null|| GT_OreDictUnificator.get(OrePrefixes.crushed, aMaterial)==null)return;
        if (GT_Mod.gregtechproxy.mNerfedCrops) {
            GT_Values.RA.addChemicalRecipe(GT_Utility.copyAmount(9, tCrop), GT_OreDictUnificator.get(OrePrefixes.crushed, aMaterial), Materials.Water.getFluid(1000), aMaterialOut.mByProducts.isEmpty() ? null : aMaterialOut.mByProducts.get(0).getMolten(144), GT_OreDictUnificator.get(OrePrefixes.crushedPurified, aMaterialOut, 4), 96, 24);
            GT_Values.RA.addAutoclaveRecipe(GT_Utility.copyAmount(16, tCrop), Materials.UUMatter.getFluid(Math.max(1, ((aMaterial.getMass()+9)/10))), GT_OreDictUnificator.get(OrePrefixes.crushedPurified, aMaterial), 10000, aMaterial.getMass() * 128, 384);
        } else {
            if (aMainOutput) GT_ModHandler.addExtractionRecipe(tCrop, GT_OreDictUnificator.get(OrePrefixes.dustTiny, aMaterial));
        }
    ...
    private void run2(){
        ...
        GT_Values.RA.addCentrifugeRecipe(new ItemStack(Blocks.sand, 1, 1), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Iron), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Diamond), new ItemStack(Blocks.sand, 1), GT_Values.NI, GT_Values.NI, GT_Values.NI, new int[]{5000, 100, 5000}, 50, 30);
        GT_Values.RA.addCentrifugeRecipe(new ItemStack(Blocks.dirt, 1, 32767), GT_Values.NI, GT_Values.NF, GT_Values.NF, ItemList.Plantball.get(1), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Clay), new ItemStack(Blocks.sand, 1), GT_Values.NI, GT_Values.NI, GT_Values.NI, new int[]{1250, 5000, 5000}, 250, 30);
        GT_Values.RA.addCentrifugeRecipe(new ItemStack(Blocks.grass, 1, 32767), GT_Values.NI, GT_Values.NF, GT_Values.NF, ItemList.Plantball.get(1), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Clay), new ItemStack(Blocks.sand, 1), GT_Values.NI, GT_Values.NI, GT_Values.NI, new int[]{2500, 5000, 5000}, 250, 30);
        ...
        GT_Values.RA.addCentrifugeRecipe(ItemList.Resin.get(1), GT_Values.NI, GT_Values.NF, Materials.Glue.getFluid(100), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.RawRubber, 3), ItemList.Plantball.get(1), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, new int[]{10000, 1000}, 300, 5);
        ...
        GT_Values.RA.addCentrifugeRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Uranium), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Uranium235), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Plutonium), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, new int[]{2000, 200}, 800, 320);
        GT_Values.RA.addCentrifugeRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Plutonium), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Plutonium241), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Uranium), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, new int[]{2000, 3000}, 1600, 320);
        GT_Values.RA.addCentrifugeRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Naquadah), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.NaquadahEnriched), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Naquadria), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, new int[]{5000, 1000}, 3200, 320);
        GT_Values.RA.addCentrifugeRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.NaquadahEnriched), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Naquadria), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Naquadah), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, new int[]{2000, 3000}, 6400, 640);
        ...
        GT_Values.RA.addCentrifugeRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Glowstone), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Redstone, 2), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Gold, 2), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, null, 488, 80);
        GT_Values.RA.addCentrifugeRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Endstone), GT_Values.NI, GT_Values.NF, Materials.Helium.getGas(120), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Tungstate), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Platinum), new ItemStack(Blocks.sand, 1), GT_Values.NI, GT_Values.NI, GT_Values.NI, new int[]{1250, 625, 9000, 0, 0, 0}, 320, 20);
        GT_Values.RA.addCentrifugeRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Netherrack), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Redstone), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Sulfur), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Coal), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Gold), GT_Values.NI, GT_Values.NI, new int[]{5625, 9900, 5625, 625, 0, 0}, 160, 20);
        GT_Values.RA.addCentrifugeRecipe(new ItemStack(Blocks.soul_sand, 1), GT_Values.NI, GT_Values.NF, Materials.Oil.getFluid(80), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Saltpeter), GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Coal), new ItemStack(Blocks.sand, 1), GT_Values.NI, GT_Values.NI, GT_Values.NI, new int[]{8000, 2000, 9000, 0, 0, 0}, 200, 80);
        GT_Values.RA.addCentrifugeRecipe(GT_Values.NI, GT_Values.NI, Materials.Lava.getFluid(100), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Copper), GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Tin), GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Gold), GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Silver), GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Tantalum), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Tungstate), new int[]{2000, 1000, 250, 250, 250, 250}, 80, 80);
        ...
        GT_Values.RA.addCentrifugeRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.RareEarth), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Neodymium), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Yttrium), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Lanthanum), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Cerium), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Cadmium), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Caesium), new int[]{2500, 2500, 2500, 2500, 2500, 2500}, 64, 20);
        GT_Values.RA.addCentrifugeRecipe(GT_ModHandler.getModItem(aTextAE, aTextAEMM, 1, 45), GT_Values.NI, GT_Values.NF, GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.BasalticMineralSand), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Olivine), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Obsidian), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Basalt), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Flint), GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.RareEarth), new int[]{2000, 2000, 2000, 2000, 2000, 2000}, 64, 20);

        GT_Values.RA.addAssemblylineRecipe(ItemList.Electric_Motor_IV.get(1),144000,new ItemStack[]{
                GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.AnnealedCopper, 64),
                GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.AnnealedCopper, 64),
                GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.AnnealedCopper, 64),
                GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.AnnealedCopper, 64),
                GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.YttriumBariumCuprate, 2)}, new FluidStack[]{
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Electric_Motor_LuV.get(1),144000,new ItemStack[]{
                GT_OreDictUnificator.get(OrePrefixes.ring, Materials.HSSE, 4),
                GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Platinum, 64),
                GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Platinum, 64),
                GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Platinum, 64),
                GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Platinum, 64),
                GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.VanadiumGallium, 2)}, new FluidStack[]{
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Electric_Motor_ZPM.get(1),288000,new ItemStack[]{
                GT_OreDictUnificator.get(OrePrefixes.block, Materials.NeodymiumMagnetic, 1),
                ...
                GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Superconductor, 64),
                GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Superconductor, 64),
                GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.NiobiumTitanium, 2)}, new FluidStack[]{
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Electric_Pump_IV.get(1),144000,new ItemStack[]{
                ...
                GT_OreDictUnificator.get(OrePrefixes.pipeSmall, Materials.Ultimate, 2),
                GT_OreDictUnificator.get(OrePrefixes.plate, Materials.HSSG, 2),
                GT_OreDictUnificator.get(OrePrefixes.screw, Materials.HSSG, 8),
                GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Silicone, 4),
                GT_OreDictUnificator.get(OrePrefixes.rotor, Materials.HSSG, 2),
                GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.YttriumBariumCuprate, 2)}, new FluidStack[]{
                Materials.SolderingAlloy.getMolten(144),
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Electric_Pump_LuV.get(1),144000,new ItemStack[]{
                ...
                GT_OreDictUnificator.get(OrePrefixes.pipeMedium, Materials.Ultimate, 2),
                GT_OreDictUnificator.get(OrePrefixes.plate, Materials.HSSE, 2),
                GT_OreDictUnificator.get(OrePrefixes.screw, Materials.HSSE, 8),
                GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Silicone, 16),
                GT_OreDictUnificator.get(OrePrefixes.rotor, Materials.HSSE, 2),
                GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.VanadiumGallium, 2)}, new FluidStack[]{
                Materials.SolderingAlloy.getMolten(288),
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Electric_Pump_ZPM.get(1),288000,new ItemStack[]{
                ...
                GT_OreDictUnificator.get(OrePrefixes.pipeLarge, Materials.Ultimate, 2),
...
//        Conveyor
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Conveyor_Module_IV.get(1),144000,new ItemStack[]{
                ...
                GT_OreDictUnificator.get(OrePrefixes.plate, Materials.HSSG, 2),
                GT_OreDictUnificator.get(OrePrefixes.ring, Materials.HSSG, 4),
                GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.YttriumBariumCuprate, 2)}, new FluidStack[]{
...
//        Piston
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Electric_Piston_IV.get(1),144000,new ItemStack[]{
                ...
                GT_OreDictUnificator.get(OrePrefixes.ring, Materials.HSSG, 4),
                GT_OreDictUnificator.get(OrePrefixes.stick, Materials.HSSG, 4),
                GT_OreDictUnificator.get(OrePrefixes.gear, Materials.HSSG, 1),
                GT_OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.HSSG, 2),
                GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.YttriumBariumCuprate, 4)}, new FluidStack[]{
                Materials.SolderingAlloy.getMolten(144),
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Electric_Piston_LuV.get(1),144000,new ItemStack[]{
                ...
                GT_OreDictUnificator.get(OrePrefixes.ring, Materials.HSSE, 4),
                GT_OreDictUnificator.get(OrePrefixes.stick, Materials.HSSE, 4),
                GT_OreDictUnificator.get(OrePrefixes.gear, Materials.HSSE, 1),
                GT_OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.HSSE, 2),
                GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.VanadiumGallium, 4)}, new FluidStack[]{
                Materials.SolderingAlloy.getMolten(288),
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Electric_Piston_ZPM.get(1),288000,new ItemStack[]{
                ...
                GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.NiobiumTitanium, 4)}, new FluidStack[]{
                Materials.SolderingAlloy.getMolten(1296),
...
//        RobotArm
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Robot_Arm_IV.get(1),144000,new ItemStack[]{
                GT_OreDictUnificator.get(OrePrefixes.gear, Materials.HSSG, 1),
                GT_OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.HSSG, 3),
                ItemList.Electric_Motor_LuV.get(2),
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Robot_Arm_LuV.get(1),144000,new ItemStack[]{
                GT_OreDictUnificator.get(OrePrefixes.gear, Materials.HSSE, 1),
                GT_OreDictUnificator.get(OrePrefixes.gearGtSmall, Materials.HSSE, 3),
                ItemList.Electric_Motor_ZPM.get(2),
...
//        Emitter
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Emitter_IV.get(1),144000,new ItemStack[]{
                        GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.HSSG, 1),
                        ItemList.Emitter_IV.get(1),
                        ItemList.Emitter_EV.get(2),
                        ItemList.Emitter_HV.get(4),
                        ItemList.Circuit_Nanoprocessor.get(7),
                        GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Electrum, 64),
                        GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Electrum, 64),
                        GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Electrum, 64),
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Emitter_LuV.get(1),144000,new ItemStack[]{
                        GT_OreDictUnificator.get(OrePrefixes.frameGt, Materials.HSSE, 1),
                        ItemList.Emitter_LuV.get(1),
                        ItemList.Emitter_IV.get(2),
                        ItemList.Emitter_EV.get(4),
                        ItemList.Circuit_Quantumcomputer.get(7),
                        GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Platinum, 64),
                        GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Platinum, 64),
                        GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Platinum, 64),
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Emitter_ZPM.get(1),288000,new ItemStack[]{
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Osmiridium, 64),
                        GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Osmiridium, 64),
                        GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Osmiridium, 64),
...
//        Field Generator
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Field_Generator_IV.get(1),144000,new ItemStack[]{
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Osmium, 64),
                        GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Osmium, 64),
                        GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Osmium, 64),
                        GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Osmium, 64),
                        GT_OreDictUnificator.get(OrePrefixes.cableGt01, Materials.YttriumBariumCuprate, 8)}, new FluidStack[]{
                        Materials.SolderingAlloy.getMolten(576)},
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Field_Generator_LuV.get(1),144000,new ItemStack[]{
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Osmium, 64),
                        GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Osmium, 64),
                        GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.VanadiumGallium, 8)}, new FluidStack[]{
                        Materials.SolderingAlloy.getMolten(1152)},
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Field_Generator_ZPM.get(1),288000,new ItemStack[]{
                        ...
                        GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Osmium, 64),
                        GT_OreDictUnificator.get(OrePrefixes.wireFine, Materials.Osmium, 64),
                        GT_OreDictUnificator.get(OrePrefixes.cableGt04, Materials.NiobiumTitanium, 8)}, new FluidStack[]{
                        Materials.SolderingAlloy.getMolten(2304)},
...
//        }
        ...
        GT_Values.RA.addAssemblylineRecipe(ItemList.Circuit_Wetwaresupercomputer.get(1), 288000, new ItemStack[]{
                ...
                ItemList.Circuit_Chip_Ram.get(16), GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Superconductor, 32),
                GT_OreDictUnificator.get(OrePrefixes.foil, Materials.Silicone, 64)
        }, new FluidStack[]{
        ...
        GT_Values.RA.addAssemblylineRecipe(GT_OreDictUnificator.get(OrePrefixes.wireGt01, Materials.Superconductor), 144000, new ItemStack[]{
                ItemList.Casing_Fusion_Coil.get(1),
                ItemList.Circuit_Quantummainframe.get(1),
                ItemList.Circuit_Quantummainframe.get(1),
                ItemList.Circuit_Quantummainframe.get(1),
                ItemList.Circuit_Quantummainframe.get(1),
                GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Plutonium241),
                GT_OreDictUnificator.get(OrePrefixes.plate, Materials.NetherStar),
                ItemList.Field_Generator_IV.get(2),
        ...
        GT_Values.RA.addAssemblylineRecipe(GT_OreDictUnificator.get(OrePrefixes.block, Materials.Europium), 288000, new ItemStack[]{
                ItemList.Casing_Fusion_Coil.get(1),
        ...
        GT_Values.RA.addAssemblylineRecipe(GT_OreDictUnificator.get(OrePrefixes.block, Materials.Americium), 432000, new ItemStack[]{
                ItemList.Casing_Fusion_Coil.get(1),
                ItemList.Circuit_Wetwaresupercomputer.get(1),
                ItemList.Circuit_Wetwaresupercomputer.get(1),
                ItemList.Circuit_Wetwaresupercomputer.get(1),
        ...
        if (GregTech_API.sThaumcraftCompat != null) {
            ...
            GregTech_API.sThaumcraftCompat.addResearch(tKey, "Charcoal Transmutation", "Turning wood into charcoal", new String[]{"ALUMENTUM"}, "ALCHEMY", GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Charcoal), 2, 0, 13, 5, Arrays.asList(new TC_AspectStack(ARBOR, 10), new TC_AspectStack(VACUOS, 8), new TC_AspectStack(IGNIS, 8)), null, aTextTCGTPage + tKey, GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, OrePrefixes.log.get(Materials.Wood), GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Charcoal), Arrays.asList(new TC_AspectStack(VACUOS, 2), new TC_AspectStack(IGNIS, 1))));
            ...
            GregTech_API.sThaumcraftCompat.addResearch(tKey, "Water Transmutation", "Filling buckets with water", null, "ALCHEMY", new ItemStack(Items.water_bucket, 1), 2, 0, 16, 5, Arrays.asList(new TC_AspectStack(PERMUTATIO, 4), new TC_AspectStack(AQUA, 4)), null, aTextTCGTPage + tKey, GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, new ItemStack(Items.bucket, 1), new ItemStack(Items.water_bucket, 1), Arrays.asList(new TC_AspectStack(AQUA, 4))), GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, new ItemStack(Items.bucket, 1), new ItemStack(Items.water_bucket, 1), Arrays.asList(new TC_AspectStack(AQUA, 4))), GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, new ItemStack(Items.bucket, 1), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Water, 1), Arrays.asList(new TC_AspectStack(AQUA, 4))));
            ...
            GregTech_API.sThaumcraftCompat.addResearch(tKey, "Zinc Transmutation", "Transformation of metals into zinc", new String[]{"TRANSTIN"}, "ALCHEMY", GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Zinc), 2, 1, 9, 13, Arrays.asList(new TC_AspectStack(METALLUM, 5), new TC_AspectStack(PERMUTATIO, 3), new TC_AspectStack(SANO, 3)), null, aTextTCGTPage + tKey, GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, OrePrefixes.nugget.get(Materials.Zinc), GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Zinc, 3), Arrays.asList(new TC_AspectStack(METALLUM, 2), new TC_AspectStack(SANO, 1))));
            ...
            GregTech_API.sThaumcraftCompat.addResearch(tKey, "Antimony Transmutation", "Transformation of metals into antimony", new String[]{"GT_TRANSZINC", "TRANSLEAD"}, "ALCHEMY", GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Antimony), 2, 1, 9, 14, Arrays.asList(new TC_AspectStack(METALLUM, 5), new TC_AspectStack(PERMUTATIO, 3), new TC_AspectStack(AQUA, 3)), null, aTextTCGTPage + tKey, GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, OrePrefixes.nugget.get(Materials.Antimony), GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Antimony, 3), Arrays.asList(new TC_AspectStack(METALLUM, 2), new TC_AspectStack(AQUA, 1))));
            ...
            GregTech_API.sThaumcraftCompat.addResearch(tKey, "Nickel Transmutation", "Transformation of metals into nickel", new String[]{"TRANSLEAD"}, "ALCHEMY", GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Nickel), 2, 1, 9, 15, Arrays.asList(new TC_AspectStack(METALLUM, 5), new TC_AspectStack(PERMUTATIO, 3), new TC_AspectStack(IGNIS, 3)), null, aTextTCGTPage + tKey, GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, OrePrefixes.nugget.get(Materials.Nickel), GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Nickel, 3), Arrays.asList(new TC_AspectStack(METALLUM, 2), new TC_AspectStack(IGNIS, 1))));
            ...
            GregTech_API.sThaumcraftCompat.addResearch(tKey, "Cobalt Transmutation", "Transformation of metals into cobalt", new String[]{"GT_TRANSNICKEL"}, "ALCHEMY", GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Cobalt), 2, 1, 9, 16, Arrays.asList(new TC_AspectStack(METALLUM, 5), new TC_AspectStack(PERMUTATIO, 3), new TC_AspectStack(INSTRUMENTUM, 3)), null, aTextTCGTPage + tKey, GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, OrePrefixes.nugget.get(Materials.Cobalt), GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Cobalt, 3), Arrays.asList(new TC_AspectStack(METALLUM, 2), new TC_AspectStack(INSTRUMENTUM, 1))));
            ...
            GregTech_API.sThaumcraftCompat.addResearch(tKey, "Bismuth Transmutation", "Transformation of metals into bismuth", new String[]{"GT_TRANSCOBALT"}, "ALCHEMY", GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Bismuth), 2, 1, 11, 17, Arrays.asList(new TC_AspectStack(METALLUM, 5), new TC_AspectStack(PERMUTATIO, 3), new TC_AspectStack(INSTRUMENTUM, 3)), null, aTextTCGTPage + tKey, GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, OrePrefixes.nugget.get(Materials.Bismuth), GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Bismuth, 3), Arrays.asList(new TC_AspectStack(METALLUM, 2), new TC_AspectStack(INSTRUMENTUM, 1))));
            ...
            GregTech_API.sThaumcraftCompat.addResearch(tKey, "Steel Transmutation", "Transforming iron to steel", new String[]{"TRANSIRON", "GT_WOOD_TO_CHARCOAL"}, "ALCHEMY", GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Steel), 3, 0, 13, 8, Arrays.asList(new TC_AspectStack(METALLUM, 5), new TC_AspectStack(PERMUTATIO, 3), new TC_AspectStack(ORDO, 3)), null, aTextTCGTPage + tKey, GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, OrePrefixes.nugget.get(Materials.Iron), GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Steel), Arrays.asList(new TC_AspectStack(ORDO, 1))));
            ...
            GregTech_API.sThaumcraftCompat.addResearch(tKey, "Bronze Transmutation", "Transformation of metals into bronze", new String[]{"TRANSTIN", "TRANSCOPPER"}, "ALCHEMY", GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Bronze), 2, 0, 13, 11, Arrays.asList(new TC_AspectStack(METALLUM, 5), new TC_AspectStack(PERMUTATIO, 3), new TC_AspectStack(INSTRUMENTUM, 3)), null, aTextTCGTPage + tKey, GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, OrePrefixes.nugget.get(Materials.Bronze), GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Bronze, 3), Arrays.asList(new TC_AspectStack(METALLUM, 2), new TC_AspectStack(INSTRUMENTUM, 1))));
            ...
            GregTech_API.sThaumcraftCompat.addResearch(tKey, "Electrum Transmutation", "Transformation of metals into electrum", new String[]{"GT_TRANSBRONZE", "TRANSGOLD", "TRANSSILVER"}, "ALCHEMY", GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Electrum), 2, 1, 11, 11, Arrays.asList(new TC_AspectStack(METALLUM, 5), new TC_AspectStack(PERMUTATIO, 3), new TC_AspectStack(LUCRUM, 3)), null, aTextTCGTPage + tKey, GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, OrePrefixes.nugget.get(Materials.Electrum), GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Electrum, 3), Arrays.asList(new TC_AspectStack(METALLUM, 2), new TC_AspectStack(LUCRUM, 1))));
            ...
            GregTech_API.sThaumcraftCompat.addResearch(tKey, "Brass Transmutation", "Transformation of metals into brass", new String[]{"GT_TRANSBRONZE", "GT_TRANSZINC"}, "ALCHEMY", GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Brass), 2, 1, 11, 12, Arrays.asList(new TC_AspectStack(METALLUM, 5), new TC_AspectStack(PERMUTATIO, 3), new TC_AspectStack(INSTRUMENTUM, 3)), null, aTextTCGTPage + tKey, GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, OrePrefixes.nugget.get(Materials.Brass), GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Brass, 3), Arrays.asList(new TC_AspectStack(METALLUM, 2), new TC_AspectStack(INSTRUMENTUM, 1))));
            ...
            GregTech_API.sThaumcraftCompat.addResearch(tKey, "Invar Transmutation", "Transformation of metals into invar", new String[]{"GT_TRANSBRONZE", "GT_TRANSNICKEL"}, "ALCHEMY", GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Invar), 2, 1, 11, 15, Arrays.asList(new TC_AspectStack(METALLUM, 5), new TC_AspectStack(PERMUTATIO, 3), new TC_AspectStack(GELUM, 3)), null, aTextTCGTPage + tKey, GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, OrePrefixes.nugget.get(Materials.Invar), GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Invar, 3), Arrays.asList(new TC_AspectStack(METALLUM, 2), new TC_AspectStack(GELUM, 1))));
            ...
            GregTech_API.sThaumcraftCompat.addResearch(tKey, "Cupronickel Transmutation", "Transformation of metals into cupronickel", new String[]{"GT_TRANSBRONZE", "GT_TRANSNICKEL"}, "ALCHEMY", GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Cupronickel), 2, 1, 11, 16, Arrays.asList(new TC_AspectStack(METALLUM, 5), new TC_AspectStack(PERMUTATIO, 3), new TC_AspectStack(PERMUTATIO, 3), new TC_AspectStack(IGNIS, 3)), null, aTextTCGTPage + tKey, GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, OrePrefixes.nugget.get(Materials.Cupronickel), GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Cupronickel, 3), Arrays.asList(new TC_AspectStack(METALLUM, 2), new TC_AspectStack(PERMUTATIO, 1), new TC_AspectStack(IGNIS, 1))));
            ...
            GregTech_API.sThaumcraftCompat.addResearch(tKey, "Advanced Metallurgic Transmutation", "Mastering the basic metals", new String[]{"GT_TRANSBISMUTH", "GT_IRON_TO_STEEL", "GT_TRANSSOLDERINGALLOY", "GT_TRANSBATTERYALLOY", "GT_TRANSBRASS", "GT_TRANSELECTRUM", "GT_TRANSCUPRONICKEL", "GT_TRANSINVAR"}, "ALCHEMY", GT_OreDictUnificator.get(OrePrefixes.ingot, Materials.Iron, 1), 3, 0, 16, 14, Arrays.asList(new TC_AspectStack(METALLUM, 50), new TC_AspectStack(PERMUTATIO, 20), new TC_AspectStack(COGNITIO, 20), new TC_AspectStack(PRAECANTATIO, 20), new TC_AspectStack(NEBRISUM, 20), new TC_AspectStack(MAGNETO, 20)), null, aTextTCGTPage + tKey);
            ...
            GregTech_API.sThaumcraftCompat.addResearch(tKey, "Aluminium Transmutation", "Transformation of metals into aluminium", new String[]{"GT_ADVANCEDMETALLURGY"}, "ALCHEMY", GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Aluminium, 1), 4, 0, 19, 14, Arrays.asList(new TC_AspectStack(METALLUM, 5), new TC_AspectStack(PERMUTATIO, 3), new TC_AspectStack(VOLATUS, 3), new TC_AspectStack(ORDO, 3), new TC_AspectStack(IGNIS, 3)), null, aTextTCGTPage + tKey, GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, OrePrefixes.nugget.get(Materials.Aluminium), GT_OreDictUnificator.get(OrePrefixes.nugget, Materials.Aluminium, 3), Arrays.asList(new TC_AspectStack(METALLUM, 2), new TC_AspectStack(VOLATUS, 1), new TC_AspectStack(ORDO, 1), new TC_AspectStack(IGNIS, 1))));
            ...
            GregTech_API.sThaumcraftCompat.addResearch(tKey, "Shard Recrystallisation", "Fixing your precious crystals", new String[]{"ALCHEMICALMANUFACTURE"}, "ALCHEMY", GT_OreDictUnificator.get(OrePrefixes.gem, Materials.InfusedOrder, 1), 3, 0, -11, -3, Arrays.asList(new TC_AspectStack(VITREUS, 5), new TC_AspectStack(PERMUTATIO, 3), new TC_AspectStack(ORDO, 3)), null, aTextTCGTPage + tKey, GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, OrePrefixes.dust.get(Materials.Amber), GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Amber, 1), Arrays.asList(new TC_AspectStack(VITREUS, 4))), GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, OrePrefixes.dust.get(Materials.InfusedOrder), GT_OreDictUnificator.get(OrePrefixes.gem, Materials.InfusedOrder, 1), Arrays.asList(new TC_AspectStack(VITREUS, 4))), GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, OrePrefixes.dust.get(Materials.InfusedEntropy), GT_OreDictUnificator.get(OrePrefixes.gem, Materials.InfusedEntropy, 1), Arrays.asList(new TC_AspectStack(VITREUS, 4))), GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, OrePrefixes.dust.get(Materials.InfusedAir), GT_OreDictUnificator.get(OrePrefixes.gem, Materials.InfusedAir, 1), Arrays.asList(new TC_AspectStack(VITREUS, 4))), GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, OrePrefixes.dust.get(Materials.InfusedEarth), GT_OreDictUnificator.get(OrePrefixes.gem, Materials.InfusedEarth, 1), Arrays.asList(new TC_AspectStack(VITREUS, 4))), GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, OrePrefixes.dust.get(Materials.InfusedFire), GT_OreDictUnificator.get(OrePrefixes.gem, Materials.InfusedFire, 1), Arrays.asList(new TC_AspectStack(VITREUS, 4))), GregTech_API.sThaumcraftCompat.addCrucibleRecipe(tKey, OrePrefixes.dust.get(Materials.InfusedWater), GT_OreDictUnificator.get(OrePrefixes.gem, Materials.InfusedWater, 1), Arrays.asList(new TC_AspectStack(VITREUS, 4))));

            tKey = "GT_MAGICENERGY";
            GT_LanguageManager.addStringLocalization(aTextTCGTPage + tKey, "While trying to find new ways to integrate magic into your industrial factories, you have discovered a way to convert magical energy into electrical power.");
            GregTech_API.sThaumcraftCompat.addResearch(tKey, "Magic Energy Conversion", "Magic to Power", new String[]{"ARCANEBORE"}, "ARTIFICE", ItemList.MagicEnergyConverter_LV.get(1), 3, 0, -3, 10,
                Arrays.asList(new TC_AspectStack(MACHINA, 10), new TC_AspectStack(COGNITIO, 10), new TC_AspectStack(POTENTIA, 20), new TC_AspectStack(ELECTRUM, 10)), null, aTextTCGTPage + tKey, GregTech_API.sThaumcraftCompat.addInfusionRecipe(tKey, ItemList.Hull_LV.get(1),
                new ItemStack[]{new ItemStack(Blocks.beacon), GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Advanced), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Thaumium), ItemList.Sensor_MV.get(2), GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Advanced), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Thaumium), ItemList.Sensor_MV.get(2)},
                ItemList.MagicEnergyConverter_LV.get(1), 5, Arrays.asList(new TC_AspectStack(POTENTIA, 32), new TC_AspectStack(ELECTRUM, 16), new TC_AspectStack(MACHINA, 32))));
            ...
            GregTech_API.sThaumcraftCompat.addResearch(tKey,
                    ...
                    1, 1, -4, 12,
                    Arrays.asList(new TC_AspectStack(MACHINA, 10),
                            new TC_AspectStack(COGNITIO, 10),
                            new TC_AspectStack(POTENTIA, 20),
                            new TC_AspectStack(ELECTRUM, 10)),
                    null, aTextTCGTPage + tKey,
                    GregTech_API.sThaumcraftCompat.addInfusionRecipe(tKey,
                            ItemList.Hull_MV.get(1),
                            new ItemStack[]{
                                    new ItemStack(Blocks.beacon),
                                    GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Data),
                                    GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Thaumium),
                                    ItemList.Sensor_HV.get(2),
                                    GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Data),
                                    GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Iridium),
                                    ItemList.Sensor_HV.get(2)
                            },
                            ItemList.MagicEnergyConverter_MV.get(1),
                            6,
                            Arrays.asList(new TC_AspectStack(POTENTIA, 64),
                                    new TC_AspectStack(ELECTRUM, 32),
                                    new TC_AspectStack(MACHINA, 64))));
            ...
            GregTech_API.sThaumcraftCompat.addResearch(tKey,
                    ...
                    1, 1, -4, 14,
                    Arrays.asList(new TC_AspectStack(MACHINA, 20),
                            new TC_AspectStack(COGNITIO, 20),
                            new TC_AspectStack(POTENTIA, 40),
                            new TC_AspectStack(ELECTRUM, 20)),
                    null, aTextTCGTPage + tKey,
                    GregTech_API.sThaumcraftCompat.addInfusionRecipe(tKey,
                            ItemList.Hull_HV.get(1),
                            new ItemStack[]{
                                    new ItemStack(Blocks.beacon),
                                    GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Elite),
                                    GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Thaumium),
                                    ItemList.Field_Generator_MV.get(1),
                                    GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Elite),
                                    GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Osmium),
                                    ItemList.Field_Generator_MV.get(1)
                            },
                            ItemList.MagicEnergyConverter_HV.get(1),
                            8,
                            Arrays.asList(new TC_AspectStack(POTENTIA, 128),
                                    new TC_AspectStack(ELECTRUM, 64),
                                    new TC_AspectStack(MACHINA, 128))));
            ...
            GregTech_API.sThaumcraftCompat.addResearch(tKey,
                    ...
                    GregTech_API.sThaumcraftCompat.addInfusionRecipe(tKey,
                            ...
                            new ItemStack[]{
                                    ...
                                    GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Advanced),
                                    GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Thaumium),
                                    ItemList.Sensor_MV.get(2)
                            },
                            ItemList.MagicEnergyAbsorber_LV.get(1),
                            6,
                            Arrays.asList(new TC_AspectStack(POTENTIA, 32),
                                    new TC_AspectStack(ELECTRUM, 16),
                                    new TC_AspectStack(MACHINA, 32),
                                    new TC_AspectStack(VACUOS, 16),
                                    new TC_AspectStack(INSTRUMENTUM, 32),
                                    new TC_AspectStack(STRONTIO, 4))));
            ...
            GregTech_API.sThaumcraftCompat.addResearch(tKey,
                    ...
                    GregTech_API.sThaumcraftCompat.addInfusionRecipe(tKey,
                            ...
                            Arrays.asList(new TC_AspectStack(POTENTIA, 64),
                                    new TC_AspectStack(ELECTRUM, 32),
                                    new TC_AspectStack(MACHINA, 64),
                                    new TC_AspectStack(VACUOS, 32),
                                    new TC_AspectStack(INSTRUMENTUM, 64),
                                    new TC_AspectStack(STRONTIO, 8)))
                    ...
                    Arrays.asList(new TC_AspectStack(POTENTIA, 128),
                            new TC_AspectStack(ELECTRUM, 64),
                            new TC_AspectStack(MACHINA, 128),
                            new TC_AspectStack(VACUOS, 64),
                            new TC_AspectStack(INSTRUMENTUM, 128),
                            new TC_AspectStack(STRONTIO, 16)))
                    ...
                    new ItemStack[]{
                            ItemList.MagicEnergyConverter_HV.get(1),
                            GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master),
                            GT_ModHandler.getModItem("Thaumcraft", "ItemResource", 1, 16),
                            ItemList.Field_Generator_HV.get(1),
                            GT_OreDictUnificator.get(OrePrefixes.circuit, Materials.Master),
                            GT_ModHandler.getModItem("Thaumcraft", "ItemResource", 1, 16)
                    ...
                    ItemList.MagicEnergyAbsorber_EV.get(1),
                    10,
                    Arrays.asList(new TC_AspectStack(POTENTIA, 256),
                            new TC_AspectStack(ELECTRUM, 128),
                            new TC_AspectStack(MACHINA, 256),
                            new TC_AspectStack(VACUOS, 128),
                            new TC_AspectStack(INSTRUMENTUM, 256),
                            new TC_AspectStack(STRONTIO, 64))));
        }
    ...
    private void addRecipesApril2017ChemistryUpdate(){
    	...
    	GT_Values.RA.addPyrolyseRecipe(new ItemStack(Items.sugar, 23), GT_Values.NF, 1, Materials.Charcoal.getDust(12), Materials.Water.getFluid(1500), 320, 64);
    	GT_Values.RA.addPyrolyseRecipe(new ItemStack(Items.sugar, 23), Materials.Nitrogen.getGas(500), 2, Materials.Charcoal.getDust(12), Materials.Water.getFluid(1500), 160, 96);
    	
    	GT_Values.RA.addUniversalDistillationRecipe(Materials.CharcoalByproducts.getGas(1000), new FluidStack[]{Materials.WoodTar.getFluid(250), Materials.WoodVinegar.getFluid(500), Materials.WoodGas.getGas(250)}, Materials.Charcoal.getDustSmall(1), 40, 256);
    	GT_Values.RA.addUniversalDistillationRecipe(Materials.WoodGas.getGas(1000), new FluidStack[]{Materials.CarbonDioxide.getGas(490), Materials.Ethylene.getGas(20), Materials.Methane.getGas(130), Materials.CarbonMonoxide.getGas(340), Materials.Hydrogen.getGas(20)}, GT_Values.NI, 40, 256);
    	GT_Values.RA.addUniversalDistillationRecipe(Materials.WoodVinegar.getFluid(1000), new FluidStack[]{Materials.AceticAcid.getFluid(100), Materials.Water.getFluid(500), Materials.Ethanol.getFluid(10), Materials.Methanol.getFluid(300), Materials.Acetone.getFluid(50), Materials.MethylAcetate.getFluid(10)}, GT_Values.NI, 40, 256);
    	GT_Values.RA.addUniversalDistillationRecipe(Materials.WoodTar.getFluid(1000), new FluidStack[]{Materials.Creosote.getFluid(500), Materials.Phenol.getFluid(75), Materials.Benzene.getFluid(350), Materials.Toluene.getFluid(75)}, GT_Values.NI, 40, 256);
        ...
        GT_Values.RA.addMixerRecipe(new ItemStack(Items.sugar, 4), GT_Values.NI, GT_Values.NI, GT_Values.NI, Materials.SulfuricAcid.getFluid(1000), Materials.DilutedSulfuricAcid.getFluid(1000), Materials.Charcoal.getGems(1), 1200, 2);
    ...
    private void addOldChemicalRecipes() {
        ...
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Nitrogen), ItemList.Circuit_Integrated.getWithDamage(0, 1), Materials.Oxygen.getGas(2000), Materials.NitrogenDioxide.getGas(1000), ItemList.Cell_Empty.get(1), 1250);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Oxygen, 2), ItemList.Circuit_Integrated.getWithDamage(0, 1), Materials.Nitrogen.getGas(1000), Materials.NitrogenDioxide.getGas(1000), ItemList.Cell_Empty.get(2), 1250);

        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur), ItemList.Circuit_Integrated.getWithDamage(0, 1), Materials.Water.getFluid(1000), Materials.SulfuricAcid.getFluid(1000), GT_Values.NI, 1150);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 2), Materials.Oxygen.getGas(4000), Materials.SulfuricAcid.getFluid(1000), ItemList.Cell_Empty.get(2), 1150);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Oxygen, 4), Materials.Hydrogen.getGas(2000), Materials.SulfuricAcid.getFluid(1000), ItemList.Cell_Empty.get(4), 1150);

        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.HydricSulfide, 2), Materials.Water.getCells(2), null, Materials.SulfuricAcid.getFluid(2000), ItemList.Cell_Empty.get(4), 320);
        ...
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.HydricSulfide, 2), null, Materials.Water.getFluid(2000),         Materials.SulfuricAcid.getFluid(2000), ItemList.Cell_Empty.get(2), 320);
        ...
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Titanium), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Oxygen, 16), Materials.Naphtha.getFluid(1296), Materials.Plastic.getMolten(1296), ItemList.Cell_Empty.get(16), 640);

        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Naphtha, 3), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.NitrogenDioxide), new FluidStack(ItemList.sEpichlorhydrin, 144), Materials.Epoxid.getMolten(288), ItemList.Cell_Empty.get(4), 240, 30);

        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Carbon), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Chlorine), Materials.LPG.getFluid(432), new FluidStack(ItemList.sEpichlorhydrin, 432), ItemList.Cell_Empty.get(1), 480, 30);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Naphtha, 3), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Fluorine), new FluidStack(ItemList.sEpichlorhydrin, 432), Materials.Polytetrafluoroethylene.getMolten(432), ItemList.Cell_Empty.get(4), 240, 256);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Silicon), null, new FluidStack(ItemList.sEpichlorhydrin, 144), Materials.Silicone.getMolten(144), GT_Values.NI, 240, 96);

        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.NitrogenDioxide), GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Hydrogen, 3), Materials.Air.getGas(500), new FluidStack(ItemList.sRocketFuel,3000), Materials.Water.getCells(4), 1000, 388);
        ...
        GT_Values.RA.addCentrifugeRecipe(ItemList.Cell_Empty.get(4), GT_Values.NI, Materials.RefineryGas.getGas(8000), GT_Values.NF, GT_OreDictUnificator.get(OrePrefixes.cell, Materials.LPG, 4), GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, GT_Values.NI, new int[]{10000}, 200, 5);

        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Fuel), GT_Values.NI, Materials.Glyceryl.getFluid(250), Materials.NitroFuel.getFluid(1000), ItemList.Cell_Empty.get(1), 250);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Glyceryl), GT_Values.NI, Materials.Fuel.getFluid(4000), Materials.NitroFuel.getFluid(4000), ItemList.Cell_Empty.get(1), 1000);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.LightFuel), GT_Values.NI, Materials.Glyceryl.getFluid(250), Materials.NitroFuel.getFluid(1250), ItemList.Cell_Empty.get(1), 250);
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Glyceryl), GT_Values.NI, Materials.LightFuel.getFluid(4000), Materials.NitroFuel.getFluid(5000), ItemList.Cell_Empty.get(1), 1000);

        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sulfur), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Sodium), Materials.Oxygen.getGas(4000), Materials.SodiumPersulfate.getFluid(6000), GT_Values.NI, 8000);
        ...
        GT_Values.RA.addChemicalRecipe(GT_OreDictUnificator.get(OrePrefixes.cell, Materials.Nitrogen), GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Carbon), Materials.Water.getFluid(2000), Materials.Glyceryl.getFluid(4000), ItemList.Cell_Empty.get(1), 2700);
        GT_Values.RA.setIsAddingDeprecatedRecipes(false);
    }

    private void addRecipesMay2017OilRefining() {
        GT_Values.RA.addUniversalDistillationRecipe(Materials.RefineryGas.getGas(1000), new FluidStack[]{Materials.Butane.getGas(60), Materials.Propane.getGas(70), Materials.Ethane.getGas(100), Materials.Methane.getGas(750), Materials.Helium.getGas(20)}, GT_Values.NI, 240, 120);
        ...
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Ethylene.getHydroCrackedFluid(0, 1000), new FluidStack[]{Materials.Ethane.getGas(1000)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Ethylene.getHydroCrackedFluid(1, 1000), new FluidStack[]{Materials.Methane.getGas(2000)}, null, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Ethylene.getHydroCrackedFluid(2, 1000), new FluidStack[]{Materials.Methane.getGas(2000), Materials.Hydrogen.getGas(2000)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Ethylene.getSteamCrackedFluid(0, 1000), new FluidStack[]{Materials.Methane.getGas(1000)}, Materials.Carbon.getDust(1), 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Ethylene.getSteamCrackedFluid(1, 1000), new FluidStack[]{Materials.Methane.getGas(1000)}, Materials.Carbon.getDust(1), 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Ethylene.getSteamCrackedFluid(2, 1000), new FluidStack[]{Materials.Methane.getGas(1000)}, Materials.Carbon.getDust(1), 120, 120);

        GT_Values.RA.addUniversalDistillationRecipe(Materials.Ethane.getHydroCrackedFluid(0, 1000), new FluidStack[]{Materials.Methane.getGas(2000)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Ethane.getHydroCrackedFluid(1, 1000), new FluidStack[]{Materials.Methane.getGas(2000), Materials.Hydrogen.getGas(2000)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Ethane.getHydroCrackedFluid(2, 1000), new FluidStack[]{Materials.Methane.getGas(2000), Materials.Hydrogen.getGas(4000)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Ethane.getSteamCrackedFluid(0, 1000), new FluidStack[]{Materials.Ethylene.getGas(250), Materials.Methane.getGas(1250)}, Materials.Carbon.getDustSmall(1), 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Ethane.getSteamCrackedFluid(1, 2000), new FluidStack[]{Materials.Ethylene.getGas(250), Materials.Methane.getGas(2750)}, Materials.Carbon.getDustSmall(3), 240, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Ethane.getSteamCrackedFluid(2, 1000), new FluidStack[]{Materials.Methane.getGas(1500)}, Materials.Carbon.getDustSmall(2), 120, 120);

        GT_Values.RA.addUniversalDistillationRecipe(Materials.Propene.getHydroCrackedFluid(0, 1000), new FluidStack[]{Materials.Propane.getGas(500), Materials.Ethylene.getGas(500), Materials.Methane.getGas(500)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Propene.getHydroCrackedFluid(1, 1000), new FluidStack[]{Materials.Ethane.getGas(1000), Materials.Methane.getGas(1000)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Propene.getHydroCrackedFluid(2, 1000), new FluidStack[]{Materials.Methane.getGas(3000)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Propene.getSteamCrackedFluid(0, 1000), new FluidStack[]{Materials.Ethylene.getGas(1000), Materials.Methane.getGas(500)}, Materials.Carbon.getDustSmall(2), 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Propene.getSteamCrackedFluid(1, 1000), new FluidStack[]{Materials.Ethylene.getGas(750), Materials.Methane.getGas(750)}, Materials.Carbon.getDustSmall(3), 180, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Propene.getSteamCrackedFluid(2, 1000), new FluidStack[]{Materials.Methane.getGas(1500)}, Materials.Carbon.getDustSmall(6), 180, 120);

        GT_Values.RA.addUniversalDistillationRecipe(Materials.Propane.getHydroCrackedFluid(0, 1000), new FluidStack[]{Materials.Ethane.getGas(1000), Materials.Methane.getGas(1000)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Propane.getHydroCrackedFluid(1, 1000), new FluidStack[]{Materials.Methane.getGas(3000)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Propane.getHydroCrackedFluid(2, 1000), new FluidStack[]{Materials.Methane.getGas(3000), Materials.Hydrogen.getGas(2000)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Propane.getSteamCrackedFluid(0, 2000), new FluidStack[]{Materials.Ethylene.getGas(1500), Materials.Methane.getGas(2500)}, Materials.Carbon.getDustSmall(1), 240, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Propane.getSteamCrackedFluid(1, 1000), new FluidStack[]{Materials.Ethylene.getGas(500), Materials.Methane.getGas(1500)}, Materials.Carbon.getDustSmall(1), 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Propane.getSteamCrackedFluid(2, 2000), new FluidStack[]{Materials.Ethylene.getGas(500), Materials.Methane.getGas(3500)}, Materials.Carbon.getDustSmall(3), 240, 120);

        GT_Values.RA.addUniversalDistillationRecipe(Materials.Butadiene.getHydroCrackedFluid(0, 750), new FluidStack[]{Materials.Butene.getGas(500), Materials.Ethylene.getGas(500)}, GT_Values.NI, 90, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Butadiene.getHydroCrackedFluid(1, 900), new FluidStack[]{Materials.Butane.getGas(200), Materials.Propene.getGas(200), Materials.Ethane.getGas(400), Materials.Ethylene.getGas(400), Materials.Methane.getGas(200)}, GT_Values.NI, 108, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Butadiene.getHydroCrackedFluid(2, 270), new FluidStack[]{Materials.Propane.getGas(70), Materials.Ethane.getGas(250), Materials.Ethylene.getGas(105), Materials.Methane.getGas(720)}, GT_Values.NI, 30, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Butadiene.getSteamCrackedFluid(0, 2000), new FluidStack[]{Materials.Propene.getGas(1500), Materials.Ethylene.getGas(375), Materials.Methane.getGas(375)}, Materials.Carbon.getDustSmall(6), 240, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Butadiene.getSteamCrackedFluid(1, 2000), new FluidStack[]{Materials.Propene.getGas(250), Materials.Ethylene.getGas(2250), Materials.Methane.getGas(375)}, Materials.Carbon.getDustSmall(6), 240, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Butadiene.getSteamCrackedFluid(2, 2000), new FluidStack[]{Materials.Propene.getGas(250), Materials.Ethylene.getGas(375), Materials.Methane.getGas(2250)}, Materials.Carbon.getDust(2), 240, 120);

        GT_Values.RA.addUniversalDistillationRecipe(Materials.Butene.getHydroCrackedFluid(0, 750), new FluidStack[]{Materials.Butane.getGas(250), Materials.Propene.getGas(250), Materials.Ethane.getGas(250), Materials.Ethylene.getGas(250), Materials.Methane.getGas(250)}, GT_Values.NI, 90, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Butene.getHydroCrackedFluid(1, 900), new FluidStack[]{Materials.Propane.getGas(350), Materials.Ethane.getGas(500), Materials.Ethylene.getGas(300), Materials.Methane.getGas(950)}, GT_Values.NI, 108, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Butene.getHydroCrackedFluid(2, 1000), new FluidStack[]{Materials.Ethane.getGas(1000), Materials.Methane.getGas(2000)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Butene.getSteamCrackedFluid(0, 1000), new FluidStack[]{Materials.Propene.getGas(750), Materials.Ethylene.getGas(500), Materials.Methane.getGas(250)}, Materials.Carbon.getDustSmall(1), 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Butene.getSteamCrackedFluid(1, 1250), new FluidStack[]{Materials.Propene.getGas(250), Materials.Ethylene.getGas(1625), Materials.Methane.getGas(500)}, Materials.Carbon.getDustSmall(2), 240, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Butene.getSteamCrackedFluid(2, 2000), new FluidStack[]{Materials.Propene.getGas(250), Materials.Ethylene.getGas(625), Materials.Methane.getGas(3000)}, Materials.Carbon.getDust(3), 240, 120);

        GT_Values.RA.addUniversalDistillationRecipe(Materials.Butane.getHydroCrackedFluid(0, 750), new FluidStack[]{Materials.Propane.getGas(500), Materials.Ethane.getGas(500), Materials.Methane.getGas(500)}, GT_Values.NI, 90, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Butane.getHydroCrackedFluid(1, 1000), new FluidStack[]{Materials.Ethane.getGas(1000), Materials.Methane.getGas(2000)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Butane.getHydroCrackedFluid(2, 1000), new FluidStack[]{Materials.Methane.getGas(4000)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Butane.getSteamCrackedFluid(0, 4000), new FluidStack[]{Materials.Propane.getGas(3000), Materials.Ethane.getGas(500), Materials.Ethylene.getGas(500), Materials.Methane.getGas(4250)}, Materials.Carbon.getDustSmall(3), 480, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Butane.getSteamCrackedFluid(1, 4000), new FluidStack[]{Materials.Propane.getGas(500), Materials.Ethane.getGas(3000), Materials.Ethylene.getGas(3000), Materials.Methane.getGas(1750)}, Materials.Carbon.getDustSmall(3), 480, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Butane.getSteamCrackedFluid(2, 2000), new FluidStack[]{Materials.Propane.getGas(250), Materials.Ethane.getGas(250), Materials.Ethylene.getGas(250), Materials.Methane.getGas(4000)}, Materials.Carbon.getDustSmall(9), 240, 120);

        GT_Values.RA.addUniversalDistillationRecipe(Materials.RefineryGas.getHydroCrackedFluid(0, 1000), new FluidStack[]{Materials.Methane.getGas(1400), Materials.Hydrogen.getGas(1340), Materials.Helium.getGas(20)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.RefineryGas.getHydroCrackedFluid(1, 1000), new FluidStack[]{Materials.Methane.getGas(1400), Materials.Hydrogen.getGas(3340), Materials.Helium.getGas(20)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.RefineryGas.getHydroCrackedFluid(2, 1000), new FluidStack[]{Materials.Methane.getGas(1400), Materials.Hydrogen.getGas(4340), Materials.Helium.getGas(20)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.RefineryGas.getSteamCrackedFluid(0, 2500), new FluidStack[]{Materials.Propene.getGas(113), Materials.Ethane.getGas(19), Materials.Ethylene.getGas(213), Materials.Methane.getGas(2566), Materials.Helium.getGas(50)}, Materials.Carbon.getDustTiny(1), 300, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.RefineryGas.getSteamCrackedFluid(1, 1700), new FluidStack[]{Materials.Propene.getGas(13), Materials.Ethane.getGas(77), Materials.Ethylene.getGas(157), Materials.Methane.getGas(1732), Materials.Helium.getGas(34)}, Materials.Carbon.getDustTiny(1), 204, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.RefineryGas.getSteamCrackedFluid(2, 800), new FluidStack[]{Materials.Propene.getGas(6), Materials.Ethane.getGas(6), Materials.Ethylene.getGas(20), Materials.Methane.getGas(914), Materials.Helium.getGas(16)}, Materials.Carbon.getDustTiny(1), 96, 120);

        GT_Values.RA.addUniversalDistillationRecipe(Materials.Naphtha.getHydroCrackedFluid(0, 1000), new FluidStack[]{Materials.Butane.getGas(800), Materials.Propane.getGas(300), Materials.Ethane.getGas(250), Materials.Methane.getGas(250)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Naphtha.getHydroCrackedFluid(1, 1000), new FluidStack[]{Materials.Butane.getGas(200), Materials.Propane.getGas(1100), Materials.Ethane.getGas(400), Materials.Methane.getGas(400)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Naphtha.getHydroCrackedFluid(2, 1000), new FluidStack[]{Materials.Butane.getGas(125), Materials.Propane.getGas(125), Materials.Ethane.getGas(1500), Materials.Methane.getGas(1500)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Naphtha.getSteamCrackedFluid(0, 1000), new FluidStack[]{Materials.HeavyFuel.getFluid(75), Materials.LightFuel.getFluid(150), Materials.Toluene.getFluid(40), Materials.Benzene.getFluid(150), Materials.Butene.getGas(80), Materials.Butadiene.getGas(150), Materials.Propane.getGas(15), Materials.Propene.getGas(200), Materials.Ethane.getGas(35), Materials.Ethylene.getGas(200), Materials.Methane.getGas(200)}, Materials.Carbon.getDustTiny(1), 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Naphtha.getSteamCrackedFluid(1, 1000), new FluidStack[]{Materials.HeavyFuel.getFluid(50), Materials.LightFuel.getFluid(100), Materials.Toluene.getFluid(30), Materials.Benzene.getFluid(125), Materials.Butene.getGas(65), Materials.Butadiene.getGas(100), Materials.Propane.getGas(30), Materials.Propene.getGas(400), Materials.Ethane.getGas(50), Materials.Ethylene.getGas(350), Materials.Methane.getGas(350)}, Materials.Carbon.getDustTiny(2), 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.Naphtha.getSteamCrackedFluid(2, 1000), new FluidStack[]{Materials.HeavyFuel.getFluid(25), Materials.LightFuel.getFluid(50), Materials.Toluene.getFluid(20), Materials.Benzene.getFluid(100), Materials.Butene.getGas(50), Materials.Butadiene.getGas(50), Materials.Propane.getGas(15), Materials.Propene.getGas(300), Materials.Ethane.getGas(65), Materials.Ethylene.getGas(500), Materials.Methane.getGas(500)}, Materials.Carbon.getDustTiny(3), 120, 120);

        GT_Values.RA.addUniversalDistillationRecipe(Materials.LightFuel.getHydroCrackedFluid(0, 1000), new FluidStack[]{Materials.Naphtha.getFluid(800), Materials.Butane.getGas(150), Materials.Propane.getGas(200), Materials.Ethane.getGas(125), Materials.Methane.getGas(125)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.LightFuel.getHydroCrackedFluid(1, 1000), new FluidStack[]{Materials.Naphtha.getFluid(500), Materials.Butane.getGas(200), Materials.Propane.getGas(1100), Materials.Ethane.getGas(400), Materials.Methane.getGas(400)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.LightFuel.getHydroCrackedFluid(2, 1000), new FluidStack[]{Materials.Naphtha.getFluid(200), Materials.Butane.getGas(125), Materials.Propane.getGas(125), Materials.Ethane.getGas(1500), Materials.Methane.getGas(1500)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.LightFuel.getSteamCrackedFluid(0, 1000), new FluidStack[]{Materials.HeavyFuel.getFluid(150), Materials.Naphtha.getFluid(400), Materials.Toluene.getFluid(40), Materials.Benzene.getFluid(200), Materials.Butene.getGas(75), Materials.Butadiene.getGas(60), Materials.Propane.getGas(20), Materials.Propene.getGas(150), Materials.Ethane.getGas(10), Materials.Ethylene.getGas(50), Materials.Methane.getGas(50)}, Materials.Carbon.getDustTiny(1), 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.LightFuel.getSteamCrackedFluid(1, 1000), new FluidStack[]{Materials.HeavyFuel.getFluid(100), Materials.Naphtha.getFluid(250), Materials.Toluene.getFluid(50), Materials.Benzene.getFluid(300), Materials.Butene.getGas(90), Materials.Butadiene.getGas(75), Materials.Propane.getGas(35), Materials.Propene.getGas(200), Materials.Ethane.getGas(30), Materials.Ethylene.getGas(150), Materials.Methane.getGas(150)}, Materials.Carbon.getDustTiny(2), 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.LightFuel.getSteamCrackedFluid(2, 1000), new FluidStack[]{Materials.HeavyFuel.getFluid(50), Materials.Naphtha.getFluid(100), Materials.Toluene.getFluid(30), Materials.Benzene.getFluid(150), Materials.Butene.getGas(65), Materials.Butadiene.getGas(50), Materials.Propane.getGas(50), Materials.Propene.getGas(250), Materials.Ethane.getGas(50), Materials.Ethylene.getGas(250), Materials.Methane.getGas(250)}, Materials.Carbon.getDustTiny(3), 120, 120);

        GT_Values.RA.addUniversalDistillationRecipe(Materials.HeavyFuel.getHydroCrackedFluid(0, 1000), new FluidStack[]{Materials.LightFuel.getFluid(600), Materials.Naphtha.getFluid(100), Materials.Butane.getGas(100), Materials.Propane.getGas(100), Materials.Ethane.getGas(75), Materials.Methane.getGas(75)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.HeavyFuel.getHydroCrackedFluid(1, 1000), new FluidStack[]{Materials.LightFuel.getFluid(400), Materials.Naphtha.getFluid(400), Materials.Butane.getGas(150), Materials.Propane.getGas(150), Materials.Ethane.getGas(100), Materials.Methane.getGas(100)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.HeavyFuel.getHydroCrackedFluid(2, 1000), new FluidStack[]{Materials.LightFuel.getFluid(200), Materials.Naphtha.getFluid(250), Materials.Butane.getGas(300), Materials.Propane.getGas(300), Materials.Ethane.getGas(175), Materials.Methane.getGas(175)}, GT_Values.NI, 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.HeavyFuel.getSteamCrackedFluid(0, 1000), new FluidStack[]{Materials.LightFuel.getFluid(300), Materials.Naphtha.getFluid(50), Materials.Toluene.getFluid(25), Materials.Benzene.getFluid(125), Materials.Butene.getGas(25), Materials.Butadiene.getGas(15), Materials.Propane.getGas(3), Materials.Propene.getGas(30), Materials.Ethane.getGas(5), Materials.Ethylene.getGas(50), Materials.Methane.getGas(50)}, Materials.Carbon.getDustTiny(1), 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.HeavyFuel.getSteamCrackedFluid(1, 1000), new FluidStack[]{Materials.LightFuel.getFluid(200), Materials.Naphtha.getFluid(200), Materials.Toluene.getFluid(40), Materials.Benzene.getFluid(200), Materials.Butene.getGas(40), Materials.Butadiene.getGas(25), Materials.Propane.getGas(5), Materials.Propene.getGas(50), Materials.Ethane.getGas(7), Materials.Ethylene.getGas(75), Materials.Methane.getGas(75)}, Materials.Carbon.getDustTiny(2), 120, 120);
        GT_Values.RA.addUniversalDistillationRecipe(Materials.HeavyFuel.getSteamCrackedFluid(2, 1000), new FluidStack[]{Materials.LightFuel.getFluid(100), Materials.Naphtha.getFluid(125), Materials.Toluene.getFluid(80), Materials.Benzene.getFluid(400), Materials.Butene.getGas(80), Materials.Butadiene.getGas(50), Materials.Propane.getGas(10), Materials.Propene.getGas(100), Materials.Ethane.getGas(15), Materials.Ethylene.getGas(150), Materials.Methane.getGas(150)}, Materials.Carbon.getDustTiny(3), 120, 120);
    }

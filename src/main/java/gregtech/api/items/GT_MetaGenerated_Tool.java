    ...
    public void addAdditionalToolTips(List aList, ItemStack aStack, EntityPlayer aPlayer) {
        ...
        if (tStats != null) {
            ...
            if (name.equals("gt.metatool.01.170") || name.equals("gt.metatool.01.172") || name.equals("gt.metatool.01.174") || name.equals("gt.metatool.01.176")) {
                ...
                aList.add(tOffset + 3, EnumChatFormatting.WHITE + "Optimal RefineryGas flow(EU burnvalue per tick): " + EnumChatFormatting.LIGHT_PURPLE + Math.max(Float.MIN_NORMAL, tStats.getSpeedMultiplier() * getPrimaryMaterial(aStack).mToolSpeed * 50) + EnumChatFormatting.GRAY + "EU/t");

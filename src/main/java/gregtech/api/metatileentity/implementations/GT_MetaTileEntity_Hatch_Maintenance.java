...
public class GT_MetaTileEntity_Hatch_Maintenance extends GT_MetaTileEntity_Hatch {
    ...
    public boolean autoMaintainance() {
        ...
        ItemStack[] mInputs = new ItemStack[]{ItemList.Duct_Tape.get(4), MatUnifier.get(OrePrefixes.cell, Materials.Lubricant, 2), MatUnifier.get(OrePrefixes.screw, Materials.Steel, 4), MatUnifier.get(OrePrefixes.circuit, Materials.Advanced, 2)};
    ...
    public void onToolClick(ItemStack aStack, EntityLivingBase aPlayer) {
        ...
        if (MatUnifier.isItemStackInstanceOf(aStack, "craftingDuctTape")) {

...
public class GTNH_ExtraMaterials implements IMaterialHandler {
    ...
    public static Materials GAGPanties              = new Materials( 783, TextureSet.SET_SHINY              ,   1.0F,    0,  1, 1                           , 179, 255, 252,   0,   "GAGPanties"              ,   "Ground Anime Girl Panties"     ,    0,       0,         -1,    0, false,  false,   3,   1,   1, Dyes.dyeLightBlue  );
    public static Materials RefPMagium              = new Materials( 784, TextureSet.SET_SHINY              ,   1.0F,    0,  1, 1                           , 255, 164, 145,   0,   "RedfinedPuellamagium"   ,   "Refined Puella Magium"         ,    0,       0,         -1,    0, false,  false,   3,   1,   1, Dyes.dyePink  );

...
public class GTNH_ExtraMaterials implements IMaterialHandler {
    ...
    public static Materials GGEssence               = new Materials(  769, TextureSet.SET_QUARTZ             ,  1.0F,      0,  1,  1|4|8|64                 ,251, 181, 255,   0,   "GGessence"                ,   "Gamer Girl Essence"            ,    0,    0,       -1,    0, false, false,   3,   1,   1, Dyes.dyePink     );
    ...
    public static Materials PMagium                 = new Materials(  743, TextureSet.SET_METALLIC          ,  512.0F,     1024000, 8,1|2        |64           , 248, 186, 173,   0,   "PuellaMagium"             ,    PuellaMagium                  ,    5,       750000,    7200,  7200, true, false,   2,   1,   1, Dyes.dyePink      , 2, Arrays.asList(new MaterialStack(GGEssence, 1), new MaterialStack(Weebium, 1)), Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.ALIENIS, 15))).disableAutoGeneratedBlastFurnaceRecipes();
    ...
    private static void initSubTags() {
        ...
        GGEssence                    .add(SubTag.CRYSTAL, SubTag.NO_SMASHING, SubTag.NO_SMELTING);

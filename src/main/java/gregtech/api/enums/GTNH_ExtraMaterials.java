...
public class GTNH_ExtraMaterials implements IMaterialHandler {
    ...
    public static Materials Testmat                 = new Materials(  790, TextureSet.SET_METALLIC         ,  25.0F,      512000, 8, 1|2|8|16|32|64|128       , 247, 158, 247,   0,   "Testmat"                 ,   "Testmat"                       ,    0,       0,       3695,     5400,  true,   false,   2,   1,   1, Dyes.dyePink       , Element.Wb        , Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.ALIENIS, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.VICTUS, 1))).disableAutoGeneratedBlastFurnaceRecipes();

    public static Materials PMagium                 = new Materials(  743, TextureSet.SET_METALLIC         ,  512.0F,     1024000, 9,1|2|4|8  |16   |64|128       , 248, 186, 173,   0,   "PuellaMagium"            ,    PuellaMagium                                    ,    0,      0,       7200,  7200,    true,   false,   2,   1,   1, Dyes.dyePink      , 2, Arrays.asList(new MaterialStack(AGEssence, 3), new MaterialStack(Weebium, 7)), Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.ALIENIS, 15))).disableAutoGeneratedBlastFurnaceRecipes();
    ...
    public static Materials AbsoluteOtaku            = new Materials(  -1, TextureSet.SET_NONE              ,   1.0F,      0,  0, 0                         , 255, 255, 255,   0,   "AbsoluteOtaku"                     ,   "AbsoluteOtaku"                           ,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes.dyeLightGray   , Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.ELECTRUM, 64)));

     //public static Materials Testmaterial            = new Materials( 790, TextureSet.SET_SHINY              ,   7.0F,    256,  2, 1|2|4|8|16|32|64|128          , 255, 100, 100, 127,   "Testmaterial"                    ,   "Testmaterial"          ,    0,       0,         -1,    0, false,  false,   5,   1,   1, Dyes.dyeRed         , 1, Arrays.asList(new MaterialStack(Chrome, 1), new MaterialStack(Aluminium, 2), new MaterialStack(Oxygen, 3)), Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.LUCRUM, 6), new TC_Aspects.TC_AspectStack(TC_Aspects.VITREUS, 4)));
    ...
    private static void initSubTags() {
        ...
        Weebium                      .add(SubTag.NO_PLATE_SMASHING, SubTag.NO_WIRE_SNIPPING, SubTag.NO_FOIL_SMASHING, SubTag.NO_BLOCK_SMASHING, SubTag.NO_GEAR_RECIPE_GEN, SubTag.NO_ROTOR_RECIPE_GEN);
        Testmat                      .add(SubTag.NO_PLATE_SMASHING, SubTag.NO_WIRE_SNIPPING, SubTag.NO_FOIL_SMASHING, SubTag.NO_BLOCK_SMASHING, SubTag.NO_GEAR_RECIPE_GEN, SubTag.NO_ROTOR_RECIPE_GEN);
        ...
        //PMagium                      .add(SubTag.NO_WIRE_SNIPPING,  SubTag.NO_SMASHING);

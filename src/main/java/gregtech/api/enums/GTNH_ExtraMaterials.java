...
public class GTNH_ExtraMaterials implements IMaterialHandler {
    ...
    public static Materials Bathwater               = new Materials(  766, TextureSet.SET_FLUID             ,  1.0F,      0,  1,  16,                       250, 250, 250,   0,   "GamerGirlBathWater"       ,   "Gamer Girl Bathwater"           ,    0,       0,         -1,    0, false, false,   3,   1,   1, Dyes.dyeWhite       );
    ...
    public static Materials GGEssence               = new Materials(  769, TextureSet.SET_FLUID             ,  1.0F,      0,  1,  1|16,                       251, 181, 255,   0,   "GGessence"                ,   "Gamer Girl Essence"            ,    0,       255,       -1,    0, false, false,   3,   1,   1, Dyes.dyeWhite       );

...
public class TextureSet {
    public static final TextureSet
            NONE = new TextureSet("NONE"), DULL = new TextureSet("DULL"), RUBY = new TextureSet("RUBY"), OPAL = new TextureSet("OPAL"), LEAF = new TextureSet("LEAF"), WOOD = new TextureSet("WOOD"), SAND = new TextureSet("SAND"), FINE = new TextureSet("FINE"), FIERY = new TextureSet("FIERY"), FLUID = new TextureSet("FLUID"), ROUGH = new TextureSet("ROUGH"), PAPER = new TextureSet("PAPER"), GLASS = new TextureSet("GLASS"), FLINT = new TextureSet("FLINT"), LAPIS = new TextureSet("LAPIS"), SHINY = new TextureSet("SHINY"), SHARDS = new TextureSet("SHARDS"), POWDER = new TextureSet("POWDER"), QUARTZ = new TextureSet("QUARTZ"), EMERALD = new TextureSet("EMERALD"), DIAMOND = new TextureSet("DIAMOND"), LIGNITE = new TextureSet("LIGNITE"), MAGNETIC = new TextureSet("MAGNETIC"), METALLIC = new TextureSet("METALLIC"), NETHERSTAR = new TextureSet("NETHERSTAR"), GEMV = new TextureSet("GEM_VERTICAL"), GEMH = new TextureSet("GEM_HORIZONTAL");

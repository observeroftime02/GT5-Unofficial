...
////public static Materials RefinedObsidian         = new Materials(----, TextureSet.SET_METALLIC          ,   1.0F,      0,  1, 1|2                       ,  80,  50, 100,   0,   "RefinedObsidian"         ,   "Refined Obsidian"              ,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes.dyePurple      );
    ...
    */
    ...
    public final static String SpWbUwU= EnumChatFormatting.RESET + "You just need " + EnumChatFormatting.DARK_PURPLE + "S" + EnumChatFormatting.LIGHT_PURPLE + "p" + EnumChatFormatting.DARK_RED + "W" + EnumChatFormatting.RED + "b" + EnumChatFormatting.YELLOW + "U" + EnumChatFormatting.GREEN + "w" + EnumChatFormatting.AQUA + "U";

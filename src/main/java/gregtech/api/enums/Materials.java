...
public class Materials implements IColorModulationContainer, ISubTagContainer {
    ...
    public static Materials Weebium                 = new Materials(  765, TextureSet.SET_METALLIC          ,  25.0F,     512000, 8,1|2|8|16|32|64|128     , 247, 158, 247,   0,   "Weebium"                    ,   "Weebium"                     ,    0,       0,       3695,  5400, true, false,   2,   1,   1, Dyes.dyePink       , Element.Wb        , Arrays.asList(new TC_AspectStack(TC_Aspects.ALIENIS, 2), new TC_AspectStack(TC_Aspects.VICTUS, 1))).disableAutoGeneratedBlastFurnaceRecipes();

    //GT++ materials
    //public static Materials Curium                  = new Materials( 979, TextureSet.SET_SHINY             ,   1.0F,      0,  0, 1|2  |8   |32|64|128      , 255,255, 255,   0,   "Curium_GT5U"                   ,    "Curium"                   ,     0,       0,      1340, 3110, false,  false,  1 ,  1,   1, Dyes.dyeWhite      , Element.Cm         , Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.RADIO, 2))).disableAutoGeneratedBlastFurnaceRecipes();
    //public static Materials Californium             = new Materials( 983, TextureSet.SET_SHINY             ,   1.0F,      0,  0, 1|2  |8   |32|64|128      , 255,255, 255,   0,   "Californium_GT5U"              ,    "Californium"              ,     0,       0,       899, 1472, false,  false,  1 ,  1,   1, Dyes.dyeWhite      , Element.Cf         , Arrays.asList(new TC_Aspects.TC_AspectStack(TC_Aspects.METALLUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.RADIO, 2))).disableAutoGeneratedBlastFurnaceRecipes();
...
//      Duralumin.mChemicalFormula="Al\u2086CuMnMg";
    ...
    private static void initSubTags() {
        ...
        SubTag.METAL.addTo(AnyIron, AnyCopper, AnyBronze, Metal, Aluminium, Americium, Antimony, Beryllium, Bismuth, Caesium, Cerium, Chrome, Cobalt, Copper, Dysprosium, Erbium, Europium, Gadolinium, Gallium, Gold,
                ...
                Uraniumtriplatinid, Vanadiumtriindinid, Tetraindiumditindibariumtitaniumheptacoppertetrakaidekaoxid, Tetranaquadahdiindiumhexaplatiumosminid, Longasssuperconductornameforuvwire, Longasssuperconductornameforuhvwire, Weebium);

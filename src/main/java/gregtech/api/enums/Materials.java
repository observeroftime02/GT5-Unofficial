...
////public static Materials RefinedObsidian         = new Materials(----, TextureSet.SET_METALLIC          ,   1.0F,      0,  1, 1|2                       ,  80,  50, 100,   0,   "RefinedObsidian"         ,   "Refined Obsidian"              ,    0,       0,         -1,    0, false, false,   1,   1,   1, Dyes.dyePurple      );
    ...
    public static Materials Mytryl                  = new Materials( 387, TextureSet.SET_SHINY             ,   8.0F,    512,  4, 1|2  |8      |64|128      , 247, 0,   255,   0,   "Mytryl"                  ,   "Mytryl"                        ,     0,       0,     3600,  3600,  true, false,  4,   1,   1, Dyes.dyeOrange       );
...
//      Duralumin.mChemicalFormula="Al\u2086CuMnMg";
    ...
    private static void initSubTags() {
        ...
        Wood                    .add(SubTag.WOOD, SubTag.FLAMMABLE, SubTag.NO_SMASHING);

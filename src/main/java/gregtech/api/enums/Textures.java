...
public class Textures {
    public enum BlockIcons implements IIconContainer, Runnable {
        ...
        BLOCK_SAPPHIRE, BLOCK_SODALITE, BLOCK_TANZANITE, BLOCK_TERRACRYSTAL, BLOCK_TOPAZ, BLOCK_VINTEUM, BLOCK_YELLOWGARNET, BLOCK_NETHERSTAR, BLOCK_CHARCOAL, BLOCK_BLAZE, BLOCK_WEEBIUM, MARBLE_STONE, MARBLE_COBBLE,

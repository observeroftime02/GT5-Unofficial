...
public enum ItemList implements IItemContainer {
    ...
    Electric_Motor_LV, Electric_Motor_MV, Electric_Motor_HV, Electric_Motor_EV, Electric_Motor_IV, Electric_Motor_LuV, Electric_Motor_ZPM, Electric_Motor_UV, Electric_Motor_UHV, Electric_Motor_UEV, Electric_Motor_UIV,
    Electric_Pump_LV, Electric_Pump_MV, Electric_Pump_HV, Electric_Pump_EV, Electric_Pump_IV, Electric_Pump_LuV, Electric_Pump_ZPM, Electric_Pump_UV, Electric_Pump_UHV,  Electric_Pump_UEV, Electric_Pump_UIV,
    Conveyor_Module_LV, Conveyor_Module_MV, Conveyor_Module_HV, Conveyor_Module_EV, Conveyor_Module_IV, Conveyor_Module_LuV, Conveyor_Module_ZPM, Conveyor_Module_UV, Conveyor_Module_UHV, Conveyor_Module_UEV, Conveyor_Module_UIV,
    Electric_Piston_LV, Electric_Piston_MV, Electric_Piston_HV, Electric_Piston_EV, Electric_Piston_IV, Electric_Piston_LuV, Electric_Piston_ZPM, Electric_Piston_UV,  Electric_Piston_UHV, Electric_Piston_UEV, Electric_Piston_UIV,
    Field_Generator_LV, Field_Generator_MV, Field_Generator_HV, Field_Generator_EV, Field_Generator_IV, Field_Generator_LuV, Field_Generator_ZPM, Field_Generator_UV, Field_Generator_UHV, Field_Generator_UEV, Field_Generator_UIV,
    ...
    Emitter_LV, Emitter_MV, Emitter_HV, Emitter_EV, Emitter_IV, Emitter_LuV, Emitter_ZPM, Emitter_UV, Emitter_UHV, Emitter_UEV, Emitter_UIV,
    Sensor_LV, Sensor_MV, Sensor_HV, Sensor_EV, Sensor_IV, Sensor_LuV, Sensor_ZPM, Sensor_UV, Sensor_UHV, Sensor_UEV, Sensor_UIV,
    ...
    Cover_SolarPanel_UMV,
    Cover_SolarPanel_LVx16,
    Cover_SolarPanel_MVx16,
    Cover_SolarPanel_HVx16,
    Cover_SolarPanel_EVx16,
    Cover_SolarPanel_IVx16,
    Cover_SolarPanel_LuVx16,
    Cover_SolarPanel_ZPMx16,
    Cover_SolarPanel_UVx16,
    Cover_SolarPanel_UHVx16,
    Cover_SolarPanel_UEVx16,
    Cover_SolarPanel_UIVx16,
    ...
    Casing_MiningOsmiridium, Casing_RobustTungstenSteel, Casing_CleanStainlessSteel, Casing_StableTitanium, Casing_Firebox_Titanium, Casing_Weebium, Casing_UUM,
    ...
    Hatch_Output_ULV, Hatch_Output_LV, Hatch_Output_MV, Hatch_Output_HV, Hatch_Output_EV, Hatch_Output_IV, Hatch_Output_LuV, Hatch_Output_ZPM, Hatch_Output_UV, Hatch_Output_MAX, Hatch_Output_Mega, Hatch_Input_Mega,
    ...
    Hatch_Muffler_LV, Hatch_Muffler_MV, Hatch_Muffler_HV, Hatch_Muffler_EV, Hatch_Muffler_IV, Hatch_Muffler_LuV, Hatch_Muffler_ZPM, Hatch_Muffler_UV, Hatch_Muffler_MAX, Hatch_Muffler_UEV, Hatch_Muffler_UIV,
    ...
    Machine_Multi_LargeChemicalReactor, Machine_Multi_LargeTestMachine,
    Machine_LV_Miner, Machine_MV_Miner, Machine_HV_Miner, Machine_LV_AdvancedChemicalReactor, Machine_MV_AdvancedChemicalReactor, Machine_HV_AdvancedChemicalReactor, Machine_EV_AdvancedChemicalReactor,
    Machine_IV_AdvancedChemicalReactor, Machine_LuV_AdvancedChemicalReactor, Machine_ZPM_AdvancedChemicalReactor, Machine_UV_AdvancedChemicalReactor, Machine_UHV_AdvancedChemicalReactor,
    Machine_UEV_AdvancedChemicalReactor, Machine_UIV_AdvancedChemicalReactor, Machine_UMV_AdvancedChemicalReactor,
    Neutron_Reflector,
    ...
    ZPM3,ZPM2, ZPM4, Energy_Module, Energy_Cluster,
    ...
    Casing_Coil_Cupronickel, Casing_Coil_Kanthal, Casing_Coil_Nichrome, Casing_Coil_TungstenSteel, Casing_Coil_HSSG, Casing_Coil_Naquadah, Casing_Coil_NaquadahAlloy, Casing_Coil_ElectrumFlux, Casing_Coil_AwakenedDraconium, Casing_Coil_Infinity,
    ...
    Circuit_Silicon_Ingot, Circuit_Silicon_Ingot2, Circuit_Silicon_Ingot3, Circuit_Silicon_Ingot4, Circuit_Silicon_Ingot5, Circuit_Silicon_Wafer, Circuit_Silicon_Wafer2, Circuit_Silicon_Wafer3, Circuit_Silicon_Wafer4, Circuit_Silicon_Wafer5, Circuit_Wafer_ILC, Circuit_Chip_ILC, Circuit_Wafer_Ram, Circuit_Chip_Ram,
    Circuit_Wafer_NAND, Circuit_Chip_NAND, Circuit_Wafer_NOR, Circuit_Chip_NOR, Circuit_Wafer_CPU, Circuit_Chip_CPU, Circuit_Wafer_SoC, Circuit_Chip_SoC, Circuit_Wafer_SoC2, Circuit_Chip_SoC2, Circuit_Wafer_PIC, Circuit_Chip_PIC, Circuit_Wafer_Simple_SoC, Circuit_Chip_Simple_SoC,
    Circuit_Wafer_HPIC, Circuit_Wafer_UHPIC, Circuit_Chip_HPIC, Circuit_Chip_UHPIC, Circuit_Chip_ULPIC, Circuit_Chip_LPIC, Circuit_Chip_NPIC, Circuit_Chip_PPIC, Circuit_Chip_QPIC, Circuit_Wafer_ULPIC, Circuit_Wafer_NPIC,  Circuit_Wafer_PPIC, Circuit_Wafer_QPIC, Circuit_Wafer_LPIC, Circuit_Wafer_NanoCPU, Circuit_Chip_NanoCPU, Circuit_Wafer_QuantumCPU, Circuit_Chip_QuantumCPU,
    ...
    VOLUMETRIC_FLASK, VOLUMETRIC_FLASK_ADVANCED, Gamer_girl_Panties, Consumed_Gamer_Girl_Panties, Doritos, Doritos_Empty, Dorito_Chip, Special_Oredrill_Circuit, Weebium_Wafer, Weebium_Wafer_Raw, Weebium_Chip, Weebium_Silicon_Boule, Engraved_Weebium_Wafer, PmCell1, PmCell2, PmCell4, PmCell1_Dep, PmCell2_Dep, PmCell4_Dep, Grief_Seed, Test_Item;
    ...
    public static Fluid sOilExtraHeavy, sEpichlorhydrin, sDrillingFluid, sNitricAcid, sBlueVitriol, sNickelSulfate, sToluene, sNitrationMixture, sRocketFuel, sHydricSulfur, sIndiumConcentrate, sLeadZincSolution, sHydrochloricAcid;

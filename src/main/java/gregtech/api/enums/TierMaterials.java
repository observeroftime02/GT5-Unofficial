...
import static gregtech.api.enums.GTNH_ExtraMaterials.Weebium;
...
public class TierMaterials {
    ...
    public static final TierMaterials[]
            CONSTRUCTION = new TierMaterials[]{
                    ...
                    new TierMaterials(SubTag.CONSTRUCTION_MATERIAL, 6, 32768, Materials.Chrome, ItemList.Hull_LuV, OrePrefixes.cableGt02.get(Materials.VanadiumGallium), OrePrefixes.wireGt01.get(Materials.SuperconductorLuV), pipeLarge.get(Materials.PolyvinylChloride), OrePrefixes.rotor.get(Materials.Chrome), OrePrefixes.circuit.get(Materials.Master), ItemList.Electric_Motor_LuV),
                    ...
                    new TierMaterials(SubTag.CONSTRUCTION_MATERIAL, 9, 2097152, Materials.Neutronium, ItemList.Hull_MAX, wireGt08.get(Materials.Ichorium), OrePrefixes.wireGt01.get(Materials.SuperconductorUHV), pipeHuge.get(Materials.MysteriousCrystal), rotor.get(Materials.Neutronium), circuit.get(Materials.Infinite), ItemList.Electric_Motor_UHV),
                    new TierMaterials(SubTag.CONSTRUCTION_MATERIAL, 10, 8388608, Materials.Bedrockium, CustomItemList.Hull_UEV, cableGt08.get(Materials.Draconium), null, pipeHuge.get(Materials.NetherStar), rotor.get(Materials.Draconium), circuit.get(Materials.Bio), ItemList.Electric_Motor_UEV),
                    new TierMaterials(SubTag.CONSTRUCTION_MATERIAL, 11, 33554432, Materials.BlackPlutonium, CustomItemList.Hull_UIV, cableGt12.get(Materials.NetherStar), null, pipeHuge.get(Materials.Neutronium), rotor.get(Materials.InfinityCatalyst), circuit.get(Materials.Nano), ItemList.Electric_Motor_UIV),
                    new TierMaterials(SubTag.CONSTRUCTION_MATERIAL, 12, 134217728, GTNH_ExtraMaterials.Weebium, CustomItemList.Hull_UMV, cableGt08.get(Weebium), null, pipeHuge.get(Weebium), rotor.get(Weebium), circuit.get(Materials.Piko), ItemList.Electric_Motor_UIV),
    };

...
public class TierMaterials {
    ...
    public static final TierMaterials[]
            CONSTRUCTION = new TierMaterials[]{
                    ...
                    new TierMaterials(SubTag.CONSTRUCTION_MATERIAL, 11, 33554432, Materials.BlackPlutonium, CustomItemList.Hull_UIV, cableGt12.get(Materials.NetherStar), null, pipeHuge.get(Materials.Neutronium), rotor.get(Materials.InfinityCatalyst), CustomItemList.NanoCircuit, ItemList.Electric_Motor_UIV),
                    new TierMaterials(SubTag.CONSTRUCTION_MATERIAL, 12, 134217728, GTNH_ExtraMaterials.Weebium, CustomItemList.Hull_UMV, cableGt08.get(Weebium), null, pipeHuge.get(Weebium), rotor.get(Weebium), CustomItemList.PikoCircuit, ItemList.Electric_Motor_UIV),
    };

...
public class TierMaterials {
    ...
    public static final TierMaterials[]
            CONSTRUCTION = new TierMaterials[]{
                    ...
                    new TierMaterials(SubTag.CONSTRUCTION_MATERIAL, 11, 33554432, Materials.BlackPlutonium, CustomItemList.Hull_UIV, cableGt08.get(Materials.NetherStar), null, pipe.get(Materials.Infinity), rotor.get(Materials.InfinityCatalyst), CustomItemList.NanoCircuit, ItemList.Electric_Motor_UIV),

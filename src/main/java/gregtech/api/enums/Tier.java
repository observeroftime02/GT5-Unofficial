...
public class Tier {
    public static final Tier[]
            ...
            new Tier(SubTag.ENERGY_ROTATIONAL, 2, 128, 1, 2, 2, Materials.Tin, OrePrefixes.frameGt.get(Materials.Tin), OrePrefixes.stick.get(Materials.Tin), OrePrefixes.ingot.get(Materials.Tin), OrePrefixes.gearGt.get(Materials.Tin), OrePrefixes.gearGt.get(Materials.Bronze)),

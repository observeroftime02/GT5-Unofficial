...
public class ItemComb extends Item {
	...
	public void initCombsRecipes() {
		...
		addSpecialCent(tComb, GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Lignite), 90);
		addProcess(tComb, Materials.Lignite, 100);
		tComb = getStackForType(CombType.COAL);
		addSpecialCent(tComb, GT_OreDictUnificator.get(OrePrefixes.gem, Materials.Coal), 40);
		...
		addSpecialCent(tComb, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Stone), 70, GT_OreDictUnificator.get(OrePrefixes.dust,Materials.Salt),20, GT_OreDictUnificator.get(OrePrefixes.dust,Materials.RockSalt),20);
...
//	    // Metals Line
		...
		addSpecialCent(tComb, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Stone), 50, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.GraniteBlack), 20, GT_OreDictUnificator.get(OrePrefixes.dust, Materials.GraniteRed), 20);
		...
		addSpecialCent(tComb, GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Copper), 70);
		...
		addSpecialCent(tComb, GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Tin), 60);
		addProcess(tComb, Materials.Tin, 100);
		addProcess(tComb, Materials.Cassiterite, 100);
		tComb = getStackForType(CombType.LEAD);
		addSpecialCent(tComb, GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Lead), 45);
		...
		addSpecialCent(tComb, GT_OreDictUnificator.get(OrePrefixes.dustTiny, Materials.Silver), 30);

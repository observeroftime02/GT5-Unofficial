...
public class ItemComb extends Item {
	...
	public void initCombsRecipes() {
		...
		tComb = getStackForType(CombType.MICA);
		addProcessLV(tComb, Materials.Mica, 95);
		addSpecialCentLV(tComb, GT_OreDictUnificator.get(OrePrefixes.dustSmall, Materials.Mica, 1L), 75);

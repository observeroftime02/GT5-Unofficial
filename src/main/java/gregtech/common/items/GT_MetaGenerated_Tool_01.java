...
public class GT_MetaGenerated_Tool_01 extends GT_MetaGenerated_Tool {
    ...
    public GT_MetaGenerated_Tool_01() {
        super("metatool.01");
        INSTANCE = this;
        addTool(0, "Sword", "", new GT_Tool_Sword(), ToolDictNames.craftingToolSword, ToolDictNames.craftingToolBlade, new TC_Aspects.TC_AspectStack(TC_Aspects.INSTRUMENTUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.TELUM, 4));
        addTool(2, "Pickaxe", "", new GT_Tool_Pickaxe(), ToolDictNames.craftingToolPickaxe, new TC_Aspects.TC_AspectStack(TC_Aspects.INSTRUMENTUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.PERFODIO, 4));
        addTool(4, "Shovel", "", new GT_Tool_Shovel(), ToolDictNames.craftingToolShovel, new TC_Aspects.TC_AspectStack(TC_Aspects.INSTRUMENTUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.PERFODIO, 4));
        addTool(6, "Axe", "", new GT_Tool_Axe(), ToolDictNames.craftingToolAxe, new TC_Aspects.TC_AspectStack(TC_Aspects.INSTRUMENTUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.METO, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.ARBOR, 2));
        addTool(8, "Hoe", "", new GT_Tool_Hoe(), ToolDictNames.craftingToolHoe, new TC_Aspects.TC_AspectStack(TC_Aspects.INSTRUMENTUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.MESSIS, 4));
        addTool(10, "Saw", "Can also harvest Ice", new GT_Tool_Saw(), ToolDictNames.craftingToolSaw, new TC_Aspects.TC_AspectStack(TC_Aspects.INSTRUMENTUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.METO, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.ARBOR, 2));
        ...
        GregTech_API.registerTool(addTool(14, "Soft Mallet", "", new GT_Tool_SoftHammer(), ToolDictNames.craftingToolSoftHammer, new TC_Aspects.TC_AspectStack(TC_Aspects.INSTRUMENTUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.LIMUS, 4)), GregTech_API.sSoftHammerList);
        ...
        addTool(18, "File", "", new GT_Tool_File(), ToolDictNames.craftingToolFile, new TC_Aspects.TC_AspectStack(TC_Aspects.INSTRUMENTUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.FABRICO, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.ORDO, 2));
        ...
        GregTech_API.registerTool(addTool(22, "Screwdriver", "Adjusts Covers and Machines", new GT_Tool_Screwdriver(), ToolDictNames.craftingToolScrewdriver, new TC_Aspects.TC_AspectStack(TC_Aspects.INSTRUMENTUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.FABRICO, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.ORDO, 2)), GregTech_API.sScrewdriverList);
        addTool(24, "Mortar", "", new GT_Tool_Mortar(), ToolDictNames.craftingToolMortar, new TC_Aspects.TC_AspectStack(TC_Aspects.INSTRUMENTUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.FABRICO, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.PERDITIO, 2));
        addTool(26, "Wire Cutter", "", new GT_Tool_WireCutter(), ToolDictNames.craftingToolWireCutter, new TC_Aspects.TC_AspectStack(TC_Aspects.INSTRUMENTUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.FABRICO, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.ORDO, 2));
        addTool(28, "Scoop", "", new GT_Tool_Scoop(), ToolDictNames.craftingToolScoop, new TC_Aspects.TC_AspectStack(TC_Aspects.INSTRUMENTUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.BESTIA, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.PANNUS, 2));
        addTool(30, "Branch Cutter", "", new GT_Tool_BranchCutter(), ToolDictNames.craftingToolBranchCutter, new TC_Aspects.TC_AspectStack(TC_Aspects.INSTRUMENTUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.METO, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.HERBA, 2));
        ...
        addTool(34, "Knife", "", new GT_Tool_Knife(), ToolDictNames.craftingToolBlade, ToolDictNames.craftingToolKnife, new TC_Aspects.TC_AspectStack(TC_Aspects.INSTRUMENTUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.TELUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.CORPUS, 2));
        addTool(36, "Butchery Knife", "Has a slow Attack Rate", new GT_Tool_ButcheryKnife(), ToolDictNames.craftingToolBlade, new TC_Aspects.TC_AspectStack(TC_Aspects.INSTRUMENTUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.FABRICO, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.CORPUS, 4));
        ...
        addTool(42, "Plow", "Used to get rid of Snow", new GT_Tool_Plow(), ToolDictNames.craftingToolPlow, new TC_Aspects.TC_AspectStack(TC_Aspects.INSTRUMENTUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.METO, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.GELUM, 2));
        addTool(44, "Plunger", "", new GT_Tool_Plunger(), ToolDictNames.craftingToolPlunger, new TC_Aspects.TC_AspectStack(TC_Aspects.INSTRUMENTUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.VACUOS, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.ITER, 2));
        addTool(46, "Rolling Pin", "", new GT_Tool_RollingPin(), ToolDictNames.craftingToolRollingPin, new TC_Aspects.TC_AspectStack(TC_Aspects.INSTRUMENTUM, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.LIMUS, 4));

        addTool(100, "Drill (LV)", "", new GT_Tool_Drill_LV(), ToolDictNames.craftingToolMiningDrill, new TC_Aspects.TC_AspectStack(TC_Aspects.MACHINA, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.PERFODIO, 4));
        addTool(102, "Drill (MV)", "", new GT_Tool_Drill_MV(), ToolDictNames.craftingToolMiningDrill, new TC_Aspects.TC_AspectStack(TC_Aspects.MACHINA, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.PERFODIO, 4));
        addTool(104, "Drill (HV)", "", new GT_Tool_Drill_HV(), ToolDictNames.craftingToolMiningDrill, new TC_Aspects.TC_AspectStack(TC_Aspects.MACHINA, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.PERFODIO, 4));
        addTool(110, "Chainsaw (LV)", "Can also harvest Ice", new GT_Tool_Chainsaw_LV(), ToolDictNames.craftingToolSaw, new TC_Aspects.TC_AspectStack(TC_Aspects.MACHINA, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.METO, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.ARBOR, 2));
        addTool(112, "Chainsaw (MV)", "Can also harvest Ice", new GT_Tool_Chainsaw_MV(), ToolDictNames.craftingToolSaw, new TC_Aspects.TC_AspectStack(TC_Aspects.MACHINA, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.METO, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.ARBOR, 2));
        addTool(114, "Chainsaw (HV)", "Can also harvest Ice", new GT_Tool_Chainsaw_HV(), ToolDictNames.craftingToolSaw, new TC_Aspects.TC_AspectStack(TC_Aspects.MACHINA, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.METO, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.ARBOR, 2));
        ...
        addTool(130, "JackHammer (HV)", "Breaks Rocks into pieces", new GT_Tool_JackHammer(), ToolDictNames.craftingToolJackHammer, new TC_Aspects.TC_AspectStack(TC_Aspects.MACHINA, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.PERFODIO, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.PERDITIO, 2));
        addTool(140, "Buzzsaw (LV)", "Not suitable for harvesting Blocks", new GT_Tool_BuzzSaw(), ToolDictNames.craftingToolSaw, new TC_Aspects.TC_AspectStack(TC_Aspects.MACHINA, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.FABRICO, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.ARBOR, 2));
        GregTech_API.registerTool(addTool(150, "Screwdriver (LV)", "Adjusts Covers and Machines", new GT_Tool_Screwdriver_LV(), ToolDictNames.craftingToolScrewdriver, new TC_Aspects.TC_AspectStack(TC_Aspects.MACHINA, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.FABRICO, 2), new TC_Aspects.TC_AspectStack(TC_Aspects.ORDO, 2)), GregTech_API.sScrewdriverList);
        ...
        if (GregTech_API.sRecipeFile.get(ConfigCategories.Tools.mortar, "Coal", true)) {
            GT_ModHandler.addShapelessCraftingRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Coal), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{ToolDictNames.craftingToolMortar, new ItemStack(Items.coal, 1)});
        }
        if (GregTech_API.sRecipeFile.get(ConfigCategories.Tools.mortar, "Clay", true)) {
            GT_ModHandler.addShapelessCraftingRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Clay), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{ToolDictNames.craftingToolMortar, new ItemStack(Blocks.clay, 1)});
        }
        if (GregTech_API.sRecipeFile.get(ConfigCategories.Tools.mortar, "Wheat", true)) {
            GT_ModHandler.addShapelessCraftingRecipe(GT_OreDictUnificator.get(OrePrefixes.dust, Materials.Wheat), GT_ModHandler.RecipeBits.NOT_REMOVABLE, new Object[]{ToolDictNames.craftingToolMortar, new ItemStack(Items.wheat, 1)});
        }

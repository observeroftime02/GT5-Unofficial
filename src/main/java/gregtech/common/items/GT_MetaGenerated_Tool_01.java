...
public class GT_MetaGenerated_Tool_01 extends GT_MetaGenerated_Tool {
    ...
    public GT_MetaGenerated_Tool_01() {
        super("metatool.01");
        INSTANCE = this;
        addTool(0, "Sword", "", new GT_Tool_Sword(), ToolDictNames.craftingToolSword, ToolDictNames.craftingToolBlade, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.TELUM, 4L));
        addTool(2, "Pickaxe", "", new GT_Tool_Pickaxe(), ToolDictNames.craftingToolPickaxe, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.PERFODIO, 4L));
        addTool(4, "Shovel", "", new GT_Tool_Shovel(), ToolDictNames.craftingToolShovel, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.PERFODIO, 4L));
        addTool(6, "Axe", "", new GT_Tool_Axe(), ToolDictNames.craftingToolAxe, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.METO, 2L), new Aspects.AspectStack(Aspects.ARBOR, 2L));
        addTool(8, "Hoe", "", new GT_Tool_Hoe(), ToolDictNames.craftingToolHoe, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.MESSIS, 4L));
        addTool(10, "Saw", "Can also harvest Ice", new GT_Tool_Saw(), ToolDictNames.craftingToolSaw, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.METO, 2L), new Aspects.AspectStack(Aspects.ARBOR, 2L));
        GregTech_API.registerTool(addTool(12, "Hammer", "Crushes Ores instead of harvesting them", new GT_Tool_HardHammer(), ToolDictNames.craftingToolHardHammer, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.FABRICO, 2L), new Aspects.AspectStack(Aspects.ORDO, 2L)), GregTech_API.sHardHammerList);
        GregTech_API.registerTool(addTool(14, "Soft Mallet", "", new GT_Tool_SoftHammer(), ToolDictNames.craftingToolSoftHammer, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.LIMUS, 4L)), GregTech_API.sSoftHammerList);
        GregTech_API.registerTool(addTool(WRENCH, "Wrench", "Hold Leftclick to dismantle Machines", new GT_Tool_Wrench(), ToolDictNames.craftingToolWrench, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.MACHINA, 2L), new Aspects.AspectStack(Aspects.ORDO, 2L)), GregTech_API.sWrenchList);
        addTool(18, "File", "", new GT_Tool_File(), ToolDictNames.craftingToolFile, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.FABRICO, 2L), new Aspects.AspectStack(Aspects.ORDO, 2L));
        GregTech_API.registerTool(addTool(20, "Crowbar", "Dismounts Covers and Rotates Rails", new GT_Tool_Crowbar(), ToolDictNames.craftingToolCrowbar, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.FABRICO, 2L), new Aspects.AspectStack(Aspects.TELUM, 2L)), GregTech_API.sCrowbarList);
        GregTech_API.registerTool(addTool(22, "Screwdriver", "Adjusts Covers and Machines", new GT_Tool_Screwdriver(), ToolDictNames.craftingToolScrewdriver, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.FABRICO, 2L), new Aspects.AspectStack(Aspects.ORDO, 2L)), GregTech_API.sScrewdriverList);
        addTool(24, "Mortar", "", new GT_Tool_Mortar(), ToolDictNames.craftingToolMortar, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.FABRICO, 2L), new Aspects.AspectStack(Aspects.PERDITIO, 2L));
        addTool(26, "Wire Cutter", "", new GT_Tool_WireCutter(), ToolDictNames.craftingToolWireCutter, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.FABRICO, 2L), new Aspects.AspectStack(Aspects.ORDO, 2L));
        addTool(28, "Scoop", "", new GT_Tool_Scoop(), ToolDictNames.craftingToolScoop, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.BESTIA, 2L), new Aspects.AspectStack(Aspects.PANNUS, 2L));
        addTool(30, "Branch Cutter", "", new GT_Tool_BranchCutter(), ToolDictNames.craftingToolBranchCutter, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.METO, 2L), new Aspects.AspectStack(Aspects.HERBA, 2L));
        GregTech_API.registerTool(addTool(32, "Universal Spade", "", new GT_Tool_UniversalSpade(), ToolDictNames.craftingToolBlade, ToolDictNames.craftingToolShovel, ToolDictNames.craftingToolCrowbar, ToolDictNames.craftingToolSaw, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.TELUM, 1L), new Aspects.AspectStack(Aspects.METO, 1L), new Aspects.AspectStack(Aspects.FABRICO, 1L)), GregTech_API.sCrowbarList);
        addTool(34, "Knife", "", new GT_Tool_Knife(), ToolDictNames.craftingToolBlade, ToolDictNames.craftingToolKnife, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.TELUM, 2L), new Aspects.AspectStack(Aspects.CORPUS, 2L));
        addTool(36, "Butchery Knife", "Has a slow Attack Rate", new GT_Tool_ButcheryKnife(), ToolDictNames.craftingToolBlade, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.FABRICO, 2L), new Aspects.AspectStack(Aspects.CORPUS, 4L));

        addTool(40, "Sense", "Because a Scythe doesn't make Sense", new GT_Tool_Sense(), ToolDictNames.craftingToolBlade, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.METO, 2L), new Aspects.AspectStack(Aspects.HERBA, 2L), new Aspects.AspectStack(Aspects.MORTUUS, 2L));
        addTool(42, "Plow", "Used to get rid of Snow", new GT_Tool_Plow(), ToolDictNames.craftingToolPlow, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.METO, 2L), new Aspects.AspectStack(Aspects.GELUM, 2L));
        addTool(44, "Plunger", "", new GT_Tool_Plunger(), ToolDictNames.craftingToolPlunger, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.VACUOS, 2L), new Aspects.AspectStack(Aspects.ITER, 2L));
        addTool(46, "Rolling Pin", "", new GT_Tool_RollingPin(), ToolDictNames.craftingToolRollingPin, new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), new Aspects.AspectStack(Aspects.LIMUS, 4L));

        addTool(100, "Drill (LV)", "", new GT_Tool_Drill_LV(), ToolDictNames.craftingToolMiningDrill, new Aspects.AspectStack(Aspects.MACHINA, 2L), new Aspects.AspectStack(Aspects.PERFODIO, 4L));
        addTool(102, "Drill (MV)", "", new GT_Tool_Drill_MV(), ToolDictNames.craftingToolMiningDrill, new Aspects.AspectStack(Aspects.MACHINA, 2L), new Aspects.AspectStack(Aspects.PERFODIO, 4L));
        addTool(104, "Drill (HV)", "", new GT_Tool_Drill_HV(), ToolDictNames.craftingToolMiningDrill, new Aspects.AspectStack(Aspects.MACHINA, 2L), new Aspects.AspectStack(Aspects.PERFODIO, 4L));
        addTool(110, "Chainsaw (LV)", "Can also harvest Ice", new GT_Tool_Chainsaw_LV(), ToolDictNames.craftingToolSaw, new Aspects.AspectStack(Aspects.MACHINA, 2L), new Aspects.AspectStack(Aspects.METO, 2L), new Aspects.AspectStack(Aspects.ARBOR, 2L));
        addTool(112, "Chainsaw (MV)", "Can also harvest Ice", new GT_Tool_Chainsaw_MV(), ToolDictNames.craftingToolSaw, new Aspects.AspectStack(Aspects.MACHINA, 2L), new Aspects.AspectStack(Aspects.METO, 2L), new Aspects.AspectStack(Aspects.ARBOR, 2L));
        addTool(114, "Chainsaw (HV)", "Can also harvest Ice", new GT_Tool_Chainsaw_HV(), ToolDictNames.craftingToolSaw, new Aspects.AspectStack(Aspects.MACHINA, 2L), new Aspects.AspectStack(Aspects.METO, 2L), new Aspects.AspectStack(Aspects.ARBOR, 2L));
        GregTech_API.registerTool(addTool(WRENCH_LV, "Wrench (LV)", "Hold Leftclick to dismantle Machines", new GT_Tool_Wrench_LV(), ToolDictNames.craftingToolWrench, new Aspects.AspectStack(Aspects.MACHINA, 4L), new Aspects.AspectStack(Aspects.ORDO, 2L)), GregTech_API.sWrenchList);
        GregTech_API.registerTool(addTool(WRENCH_MV, "Wrench (MV)", "Hold Leftclick to dismantle Machines", new GT_Tool_Wrench_MV(), ToolDictNames.craftingToolWrench, new Aspects.AspectStack(Aspects.MACHINA, 4L), new Aspects.AspectStack(Aspects.ORDO, 2L)), GregTech_API.sWrenchList);
        GregTech_API.registerTool(addTool(WRENCH_HV, "Wrench (HV)", "Hold Leftclick to dismantle Machines", new GT_Tool_Wrench_HV(), ToolDictNames.craftingToolWrench, new Aspects.AspectStack(Aspects.MACHINA, 4L), new Aspects.AspectStack(Aspects.ORDO, 2L)), GregTech_API.sWrenchList);
        addTool(130, "JackHammer (HV)", "Breaks Rocks into pieces", new GT_Tool_JackHammer(), ToolDictNames.craftingToolJackHammer, new Aspects.AspectStack(Aspects.MACHINA, 2L), new Aspects.AspectStack(Aspects.PERFODIO, 2L), new Aspects.AspectStack(Aspects.PERDITIO, 2L));
        addTool(140, "Buzzsaw (LV)", "Not suitable for harvesting Blocks", new GT_Tool_BuzzSaw(), ToolDictNames.craftingToolSaw, new Aspects.AspectStack(Aspects.MACHINA, 2L), new Aspects.AspectStack(Aspects.FABRICO, 2L), new Aspects.AspectStack(Aspects.ARBOR, 2L));
        GregTech_API.registerTool(addTool(150, "Screwdriver (LV)", "Adjusts Covers and Machines", new GT_Tool_Screwdriver_LV(), ToolDictNames.craftingToolScrewdriver, new Aspects.AspectStack(Aspects.MACHINA, 2L), new Aspects.AspectStack(Aspects.FABRICO, 2L), new Aspects.AspectStack(Aspects.ORDO, 2L)), GregTech_API.sScrewdriverList);
        GregTech_API.registerTool(addTool(SOLDERING_IRON_LV, "Soldering Iron (LV)", "Fixes burned out Circuits. Needs soldering materials in inventory and 10kEU", new GT_Tool_Soldering_Iron(), ToolDictNames.craftingToolSolderingIron, new Aspects.AspectStack(Aspects.MACHINA, 2L), new Aspects.AspectStack(Aspects.FABRICO, 2L), new Aspects.AspectStack(Aspects.ORDO, 2L)), GregTech_API.sSolderingToolList);

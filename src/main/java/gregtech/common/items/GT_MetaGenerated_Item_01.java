...
public class GT_MetaGenerated_Item_01 extends GT_MetaGenerated_Item_X32 {
    ...
    public GT_MetaGenerated_Item_01() {
        ...
        MatUnifier.addToBlacklist(new ItemStack(this, 1, 17000 + Materials.Wood.mMetaItemSubID));
        GT_ModHandler.addCompressionRecipe(MatUnifier.get(OrePrefixes.dust, Materials.Wood), new ItemStack(this, 1, 17000 + Materials.Wood.mMetaItemSubID));
        ...
        ItemList.Coin_Doge.set(addItem(tLastID = 9, "Doge Coin", "wow much coin how money so crypto plz mine v rich very currency wow", new Object[]{new ItemData(Materials.Brass, 907200), new Aspects.AspectStack(Aspects.LUCRUM, 1)}));

        ItemList.Component_Minecart_Wheels_Iron.set(addItem(tLastID = 100, "Iron Minecart Wheels", "To get things rolling", new Object[]{new Aspects.AspectStack(Aspects.MOTUS, 2), new Aspects.AspectStack(Aspects.METALLUM, 2)}));
        ItemList.Component_Minecart_Wheels_Steel.set(addItem(tLastID = 101, "Steel Minecart Wheels", "To get things rolling", new Object[]{new Aspects.AspectStack(Aspects.MOTUS, 2), new Aspects.AspectStack(Aspects.METALLUM, 2)}));
        ...
        ItemList.Shape_Empty.set(addItem(tLastID = 300, "Empty Shape Plate", "Raw Plate to make Molds and Extruder Shapes", new Object[]{new Aspects.AspectStack(Aspects.FABRICO, 4), new Aspects.AspectStack(Aspects.METALLUM, 4)}));
        ...
        ItemList.Large_Fluid_Cell_Steel.set(addItem(tLastID = 405, "Large Steel Fluid Cell", "", new Object[]{new ItemData(Materials.Steel, OrePrefixes.plate.mMaterialAmount * 2 + 2 * OrePrefixes.ring.mMaterialAmount), new Aspects.AspectStack(Aspects.VACUOS, 4), new Aspects.AspectStack(Aspects.AQUA, 2)}));
        setFluidContainerStats(32000 + tLastID, 16000L, 16);

        GT_Values.RA.addAssemblerRecipe(MatUnifier.get(OrePrefixes.plate, Materials.Steel, 2), MatUnifier.get(OrePrefixes.ring, Materials.Steel, 2), ItemList.Large_Fluid_Cell_Steel.get(1), 100, 64);

        ItemList.Large_Fluid_Cell_TungstenSteel.set(addItem(tLastID = 406, "Large Tungstensteel Fluid Cell", "", new Object[]{new ItemData(Materials.TungstenSteel, OrePrefixes.plate.mMaterialAmount * 2 + 2 * OrePrefixes.ring.mMaterialAmount), new Aspects.AspectStack(Aspects.VACUOS, 6), new Aspects.AspectStack(Aspects.AQUA, 3)}));
        setFluidContainerStats(32000 + tLastID, 64000L, 16);

        GT_Values.RA.addAssemblerRecipe(MatUnifier.get(OrePrefixes.plate, Materials.TungstenSteel, 2), MatUnifier.get(OrePrefixes.ring, Materials.TungstenSteel, 2), ItemList.Large_Fluid_Cell_TungstenSteel.get(1), 200, 256);

        ItemList.Tool_Lighter_Invar_Empty.set(addItem(tLastID = 474, "Lighter (Empty)", "", new Object[]{new ItemData(Materials.Invar, OrePrefixes.plate.mMaterialAmount * 2), new Aspects.AspectStack(Aspects.IGNIS, 1), new Aspects.AspectStack(Aspects.VACUOS, 1)}));
        ItemList.Tool_Lighter_Invar_Used.set(addItem(tLastID = 475, "Lighter", "", new Object[]{new ItemData(Materials.Invar, OrePrefixes.plate.mMaterialAmount * 2), new Aspects.AspectStack(Aspects.IGNIS, 2), new Aspects.AspectStack(Aspects.POTENTIA, 1), SubTag.INVISIBLE}));
        ItemList.Tool_Lighter_Invar_Full.set(addItem(tLastID = 476, "Lighter (Full)", "", new Object[]{new ItemData(Materials.Invar, OrePrefixes.plate.mMaterialAmount * 2), new Aspects.AspectStack(Aspects.IGNIS, 1), new Aspects.AspectStack(Aspects.POTENTIA, 2)}));
        ...
        GT_Values.RA.addAssemblerRecipe(MatUnifier.get(OrePrefixes.plate, Materials.Invar, 2), new ItemStack(Items.flint, 1), ItemList.Tool_Lighter_Invar_Empty.get(1), 256, 16);

        ItemList.Tool_Lighter_Platinum_Empty.set(addItem(tLastID = 477, "Platinum Lighter (Empty)", "A known Prank Master is engraved on it", new Object[]{new ItemData(Materials.Platinum, OrePrefixes.plate.mMaterialAmount * 2), new Aspects.AspectStack(Aspects.IGNIS, 1), new Aspects.AspectStack(Aspects.NEBRISUM, 1), new Aspects.AspectStack(Aspects.VACUOS, 1)}));
        ItemList.Tool_Lighter_Platinum_Used.set(addItem(tLastID = 478, "Platinum Lighter", "A known Prank Master is engraved on it", new Object[]{new ItemData(Materials.Platinum, OrePrefixes.plate.mMaterialAmount * 2), new Aspects.AspectStack(Aspects.IGNIS, 2), new Aspects.AspectStack(Aspects.NEBRISUM, 1), new Aspects.AspectStack(Aspects.POTENTIA, 1), SubTag.INVISIBLE}));
        ItemList.Tool_Lighter_Platinum_Full.set(addItem(tLastID = 479, "Platinum Lighter (Full)", "A known Prank Master is engraved on it", new Object[]{new ItemData(Materials.Platinum, OrePrefixes.plate.mMaterialAmount * 2), new Aspects.AspectStack(Aspects.IGNIS, 1), new Aspects.AspectStack(Aspects.NEBRISUM, 1), new Aspects.AspectStack(Aspects.POTENTIA, 2)}));
        ...
        ItemList.Ingot_IridiumAlloy.set(addItem(tLastID = 480, "Iridium Alloy Ingot", "Used to make Iridium Alloy Plates", new Object[]{new Aspects.AspectStack(Aspects.TUTAMEN, 4), new Aspects.AspectStack(Aspects.METALLUM, 4)}));
        ...
        ItemList.Paper_Printed_Pages.set(addItem(tLastID = 481, "Printed Pages", "Used to make written Books", new Object[]{new ItemData(Materials.Paper, 10886400), new Behaviour_PrintedPages(), new Aspects.AspectStack(Aspects.COGNITIO, 2)}));
        ItemList.Paper_Magic_Empty.set(addItem(tLastID = 482, "Magic Paper", "", new Object[]{SubTag.INVISIBLE, new ItemData(Materials.Paper, 3628800), new Aspects.AspectStack(Aspects.COGNITIO, 1), new Aspects.AspectStack(Aspects.PRAECANTATIO, 1)}));
        ItemList.Paper_Magic_Page.set(addItem(tLastID = 483, "Enchanted Page", "", new Object[]{SubTag.INVISIBLE, new ItemData(Materials.Paper, 3628800), new Aspects.AspectStack(Aspects.COGNITIO, 1), new Aspects.AspectStack(Aspects.PRAECANTATIO, 2)}));
        ItemList.Paper_Magic_Pages.set(addItem(tLastID = 484, "Enchanted Pages", "", new Object[]{SubTag.INVISIBLE, new ItemData(Materials.Paper, 10886400), new Aspects.AspectStack(Aspects.COGNITIO, 2), new Aspects.AspectStack(Aspects.PRAECANTATIO, 4)}));
        ItemList.Paper_Punch_Card_Empty.set(addItem(tLastID = 485, "Punch Card", "", new Object[]{SubTag.INVISIBLE, new ItemData(Materials.Paper, 7257600), new Aspects.AspectStack(Aspects.COGNITIO, 1)}));
        ItemList.Paper_Punch_Card_Encoded.set(addItem(tLastID = 486, "Punched Card", "", new Object[]{SubTag.INVISIBLE, new ItemData(Materials.Paper, 7257600), new Aspects.AspectStack(Aspects.COGNITIO, 2)}));
        ItemList.Book_Written_01.set(addItem(tLastID = 487, "Book", "", new Object[]{new ItemData(Materials.Paper, 10886400), "bookWritten", OreDictNames.craftingBook, new Behaviour_WrittenBook(), new Aspects.AspectStack(Aspects.COGNITIO, 2)}));
        ItemList.Book_Written_02.set(addItem(tLastID = 488, "Book", "", new Object[]{new ItemData(Materials.Paper, 10886400), "bookWritten", OreDictNames.craftingBook, new Behaviour_WrittenBook(), new Aspects.AspectStack(Aspects.COGNITIO, 2)}));
        ItemList.Book_Written_03.set(addItem(tLastID = 489, "Book", "", new Object[]{new ItemData(Materials.Paper, 10886400), "bookWritten", OreDictNames.craftingBook, new Behaviour_WrittenBook(), new Aspects.AspectStack(Aspects.COGNITIO, 2)}));

        ItemList.Schematic.set(addItem(tLastID = 490, "Schematic", "EMPTY", new Object[]{new ItemData(Materials.StainlessSteel, 7257600), new Aspects.AspectStack(Aspects.STRONTIO, 1)}));
        ItemList.Schematic_Crafting.set(addItem(tLastID = 491, "Schematic (Crafting)", "Crafts the Programmed Recipe", new Object[]{new ItemData(Materials.StainlessSteel, 7257600), new Aspects.AspectStack(Aspects.COGNITIO, 1), new Aspects.AspectStack(Aspects.FABRICO, 1)}));
        ItemList.Schematic_1by1.set(addItem(tLastID = 495, "Schematic (1x1)", "Crafts 1 Items as 1x1 (use in Packager)", new Object[]{new ItemData(Materials.StainlessSteel, 7257600), new Aspects.AspectStack(Aspects.COGNITIO, 1), new Aspects.AspectStack(Aspects.FABRICO, 1)}));
        ItemList.Schematic_2by2.set(addItem(tLastID = 496, "Schematic (2x2)", "Crafts 4 Items as 2x2 (use in Packager)", new Object[]{new ItemData(Materials.StainlessSteel, 7257600), new Aspects.AspectStack(Aspects.COGNITIO, 1), new Aspects.AspectStack(Aspects.FABRICO, 1)}));
        ItemList.Schematic_3by3.set(addItem(tLastID = 497, "Schematic (3x3)", "Crafts 9 Items as 3x3 (use in Packager)", new Object[]{new ItemData(Materials.StainlessSteel, 7257600), new Aspects.AspectStack(Aspects.COGNITIO, 1), new Aspects.AspectStack(Aspects.FABRICO, 1)}));
        ItemList.Schematic_Dust.set(addItem(tLastID = 498, "Schematic (Dusts)", "Combines Dusts (use in Packager)", new Object[]{new ItemData(Materials.StainlessSteel, 7257600), new Aspects.AspectStack(Aspects.COGNITIO, 1), new Aspects.AspectStack(Aspects.FABRICO, 1)}));
        ...
        ItemList.Battery_Hull_LV.set(addItem(tLastID = 500, "Small Battery Hull", "An empty LV Battery Hull", new Object[]{new ItemData(Materials.BatteryAlloy, OrePrefixes.plate.mMaterialAmount), new Aspects.AspectStack(Aspects.ELECTRUM, 1), new Aspects.AspectStack(Aspects.METALLUM, 1), new Aspects.AspectStack(Aspects.VACUOS, 1)}));
        ItemList.Battery_Hull_MV.set(addItem(tLastID = 501, "Medium Battery Hull", "An empty MV Battery Hull", new Object[]{new ItemData(Materials.BatteryAlloy, OrePrefixes.plate.mMaterialAmount * 3), new Aspects.AspectStack(Aspects.ELECTRUM, 2), new Aspects.AspectStack(Aspects.METALLUM, 2), new Aspects.AspectStack(Aspects.VACUOS, 1)}));
        ItemList.Battery_Hull_HV.set(addItem(tLastID = 502, "Large Battery Hull", "An empty HV Battery Hull", new Object[]{new ItemData(Materials.BatteryAlloy, OrePrefixes.plate.mMaterialAmount * 9), new Aspects.AspectStack(Aspects.ELECTRUM, 4), new Aspects.AspectStack(Aspects.METALLUM, 4), new Aspects.AspectStack(Aspects.VACUOS, 1)}));
        ...
        ItemList.Battery_RE_ULV_Tantalum.set(addItem(tLastID = 499, "Tantalum Capacitor", "Reusable", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1), new Aspects.AspectStack(Aspects.METALLUM, 1), new Aspects.AspectStack(Aspects.POTENTIA, 1)}));
        setElectricStats(32000 + tLastID, 1000L, GT_Values.V[0], 0L, -3L, false);

        ItemList.Battery_SU_LV_SulfuricAcid.set(addItem(tLastID = 510, "Small Acid Battery", "Single Use", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1), new Aspects.AspectStack(Aspects.METALLUM, 1), new Aspects.AspectStack(Aspects.POTENTIA, 2)}));
        setElectricStats(32000 + tLastID, 18000L, GT_Values.V[1], 1, -2L, true);
        ItemList.Battery_SU_LV_Mercury.set(addItem(tLastID = 511, "Small Mercury Battery", "Single Use", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1), new Aspects.AspectStack(Aspects.METALLUM, 1), new Aspects.AspectStack(Aspects.POTENTIA, 2)}));
        setElectricStats(32000 + tLastID, 32000L, GT_Values.V[1], 1, -2L, true);

        ItemList.Battery_RE_LV_Cadmium.set(addItem(tLastID = 517, "Small Cadmium Battery", "Reusable", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1), new Aspects.AspectStack(Aspects.METALLUM, 1), new Aspects.AspectStack(Aspects.POTENTIA, 1), "calclavia:ADVANCED_BATTERY"}));
        setElectricStats(32000 + tLastID, 75000L, GT_Values.V[1], 1, -3L, true);
        ItemList.Battery_RE_LV_Lithium.set(addItem(tLastID = 518, "Small Lithium Battery", "Reusable", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1), new Aspects.AspectStack(Aspects.METALLUM, 1), new Aspects.AspectStack(Aspects.POTENTIA, 1), "calclavia:ADVANCED_BATTERY"}));
        setElectricStats(32000 + tLastID, 100000L, GT_Values.V[1], 1, -3L, true);
        ItemList.Battery_RE_LV_Sodium.set(addItem(tLastID = 519, "Small Sodium Battery", "Reusable", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1), new Aspects.AspectStack(Aspects.METALLUM, 1), new Aspects.AspectStack(Aspects.POTENTIA, 1), "calclavia:ADVANCED_BATTERY"}));
        setElectricStats(32000 + tLastID, 50000L, GT_Values.V[1], 1, -3L, true);

        ItemList.Battery_SU_MV_SulfuricAcid.set(addItem(tLastID = 520, "Medium Acid Battery", "Single Use", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2), new Aspects.AspectStack(Aspects.METALLUM, 2), new Aspects.AspectStack(Aspects.POTENTIA, 4)}));
        setElectricStats(32000 + tLastID, 72000L, GT_Values.V[2], 2, -2L, true);
        ItemList.Battery_SU_MV_Mercury.set(addItem(tLastID = 521, "Medium Mercury Battery", "Single Use", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2), new Aspects.AspectStack(Aspects.METALLUM, 2), new Aspects.AspectStack(Aspects.POTENTIA, 4)}));
        setElectricStats(32000 + tLastID, 128000L, GT_Values.V[2], 2, -2L, true);

        ItemList.Battery_RE_MV_Cadmium.set(addItem(tLastID = 527, "Medium Cadmium Battery", "Reusable", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2), new Aspects.AspectStack(Aspects.METALLUM, 2), new Aspects.AspectStack(Aspects.POTENTIA, 2)}));
        setElectricStats(32000 + tLastID, 300000L, GT_Values.V[2], 2, -3L, true);
        ItemList.Battery_RE_MV_Lithium.set(addItem(tLastID = 528, "Medium Lithium Battery", "Reusable", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2), new Aspects.AspectStack(Aspects.METALLUM, 2), new Aspects.AspectStack(Aspects.POTENTIA, 2)}));
        setElectricStats(32000 + tLastID, 400000L, GT_Values.V[2], 2, -3L, true);
        ItemList.Battery_RE_MV_Sodium.set(addItem(tLastID = 529, "Medium Sodium Battery", "Reusable", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2), new Aspects.AspectStack(Aspects.METALLUM, 2), new Aspects.AspectStack(Aspects.POTENTIA, 2)}));
        setElectricStats(32000 + tLastID, 200000L, GT_Values.V[2], 2, -3L, true);

        ItemList.Battery_SU_HV_SulfuricAcid.set(addItem(tLastID = 530, "Large Acid Battery", "Single Use", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4), new Aspects.AspectStack(Aspects.METALLUM, 4), new Aspects.AspectStack(Aspects.POTENTIA, 8)}));
        setElectricStats(32000 + tLastID, 288000L, GT_Values.V[3], 3L, -2L, true);
        ItemList.Battery_SU_HV_Mercury.set(addItem(tLastID = 531, "Large Mercury Battery", "Single Use", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4), new Aspects.AspectStack(Aspects.METALLUM, 4), new Aspects.AspectStack(Aspects.POTENTIA, 8)}));
        setElectricStats(32000 + tLastID, 512000L, GT_Values.V[3], 3L, -2L, true);

        ItemList.Battery_RE_HV_Cadmium.set(addItem(tLastID = 537, "Large Cadmium Battery", "Reusable", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4), new Aspects.AspectStack(Aspects.METALLUM, 4), new Aspects.AspectStack(Aspects.POTENTIA, 4)}));
        setElectricStats(32000 + tLastID, 1200000L, GT_Values.V[3], 3L, -3L, true);
        ItemList.Battery_RE_HV_Lithium.set(addItem(tLastID = 538, "Large Lithium Battery", "Reusable", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4), new Aspects.AspectStack(Aspects.METALLUM, 4), new Aspects.AspectStack(Aspects.POTENTIA, 4)}));
        setElectricStats(32000 + tLastID, 1600000L, GT_Values.V[3], 3L, -3L, true);
        ItemList.Battery_RE_HV_Sodium.set(addItem(tLastID = 539, "Large Sodium Battery", "Reusable", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4), new Aspects.AspectStack(Aspects.METALLUM, 4), new Aspects.AspectStack(Aspects.POTENTIA, 4)}));
        ...
        GT_Values.RA.addCannerRecipe(MatUnifier.get(OrePrefixes.dust, Materials.Cadmium, 2), ItemList.Battery_Hull_LV.get(1), ItemList.Battery_RE_LV_Cadmium.get(1), null, 100, 2);
        GT_Values.RA.addCannerRecipe(MatUnifier.get(OrePrefixes.dust, Materials.Lithium, 2), ItemList.Battery_Hull_LV.get(1), ItemList.Battery_RE_LV_Lithium.get(1), null, 100, 2);
        GT_Values.RA.addCannerRecipe(MatUnifier.get(OrePrefixes.dust, Materials.Sodium, 2), ItemList.Battery_Hull_LV.get(1), ItemList.Battery_RE_LV_Sodium.get(1), null, 100, 2);
        GT_Values.RA.addCannerRecipe(MatUnifier.get(OrePrefixes.dust, Materials.Cadmium, 8), ItemList.Battery_Hull_MV.get(1), ItemList.Battery_RE_MV_Cadmium.get(1), null, 400, 2);
        GT_Values.RA.addCannerRecipe(MatUnifier.get(OrePrefixes.dust, Materials.Lithium, 8), ItemList.Battery_Hull_MV.get(1), ItemList.Battery_RE_MV_Lithium.get(1), null, 400, 2);
        GT_Values.RA.addCannerRecipe(MatUnifier.get(OrePrefixes.dust, Materials.Sodium, 8), ItemList.Battery_Hull_MV.get(1), ItemList.Battery_RE_MV_Sodium.get(1), null, 400, 2);
        GT_Values.RA.addCannerRecipe(MatUnifier.get(OrePrefixes.dust, Materials.Cadmium, 32), ItemList.Battery_Hull_HV.get(1), ItemList.Battery_RE_HV_Cadmium.get(1), null, 1600, 2);
        GT_Values.RA.addCannerRecipe(MatUnifier.get(OrePrefixes.dust, Materials.Lithium, 32), ItemList.Battery_Hull_HV.get(1), ItemList.Battery_RE_HV_Lithium.get(1), null, 1600, 2);
        GT_Values.RA.addCannerRecipe(MatUnifier.get(OrePrefixes.dust, Materials.Sodium, 32), ItemList.Battery_Hull_HV.get(1), ItemList.Battery_RE_HV_Sodium.get(1), null, 1600, 2);

        ItemList.Energy_LapotronicOrb.set(addItem(tLastID = 597, "Lapotronic Energy Orb", "Reusable battery", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.VITREUS, 16), new Aspects.AspectStack(Aspects.POTENTIA, 16), OrePrefixes.battery.get(Materials.Ultimate)}));
        setElectricStats(32000 + tLastID, 100000000L, GT_Values.V[5], 5L, -3L, true);

        ItemList.ZPM.set(addItem(tLastID = 598, "Zero Point Module", "Single use battery", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 64), new Aspects.AspectStack(Aspects.VITREUS, 16), new Aspects.AspectStack(Aspects.POTENTIA, 64)}));
        setElectricStats(32000 + tLastID, 2000000000000L, GT_Values.V[7], 7L, -2L, true);

        ItemList.Energy_LapotronicOrb2.set(addItem(tLastID = 599, "Lapotronic Energy Orb Cluster", "Reusable battery", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.VITREUS, 16), new Aspects.AspectStack(Aspects.POTENTIA, 16), OrePrefixes.battery.get(Materials.Ultimate)}));
        setElectricStats(32000 + tLastID, 1000000000L, GT_Values.V[6], 6L, -3L, true);
        


        ItemList.Energy_Module.set(addItem(tLastID = 736, "Energy Module", "Reusable battery", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.VITREUS, 16), new Aspects.AspectStack(Aspects.POTENTIA, 16), OrePrefixes.battery.get(Materials.Ultimate)}));
        setElectricStats(32000 + tLastID, 10000000000L, GT_Values.V[7], 7L, -3L, true);

        ItemList.Energy_Cluster.set(addItem(tLastID = 737, "Energy Cluster", "Reusable battery", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 64), new Aspects.AspectStack(Aspects.VITREUS, 16), new Aspects.AspectStack(Aspects.POTENTIA, 64)}));
        setElectricStats(32000 + tLastID, 100000000000L, GT_Values.V[8], 8, -3L, true);

        ItemList.Electric_Motor_LV.set(addItem(tLastID = 600, "Electric Motor (LV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1), new Aspects.AspectStack(Aspects.MACHINA, 1), new Aspects.AspectStack(Aspects.MOTUS, 1)}));
        ItemList.Electric_Motor_MV.set(addItem(tLastID = 601, "Electric Motor (MV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2), new Aspects.AspectStack(Aspects.MACHINA, 2), new Aspects.AspectStack(Aspects.MOTUS, 2)}));
        ItemList.Electric_Motor_HV.set(addItem(tLastID = 602, "Electric Motor (HV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4), new Aspects.AspectStack(Aspects.MACHINA, 4), new Aspects.AspectStack(Aspects.MOTUS, 4)}));
        ItemList.Electric_Motor_EV.set(addItem(tLastID = 603, "Electric Motor (EV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 8), new Aspects.AspectStack(Aspects.MACHINA, 8), new Aspects.AspectStack(Aspects.MOTUS, 8)}));
        ItemList.Electric_Motor_IV.set(addItem(tLastID = 604, "Electric Motor (IV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.MOTUS, 16)}));
        ItemList.Electric_Motor_LuV.set(addItem(tLastID = 606, "Electric Motor (LuV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 24), new Aspects.AspectStack(Aspects.MACHINA, 24), new Aspects.AspectStack(Aspects.MOTUS, 24)}));
        ItemList.Electric_Motor_ZPM.set(addItem(tLastID = 607, "Electric Motor (ZPM)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 32), new Aspects.AspectStack(Aspects.MACHINA, 32), new Aspects.AspectStack(Aspects.MOTUS, 32)}));
        ItemList.Electric_Motor_UV.set(addItem(tLastID = 608, "Electric Motor (UV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 48), new Aspects.AspectStack(Aspects.MACHINA, 48), new Aspects.AspectStack(Aspects.MOTUS, 48)}));
        ...
        ItemList.Electric_Pump_LV.set(addItem(tLastID = 610, "Electric Pump (LV)", "640 L/sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1), new Aspects.AspectStack(Aspects.MACHINA, 1), new Aspects.AspectStack(Aspects.ITER, 1), new Aspects.AspectStack(Aspects.AQUA, 1)}));
        ItemList.Electric_Pump_MV.set(addItem(tLastID = 611, "Electric Pump (MV)", "2560 L/sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2), new Aspects.AspectStack(Aspects.MACHINA, 2), new Aspects.AspectStack(Aspects.ITER, 2), new Aspects.AspectStack(Aspects.AQUA, 2)}));
        ItemList.Electric_Pump_HV.set(addItem(tLastID = 612, "Electric Pump (HV)", "10240 L/sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4), new Aspects.AspectStack(Aspects.MACHINA, 4), new Aspects.AspectStack(Aspects.ITER, 4), new Aspects.AspectStack(Aspects.AQUA, 4)}));
        ItemList.Electric_Pump_EV.set(addItem(tLastID = 613, "Electric Pump (EV)", "40.960 L/sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 8), new Aspects.AspectStack(Aspects.MACHINA, 8), new Aspects.AspectStack(Aspects.ITER, 8), new Aspects.AspectStack(Aspects.AQUA, 8)}));
        ItemList.Electric_Pump_IV.set(addItem(tLastID = 614, "Electric Pump (IV)", "163.840 L/sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.ITER, 16), new Aspects.AspectStack(Aspects.AQUA, 16)}));
        ItemList.Electric_Pump_LuV.set(addItem(tLastID = 620, "Electric Pump (LuV)", "655.360 L/sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.ITER, 16), new Aspects.AspectStack(Aspects.AQUA, 16)}));
        ItemList.Electric_Pump_ZPM.set(addItem(tLastID = 621, "Electric Pump (ZPM)", "2.621.440 L/sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.ITER, 16), new Aspects.AspectStack(Aspects.AQUA, 16)}));
        ItemList.Electric_Pump_UV.set(addItem(tLastID = 622, "Electric Pump (UV)", "10.485.760 L/sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.ITER, 16), new Aspects.AspectStack(Aspects.AQUA, 16)}));
        ...
        ItemList.Conveyor_Module_LV.set(addItem(tLastID = 630, "Conveyor Module (LV)", "1 Stack every 20 secs (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1), new Aspects.AspectStack(Aspects.MACHINA, 1), new Aspects.AspectStack(Aspects.ITER, 1)}));
        ItemList.Conveyor_Module_MV.set(addItem(tLastID = 631, "Conveyor Module (MV)", "1 Stack every 5 secs (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2), new Aspects.AspectStack(Aspects.MACHINA, 2), new Aspects.AspectStack(Aspects.ITER, 2)}));
        ItemList.Conveyor_Module_HV.set(addItem(tLastID = 632, "Conveyor Module (HV)", "1 Stack every 1 sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4), new Aspects.AspectStack(Aspects.MACHINA, 4), new Aspects.AspectStack(Aspects.ITER, 4)}));
        ItemList.Conveyor_Module_EV.set(addItem(tLastID = 633, "Conveyor Module (EV)", "1 Stack every 1/5 sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 8), new Aspects.AspectStack(Aspects.MACHINA, 8), new Aspects.AspectStack(Aspects.ITER, 8)}));
        ItemList.Conveyor_Module_IV.set(addItem(tLastID = 634, "Conveyor Module (IV)", "1 Stack every 1/20 sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.ITER, 16)}));
        ItemList.Conveyor_Module_LuV.set(addItem(tLastID = 636, "Conveyor Module (LuV)", "1 Stack every 1/20 sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.ITER, 16)}));
        ItemList.Conveyor_Module_ZPM.set(addItem(tLastID = 637, "Conveyor Module (ZPM)", "1 Stack every 1/20 sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.ITER, 16)}));
        ItemList.Conveyor_Module_UV.set(addItem(tLastID = 638, "Conveyor Module (UV)", "1 Stack every 1/20 sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.ITER, 16)}));
        ...
        ItemList.Electric_Piston_LV.set(addItem(tLastID = 640, "Electric Piston (LV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1), new Aspects.AspectStack(Aspects.MACHINA, 2), new Aspects.AspectStack(Aspects.MOTUS, 1)}));
        ItemList.Electric_Piston_MV.set(addItem(tLastID = 641, "Electric Piston (MV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2), new Aspects.AspectStack(Aspects.MACHINA, 4), new Aspects.AspectStack(Aspects.MOTUS, 2)}));
        ItemList.Electric_Piston_HV.set(addItem(tLastID = 642, "Electric Piston (HV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4), new Aspects.AspectStack(Aspects.MACHINA, 8), new Aspects.AspectStack(Aspects.MOTUS, 4)}));
        ItemList.Electric_Piston_EV.set(addItem(tLastID = 643, "Electric Piston (EV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 8), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.MOTUS, 8)}));
        ItemList.Electric_Piston_IV.set(addItem(tLastID = 644, "Electric Piston (IV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 32), new Aspects.AspectStack(Aspects.MOTUS, 16)}));
        ItemList.Electric_Piston_LuV.set(addItem(tLastID = 645, "Electric Piston (LuV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 32), new Aspects.AspectStack(Aspects.MOTUS, 16)}));
        ItemList.Electric_Piston_ZPM.set(addItem(tLastID = 646, "Electric Piston (ZPM)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 32), new Aspects.AspectStack(Aspects.MOTUS, 16)}));
        ItemList.Electric_Piston_UV.set(addItem(tLastID = 647, "Electric Piston (UV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 32), new Aspects.AspectStack(Aspects.MOTUS, 16)}));
        ...
        ItemList.Robot_Arm_LV.set(addItem(tLastID = 650, "Robot Arm (LV)", "Inserts into specific Slots (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1), new Aspects.AspectStack(Aspects.MACHINA, 2), new Aspects.AspectStack(Aspects.MOTUS, 1), new Aspects.AspectStack(Aspects.COGNITIO, 1)}));
        ItemList.Robot_Arm_MV.set(addItem(tLastID = 651, "Robot Arm (MV)", "Inserts into specific Slots (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2), new Aspects.AspectStack(Aspects.MACHINA, 4), new Aspects.AspectStack(Aspects.MOTUS, 2), new Aspects.AspectStack(Aspects.COGNITIO, 2)}));
        ItemList.Robot_Arm_HV.set(addItem(tLastID = 652, "Robot Arm (HV)", "Inserts into specific Slots (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4), new Aspects.AspectStack(Aspects.MACHINA, 8), new Aspects.AspectStack(Aspects.MOTUS, 4), new Aspects.AspectStack(Aspects.COGNITIO, 4)}));
        ItemList.Robot_Arm_EV.set(addItem(tLastID = 653, "Robot Arm (EV)", "Inserts into specific Slots (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 8), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.MOTUS, 8), new Aspects.AspectStack(Aspects.COGNITIO, 8)}));
        ItemList.Robot_Arm_IV.set(addItem(tLastID = 654, "Robot Arm (IV)", "Inserts into specific Slots (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 32), new Aspects.AspectStack(Aspects.MOTUS, 16), new Aspects.AspectStack(Aspects.COGNITIO, 16)}));
        ItemList.Robot_Arm_LuV.set(addItem(tLastID = 655, "Robot Arm (LuV)", "Inserts into specific Slots (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 32), new Aspects.AspectStack(Aspects.MOTUS, 16), new Aspects.AspectStack(Aspects.COGNITIO, 16)}));
        ItemList.Robot_Arm_ZPM.set(addItem(tLastID = 656, "Robot Arm (ZPM)", "Inserts into specific Slots (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 32), new Aspects.AspectStack(Aspects.MOTUS, 16), new Aspects.AspectStack(Aspects.COGNITIO, 16)}));
        ItemList.Robot_Arm_UV.set(addItem(tLastID = 657, "Robot Arm (UV)", "Inserts into specific Slots (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 32), new Aspects.AspectStack(Aspects.MOTUS, 16), new Aspects.AspectStack(Aspects.COGNITIO, 16)}));
        ...
        ItemList.Field_Generator_LV.set(addItem(tLastID = 670, "Field Generator (LV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2), new Aspects.AspectStack(Aspects.MACHINA, 1), new Aspects.AspectStack(Aspects.TUTAMEN, 1)}));
        ItemList.Field_Generator_MV.set(addItem(tLastID = 671, "Field Generator (MV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4), new Aspects.AspectStack(Aspects.MACHINA, 2), new Aspects.AspectStack(Aspects.TUTAMEN, 2)}));
        ItemList.Field_Generator_HV.set(addItem(tLastID = 672, "Field Generator (HV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 8), new Aspects.AspectStack(Aspects.MACHINA, 4), new Aspects.AspectStack(Aspects.TUTAMEN, 4)}));
        ItemList.Field_Generator_EV.set(addItem(tLastID = 673, "Field Generator (EV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 8), new Aspects.AspectStack(Aspects.TUTAMEN, 8)}));
        ItemList.Field_Generator_IV.set(addItem(tLastID = 674, "Field Generator (IV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 32), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.TUTAMEN, 16)}));
        ItemList.Field_Generator_LuV.set(addItem(tLastID = 675, "Field Generator (LuV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 32), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.TUTAMEN, 16)}));
        ItemList.Field_Generator_ZPM.set(addItem(tLastID = 676, "Field Generator (ZPM)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 32), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.TUTAMEN, 16)}));
        ItemList.Field_Generator_UV.set(addItem(tLastID = 677, "Field Generator (UV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 32), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.TUTAMEN, 16)}));
        ...
        ItemList.Emitter_LV.set(addItem(tLastID = 680, "Emitter (LV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1), new Aspects.AspectStack(Aspects.MACHINA, 1), new Aspects.AspectStack(Aspects.LUX, 1)}));
        ItemList.Emitter_MV.set(addItem(tLastID = 681, "Emitter (MV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2), new Aspects.AspectStack(Aspects.MACHINA, 2), new Aspects.AspectStack(Aspects.LUX, 2)}));
        ItemList.Emitter_HV.set(addItem(tLastID = 682, "Emitter (HV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4), new Aspects.AspectStack(Aspects.MACHINA, 4), new Aspects.AspectStack(Aspects.LUX, 4)}));
        ItemList.Emitter_EV.set(addItem(tLastID = 683, "Emitter (EV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 8), new Aspects.AspectStack(Aspects.MACHINA, 8), new Aspects.AspectStack(Aspects.LUX, 8)}));
        ItemList.Emitter_IV.set(addItem(tLastID = 684, "Emitter (IV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.LUX, 16)}));
        ItemList.Emitter_LuV.set(addItem(tLastID = 685, "Emitter (LuV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.LUX, 16)}));
        ItemList.Emitter_ZPM.set(addItem(tLastID = 686, "Emitter (ZPM)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.LUX, 16)}));
        ItemList.Emitter_UV.set(addItem(tLastID = 687, "Emitter (UV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.LUX, 16)}));
        ...
        ItemList.Sensor_LV.set(addItem(tLastID = 690, "Sensor (LV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1), new Aspects.AspectStack(Aspects.MACHINA, 1), new Aspects.AspectStack(Aspects.SENSUS, 1)}));
        ItemList.Sensor_MV.set(addItem(tLastID = 691, "Sensor (MV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2), new Aspects.AspectStack(Aspects.MACHINA, 2), new Aspects.AspectStack(Aspects.SENSUS, 2)}));
        ItemList.Sensor_HV.set(addItem(tLastID = 692, "Sensor (HV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4), new Aspects.AspectStack(Aspects.MACHINA, 4), new Aspects.AspectStack(Aspects.SENSUS, 4)}));
        ItemList.Sensor_EV.set(addItem(tLastID = 693, "Sensor (EV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 8), new Aspects.AspectStack(Aspects.MACHINA, 8), new Aspects.AspectStack(Aspects.SENSUS, 8)}));
        ItemList.Sensor_IV.set(addItem(tLastID = 694, "Sensor (IV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.SENSUS, 16)}));
        ItemList.Sensor_LuV.set(addItem(tLastID = 695, "Sensor (LuV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.SENSUS, 16)}));
        ItemList.Sensor_ZPM.set(addItem(tLastID = 696, "Sensor (ZPM)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.SENSUS, 16)}));
        ItemList.Sensor_UV.set(addItem(tLastID = 697, "Sensor (UV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.MACHINA, 16), new Aspects.AspectStack(Aspects.SENSUS, 16)}));
        ...
        ItemList.Component_Sawblade_Diamond.set(addItem(tLastID = 721, "Diamond Sawblade", "", new Object[]{new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2), new Aspects.AspectStack(Aspects.PERDITIO, 2), new Aspects.AspectStack(Aspects.VITREUS, 4), OreDictNames.craftingDiamondBlade}));
        ItemList.Component_Grinder_Diamond.set(addItem(tLastID = 722, "Diamond Grinding Head", "", new Object[]{new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2), new Aspects.AspectStack(Aspects.PERDITIO, 2), new Aspects.AspectStack(Aspects.VITREUS, 6), OreDictNames.craftingGrinder}));
        ItemList.Component_Grinder_Tungsten.set(addItem(tLastID = 723, "Tungsten Grinding Head", "", new Object[]{new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2), new Aspects.AspectStack(Aspects.PERDITIO, 2), new Aspects.AspectStack(Aspects.METALLUM, 6), OreDictNames.craftingGrinder}));
        ...
        ItemList.Upgrade_Muffler.set(addItem(tLastID = 727, "Muffler Upgrade", "Makes Machines silent", new Object[]{new Aspects.AspectStack(Aspects.SENSUS, 2), new Aspects.AspectStack(Aspects.VACUOS, 2)}));
        ItemList.Upgrade_Lock.set(addItem(tLastID = 728, "Lock Upgrade", "Protects your Machines", new Object[]{new Aspects.AspectStack(Aspects.TUTAMEN, 4)}));

        GT_Values.RA.addAssemblerRecipe(MatUnifier.get(OrePrefixes.plate, Materials.Aluminium), MatUnifier.get(OrePrefixes.dust, Materials.Plastic, 2), ItemList.Upgrade_Muffler.get(1), 1600, 2);
        GT_Values.RA.addAssemblerRecipe(MatUnifier.get(OrePrefixes.plate, Materials.Aluminium), MatUnifier.get(OrePrefixes.dust, Materials.Wood, 2), ItemList.Upgrade_Muffler.get(1), 1600, 2);
        GT_Values.RA.addAssemblerRecipe(MatUnifier.get(OrePrefixes.plate, Materials.Iron), MatUnifier.get(OrePrefixes.dust, Materials.Plastic, 2), ItemList.Upgrade_Muffler.get(1), 1600, 2);
        GT_Values.RA.addAssemblerRecipe(MatUnifier.get(OrePrefixes.plate, Materials.Iron), MatUnifier.get(OrePrefixes.dust, Materials.Wood, 2), ItemList.Upgrade_Muffler.get(1), 1600, 2);
        GT_Values.RA.addAssemblerRecipe(MatUnifier.get(OrePrefixes.plate, Materials.WroughtIron), MatUnifier.get(OrePrefixes.dust, Materials.Plastic, 2), ItemList.Upgrade_Muffler.get(1), 1600, 2);
        GT_Values.RA.addAssemblerRecipe(MatUnifier.get(OrePrefixes.plate, Materials.WroughtIron), MatUnifier.get(OrePrefixes.dust, Materials.Wood, 2), ItemList.Upgrade_Muffler.get(1), 1600, 2);
        GT_Values.RA.addAssemblerRecipe(MatUnifier.get(OrePrefixes.plate, Materials.Aluminium), MatUnifier.get(OrePrefixes.plate, Materials.Iridium, 1), ItemList.Upgrade_Lock.get(1), 6400, 16);
        GT_Values.RA.addAssemblerRecipe(MatUnifier.get(OrePrefixes.plate, Materials.Iron), MatUnifier.get(OrePrefixes.plate, Materials.Iridium, 1), ItemList.Upgrade_Lock.get(1), 6400, 16);
        GT_Values.RA.addAssemblerRecipe(MatUnifier.get(OrePrefixes.plate, Materials.WroughtIron), MatUnifier.get(OrePrefixes.plate, Materials.Iridium, 1), ItemList.Upgrade_Lock.get(1), 6400, 16);

        ItemList.Component_Filter.set(addItem(tLastID = 729, "Item Filter", "", new Object[]{new ItemData(Materials.Zinc, OrePrefixes.foil.mMaterialAmount * 16), new Aspects.AspectStack(Aspects.COGNITIO, 1), new Aspects.AspectStack(Aspects.SENSUS, 1), new Aspects.AspectStack(Aspects.ITER, 1), OreDictNames.craftingFilter}));
        ...
        ItemList.Cover_Controller.set(addItem(tLastID = 730, "Machine Controller", "Turns Machines ON/OFF", new Object[]{new Aspects.AspectStack(Aspects.ORDO, 2), new Aspects.AspectStack(Aspects.MACHINA, 1)}));
        ItemList.Cover_ActivityDetector.set(addItem(tLastID = 731, "Activity Detector", "Gives out Activity as Redstone", new Object[]{new Aspects.AspectStack(Aspects.SENSUS, 2), new Aspects.AspectStack(Aspects.MACHINA, 1)}));
        ItemList.Cover_FluidDetector.set(addItem(tLastID = 732, "Fluid Detector", "Gives out Fluid Amount as Redstone", new Object[]{new Aspects.AspectStack(Aspects.SENSUS, 2), new Aspects.AspectStack(Aspects.AQUA, 1)}));
        ItemList.Cover_ItemDetector.set(addItem(tLastID = 733, "Item Detector", "Gives out Item Amount as Redstone", new Object[]{new Aspects.AspectStack(Aspects.SENSUS, 2), new Aspects.AspectStack(Aspects.TERRA, 1)}));
        ItemList.Cover_EnergyDetector.set(addItem(tLastID = 734, "Energy Detector", "Gives out Energy Amount as Redstone", new Object[]{new Aspects.AspectStack(Aspects.SENSUS, 2), new Aspects.AspectStack(Aspects.POTENTIA, 1)}));
        ItemList.Cover_PlayerDetector.set(addItem(tLastID = 735, "Player Detector", "Gives out close Players as Redstone", new Object[]{new Aspects.AspectStack(Aspects.SENSUS, 2), new Aspects.AspectStack(Aspects.MACHINA, 1)}));
        GT_Values.RA.addAssemblerRecipe(ItemList.Sensor_EV.get(1), MatUnifier.get(OrePrefixes.plate, Materials.Titanium), ItemList.Cover_PlayerDetector.get(1), 3200, 128);
        ...
        ItemList.Cover_Screen.set(addItem(tLastID = 740, "Computer Monitor", "Displays Data", new Object[]{new Aspects.AspectStack(Aspects.COGNITIO, 2), new Aspects.AspectStack(Aspects.LUX, 2), new Aspects.AspectStack(Aspects.VITREUS, 1)}));
        ItemList.Cover_Crafting.set(addItem(tLastID = 744, "Crafting Table Cover", "Better than a wooden Workbench", new Object[]{new Aspects.AspectStack(Aspects.FABRICO, 4)}));
        ItemList.Cover_Drain.set(addItem(tLastID = 745, "Drain", "Absorbs Fluids and collects Rain", new Object[]{new Aspects.AspectStack(Aspects.VACUOS, 2), new Aspects.AspectStack(Aspects.AQUA, 2)}));

        ItemList.Cover_Shutter.set(addItem(tLastID = 749, "Shutter Module", "Blocks Inventory/Tank Side. Usage together with Machine Controller.", new Object[]{new Aspects.AspectStack(Aspects.ORDO, 2), new Aspects.AspectStack(Aspects.ITER, 1)}));
        ...
        GT_Values.RA.addAssemblerRecipe(MatUnifier.get(OrePrefixes.plate, Materials.Aluminium, 2), new ItemStack(Blocks.iron_bars, 2), ItemList.Cover_Drain.get(1), 800, 16);
        GT_Values.RA.addAssemblerRecipe(MatUnifier.get(OrePrefixes.plate, Materials.Iron, 2), new ItemStack(Blocks.iron_bars, 2), ItemList.Cover_Drain.get(1), 800, 16);
        GT_Values.RA.addAssemblerRecipe(MatUnifier.get(OrePrefixes.plate, Materials.WroughtIron, 2), new ItemStack(Blocks.iron_bars, 2), ItemList.Cover_Drain.get(1), 800, 16);
        GT_Values.RA.addAssemblerRecipe(MatUnifier.get(OrePrefixes.plate, Materials.Aluminium), new ItemStack(Blocks.crafting_table, 1), ItemList.Cover_Crafting.get(1), 800, 16);
        GT_Values.RA.addAssemblerRecipe(MatUnifier.get(OrePrefixes.plate, Materials.Iron), new ItemStack(Blocks.crafting_table, 1), ItemList.Cover_Crafting.get(1), 800, 16);
        GT_Values.RA.addAssemblerRecipe(MatUnifier.get(OrePrefixes.plate, Materials.WroughtIron), new ItemStack(Blocks.crafting_table, 1), ItemList.Cover_Crafting.get(1), 800, 16);
        ...
        ItemList.Cover_SolarPanel.set(addItem(tLastID = 750, "Solar Panel", "May the Sun be with you", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1), new Aspects.AspectStack(Aspects.POTENTIA, 1), new Aspects.AspectStack(Aspects.TENEBRAE, 1)}));
        ItemList.Cover_SolarPanel_8V.set(addItem(tLastID = 751, "Solar Panel (8V)", "8 Volt Solar Panel", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2), new Aspects.AspectStack(Aspects.POTENTIA, 2), new Aspects.AspectStack(Aspects.TENEBRAE, 2)}));
        ItemList.Cover_SolarPanel_LV.set(addItem(tLastID = 752, "Solar Panel (LV)", "Low Voltage Solar Panel", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4), new Aspects.AspectStack(Aspects.POTENTIA, 4), new Aspects.AspectStack(Aspects.TENEBRAE, 4)}));
        ItemList.Cover_SolarPanel_MV.set(addItem(tLastID = 753, "Solar Panel (MV)", "Medium Voltage Solar Panel", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 8), new Aspects.AspectStack(Aspects.POTENTIA, 8), new Aspects.AspectStack(Aspects.TENEBRAE, 8)}));
        ItemList.Cover_SolarPanel_HV.set(addItem(tLastID = 754, "Solar Panel (HV)", "High Voltage Solar Panel", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16), new Aspects.AspectStack(Aspects.POTENTIA, 16), new Aspects.AspectStack(Aspects.TENEBRAE, 16)}));
        ItemList.Cover_SolarPanel_EV.set(addItem(tLastID = 755, "Solar Panel (EV)", "Extreme Solar Panel", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 32), new Aspects.AspectStack(Aspects.POTENTIA, 32), new Aspects.AspectStack(Aspects.TENEBRAE, 32)}));
        ItemList.Cover_SolarPanel_IV.set(addItem(tLastID = 756, "Solar Panel (IV)", "Insane Solar Panel", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 64), new Aspects.AspectStack(Aspects.POTENTIA, 64), new Aspects.AspectStack(Aspects.TENEBRAE, 64)}));
        ItemList.Cover_SolarPanel_LuV.set(addItem(tLastID = 757, "Solar Panel (LuV)", "Ludicrous Solar Panel", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 64), new Aspects.AspectStack(Aspects.POTENTIA, 64), new Aspects.AspectStack(Aspects.TENEBRAE, 64)}));
        ItemList.Cover_SolarPanel_ZPM.set(addItem(tLastID = 758, "Solar Panel (ZPM)", "ZPM Voltage Solar Panel", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 64), new Aspects.AspectStack(Aspects.POTENTIA, 64), new Aspects.AspectStack(Aspects.TENEBRAE, 64)}));
        ItemList.Cover_SolarPanel_UV.set(addItem(tLastID = 759, "Solar Panel (UV)", "Ultimate Solar Panel", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 64), new Aspects.AspectStack(Aspects.POTENTIA, 64), new Aspects.AspectStack(Aspects.TENEBRAE, 64)}));
        ...
        ItemList.Tool_Sonictron.set(addItem(tLastID = 760, "Sonictron", "Bring your Music with you", new Object[]{Behaviour_Sonictron.INSTANCE, new Aspects.AspectStack(Aspects.SENSUS, 4)}));
        ItemList.Tool_Cheat.set(addItem(tLastID = 761, "Debug Scanner", "Also an Infinite Energy Source", new Object[]{Behaviour_Scanner.INSTANCE, new Aspects.AspectStack(Aspects.NEBRISUM, 64)}));
        setElectricStats(32000 + tLastID, -2000000000L, 1000000000L, -1L, -3L, false);
        ItemList.Tool_Scanner.set(addItem(tLastID = 762, "Portable Scanner", "Tricorder", new Object[]{Behaviour_Scanner.INSTANCE, new Aspects.AspectStack(Aspects.ELECTRUM, 6), new Aspects.AspectStack(Aspects.SENSUS, 6)}));
        ...
        ItemList.Duct_Tape.set(addItem(tLastID = 764, "BrainTech Aerospace Advanced Reinforced Duct Tape FAL-84", "If you can't fix it with this, use more of it!", new Object[]{new Aspects.AspectStack(Aspects.ORDO, 2), new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2), OreDictNames.craftingDuctTape}));

       GT_Values.RA.addAssemblerRecipe(ItemList.Sensor_LV.get(1), ItemList.Emitter_LV.get(1), ItemList.NC_SensorKit.get(1), 1600, 2);

        ItemList.Cover_RedstoneTransmitterExternal.set(addItem(tLastID = 741, "Redstone Transmitter (Out)", "Transfers Redstonesignals wireless", new Object[]{new Aspects.AspectStack(Aspects.ORDO, 2), new Aspects.AspectStack(Aspects.MACHINA, 1)}));
        ItemList.Cover_RedstoneTransmitterInternal.set(addItem(tLastID = 742, "Redstone Transmitter (In)", "Transfers Redstonesignals wireless", new Object[]{new Aspects.AspectStack(Aspects.ORDO, 2), new Aspects.AspectStack(Aspects.MACHINA, 1)}));
        ItemList.Cover_RedstoneReceiverExternal.set(addItem(tLastID = 746, "Redstone Receiver (Out)", "Transfers Redstonesignals wireless", new Object[]{new Aspects.AspectStack(Aspects.ORDO, 2), new Aspects.AspectStack(Aspects.MACHINA, 1)}));
        ItemList.Cover_RedstoneReceiverInternal.set(addItem(tLastID = 747, "Redstone Receiver (In)", "Transfers Redstonesignals wireless", new Object[]{new Aspects.AspectStack(Aspects.ORDO, 2), new Aspects.AspectStack(Aspects.MACHINA, 1)}));
        ...
        GT_Values.RA.addAssemblerRecipe(ItemList.Emitter_EV.get(1), MatUnifier.get(OrePrefixes.plate, Materials.StainlessSteel, 1), ItemList.Cover_RedstoneTransmitterExternal.get(1), 3200, 128);
        GT_Values.RA.addAssemblerRecipe(ItemList.Sensor_EV.get(1), MatUnifier.get(OrePrefixes.plate, Materials.StainlessSteel, 1), ItemList.Cover_RedstoneReceiverExternal.get(1), 3200, 128);
        ...
        ItemList.Cover_NeedsMaintainance.set(addItem(tLastID = 748, "Needs Maintenance Cover", "Attach to Multiblock Controller. Emits Redstone Signal if needs Maintenance", new Object[]{new Aspects.AspectStack(Aspects.ORDO, 2), new Aspects.AspectStack(Aspects.MACHINA, 1)}));
        ...
        GT_Values.RA.addAssemblerRecipe(ItemList.Emitter_MV.get(1), MatUnifier.get(OrePrefixes.plate, Materials.Aluminium), ItemList.Cover_NeedsMaintainance.get(1), 600, 24);
        ...
        ItemList.ZPM2.set(addItem(tLastID = 605, "Ultimate Battery", "Fill this to win minecraft", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 64), new Aspects.AspectStack(Aspects.VITREUS, 16), new Aspects.AspectStack(Aspects.POTENTIA, 64)}));
            ...
            if ((aMaterial != null) && (aMaterial != Materials.Empty) && (aMaterial != Materials._NULL)) {
                ...
                if ((aPrefix == OrePrefixes.dustImpure) || (aPrefix == OrePrefixes.dustPure)) {
                    ...
                    if ((tBlock == Blocks.cauldron) && (tMetaData > 0)) {
                        aItemEntity.setEntityItemStack(MatUnifier.get(OrePrefixes.dust, aMaterial, aItemEntity.getEntityItem().stackSize));
                    ...
                    byte tMetaData = (byte) aItemEntity.worldObj.getBlockMetadata(tX, tY, tZ);
                    if ((tBlock == Blocks.cauldron) && (tMetaData > 0)) {
                        aItemEntity.setEntityItemStack(MatUnifier.get(OrePrefixes.crushedPurified, aMaterial, aItemEntity.getEntityItem().stackSize));
                        aItemEntity.worldObj.setBlockMetadataWithNotify(tX, tY, tZ, tMetaData - 1, 3);
                        return true;
                    }
                }

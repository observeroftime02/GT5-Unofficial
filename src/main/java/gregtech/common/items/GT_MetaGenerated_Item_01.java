...
public class GT_MetaGenerated_Item_01 extends GT_MetaGenerated_Item_X32 {
    ...
    public GT_MetaGenerated_Item_01() {
        ...
        ItemList.Coin_Doge.set(addItem(tLastID = 9, "Doge Coin", "wow much coin how money so crypto plz mine v rich very currency wow", new Object[]{new ItemData(Materials.Brass, 907200), new Aspects.AspectStack(Aspects.LUCRUM, 1L)}));
        ...
        ItemList.Large_Fluid_Cell_Steel.set(addItem(tLastID = 405, "Large Steel Fluid Cell", "", new Object[]{new ItemData(Materials.Steel, OrePrefixes.plate.mMaterialAmount * 2 + 2 * OrePrefixes.ring.mMaterialAmount), new Aspects.AspectStack(Aspects.VACUOS, 4L), new Aspects.AspectStack(Aspects.AQUA, 2L)}));
        ...
        ItemList.Large_Fluid_Cell_TungstenSteel.set(addItem(tLastID = 406, "Large Tungstensteel Fluid Cell", "", new Object[]{new ItemData(Materials.TungstenSteel, OrePrefixes.plate.mMaterialAmount * 2 + 2 * OrePrefixes.ring.mMaterialAmount), new Aspects.AspectStack(Aspects.VACUOS, 6L), new Aspects.AspectStack(Aspects.AQUA, 3L)}));
        ...
        ItemList.Tool_Lighter_Invar_Empty.set(addItem(tLastID = 474, "Lighter (Empty)", "", new Object[]{new ItemData(Materials.Invar, OrePrefixes.plate.mMaterialAmount * 2), new Aspects.AspectStack(Aspects.IGNIS, 1L), new Aspects.AspectStack(Aspects.VACUOS, 1L)}));
        ItemList.Tool_Lighter_Invar_Used.set(addItem(tLastID = 475, "Lighter", "", new Object[]{new ItemData(Materials.Invar, OrePrefixes.plate.mMaterialAmount * 2), new Aspects.AspectStack(Aspects.IGNIS, 2L), new Aspects.AspectStack(Aspects.POTENTIA, 1L), SubTag.INVISIBLE}));
        ItemList.Tool_Lighter_Invar_Full.set(addItem(tLastID = 476, "Lighter (Full)", "", new Object[]{new ItemData(Materials.Invar, OrePrefixes.plate.mMaterialAmount * 2), new Aspects.AspectStack(Aspects.IGNIS, 1L), new Aspects.AspectStack(Aspects.POTENTIA, 2L)}));
        ...
        ItemList.Paper_Magic_Page.set(addItem(tLastID = 483, "Enchanted Page", "", new Object[]{SubTag.INVISIBLE, new ItemData(Materials.Paper, 3628800), new Aspects.AspectStack(Aspects.COGNITIO, 1L), new Aspects.AspectStack(Aspects.PRAECANTATIO, 2L)}));
        ItemList.Paper_Magic_Pages.set(addItem(tLastID = 484, "Enchanted Pages", "", new Object[]{SubTag.INVISIBLE, new ItemData(Materials.Paper, 10886400), new Aspects.AspectStack(Aspects.COGNITIO, 2L), new Aspects.AspectStack(Aspects.PRAECANTATIO, 4L)}));
        ItemList.Paper_Punch_Card_Empty.set(addItem(tLastID = 485, "Punch Card", "", new Object[]{SubTag.INVISIBLE, new ItemData(Materials.Paper, 7257600), new Aspects.AspectStack(Aspects.COGNITIO, 1L)}));
        ItemList.Paper_Punch_Card_Encoded.set(addItem(tLastID = 486, "Punched Card", "", new Object[]{SubTag.INVISIBLE, new ItemData(Materials.Paper, 7257600), new Aspects.AspectStack(Aspects.COGNITIO, 2L)}));
        ItemList.Book_Written_01.set(addItem(tLastID = 487, "Book", "", new Object[]{new ItemData(Materials.Paper, 10886400), "bookWritten", OreDictNames.craftingBook, new Behaviour_WrittenBook(), new Aspects.AspectStack(Aspects.COGNITIO, 2L)}));
        ItemList.Book_Written_02.set(addItem(tLastID = 488, "Book", "", new Object[]{new ItemData(Materials.Paper, 10886400), "bookWritten", OreDictNames.craftingBook, new Behaviour_WrittenBook(), new Aspects.AspectStack(Aspects.COGNITIO, 2L)}));
        ItemList.Book_Written_03.set(addItem(tLastID = 489, "Book", "", new Object[]{new ItemData(Materials.Paper, 10886400), "bookWritten", OreDictNames.craftingBook, new Behaviour_WrittenBook(), new Aspects.AspectStack(Aspects.COGNITIO, 2L)}));

        ItemList.Schematic.set(addItem(tLastID = 490, "Schematic", "EMPTY", new Object[]{new ItemData(Materials.StainlessSteel, 7257600), new Aspects.AspectStack(Aspects.STRONTIO, 1L)}));
        ItemList.Schematic_Crafting.set(addItem(tLastID = 491, "Schematic (Crafting)", "Crafts the Programmed Recipe", new Object[]{new ItemData(Materials.StainlessSteel, 7257600), new Aspects.AspectStack(Aspects.COGNITIO, 1L), new Aspects.AspectStack(Aspects.FABRICO, 1L)}));
        ItemList.Schematic_1by1.set(addItem(tLastID = 495, "Schematic (1x1)", "Crafts 1 Items as 1x1 (use in Packager)", new Object[]{new ItemData(Materials.StainlessSteel, 7257600), new Aspects.AspectStack(Aspects.COGNITIO, 1L), new Aspects.AspectStack(Aspects.FABRICO, 1L)}));
        ItemList.Schematic_2by2.set(addItem(tLastID = 496, "Schematic (2x2)", "Crafts 4 Items as 2x2 (use in Packager)", new Object[]{new ItemData(Materials.StainlessSteel, 7257600), new Aspects.AspectStack(Aspects.COGNITIO, 1L), new Aspects.AspectStack(Aspects.FABRICO, 1L)}));
        ItemList.Schematic_3by3.set(addItem(tLastID = 497, "Schematic (3x3)", "Crafts 9 Items as 3x3 (use in Packager)", new Object[]{new ItemData(Materials.StainlessSteel, 7257600), new Aspects.AspectStack(Aspects.COGNITIO, 1L), new Aspects.AspectStack(Aspects.FABRICO, 1L)}));
        ItemList.Schematic_Dust.set(addItem(tLastID = 498, "Schematic (Dusts)", "Combines Dusts (use in Packager)", new Object[]{new ItemData(Materials.StainlessSteel, 7257600), new Aspects.AspectStack(Aspects.COGNITIO, 1L), new Aspects.AspectStack(Aspects.FABRICO, 1L)}));
        ...
        ItemList.Battery_Hull_MV.set(addItem(tLastID = 501, "Medium Battery Hull", "An empty MV Battery Hull", new Object[]{new ItemData(Materials.BatteryAlloy, OrePrefixes.plate.mMaterialAmount * 3), new Aspects.AspectStack(Aspects.ELECTRUM, 2L), new Aspects.AspectStack(Aspects.METALLUM, 2L), new Aspects.AspectStack(Aspects.VACUOS, 1L)}));
        ItemList.Battery_Hull_HV.set(addItem(tLastID = 502, "Large Battery Hull", "An empty HV Battery Hull", new Object[]{new ItemData(Materials.BatteryAlloy, OrePrefixes.plate.mMaterialAmount * 9), new Aspects.AspectStack(Aspects.ELECTRUM, 4L), new Aspects.AspectStack(Aspects.METALLUM, 4L), new Aspects.AspectStack(Aspects.VACUOS, 1L)}));
        ...
        GT_Values.RA.addCannerRecipe(MatUnifier.get(OrePrefixes.dust, Materials.Cadmium, 2L), ItemList.Battery_Hull_LV.get(1), ItemList.Battery_RE_LV_Cadmium.get(1), null, 100, 2);
        GT_Values.RA.addCannerRecipe(MatUnifier.get(OrePrefixes.dust, Materials.Lithium, 2L), ItemList.Battery_Hull_LV.get(1), ItemList.Battery_RE_LV_Lithium.get(1), null, 100, 2);
        GT_Values.RA.addCannerRecipe(MatUnifier.get(OrePrefixes.dust, Materials.Sodium, 2L), ItemList.Battery_Hull_LV.get(1), ItemList.Battery_RE_LV_Sodium.get(1), null, 100, 2);
        GT_Values.RA.addCannerRecipe(MatUnifier.get(OrePrefixes.dust, Materials.Cadmium, 8L), ItemList.Battery_Hull_MV.get(1), ItemList.Battery_RE_MV_Cadmium.get(1), null, 400, 2);
        GT_Values.RA.addCannerRecipe(MatUnifier.get(OrePrefixes.dust, Materials.Lithium, 8L), ItemList.Battery_Hull_MV.get(1), ItemList.Battery_RE_MV_Lithium.get(1), null, 400, 2);
        GT_Values.RA.addCannerRecipe(MatUnifier.get(OrePrefixes.dust, Materials.Sodium, 8L), ItemList.Battery_Hull_MV.get(1), ItemList.Battery_RE_MV_Sodium.get(1), null, 400, 2);
        GT_Values.RA.addCannerRecipe(MatUnifier.get(OrePrefixes.dust, Materials.Cadmium, 32L), ItemList.Battery_Hull_HV.get(1), ItemList.Battery_RE_HV_Cadmium.get(1), null, 1600, 2);
        GT_Values.RA.addCannerRecipe(MatUnifier.get(OrePrefixes.dust, Materials.Lithium, 32L), ItemList.Battery_Hull_HV.get(1), ItemList.Battery_RE_HV_Lithium.get(1), null, 1600, 2);
        GT_Values.RA.addCannerRecipe(MatUnifier.get(OrePrefixes.dust, Materials.Sodium, 32L), ItemList.Battery_Hull_HV.get(1), ItemList.Battery_RE_HV_Sodium.get(1), null, 1600, 2);

        ItemList.Energy_LapotronicOrb.set(addItem(tLastID = 597, "Lapotronic Energy Orb", "Reusable battery", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.VITREUS, 16L), new Aspects.AspectStack(Aspects.POTENTIA, 16L), OrePrefixes.battery.get(Materials.Ultimate)}));
        setElectricStats(32000 + tLastID, 100000000L, GT_Values.V[5], 5L, -3L, true);

        ItemList.ZPM.set(addItem(tLastID = 598, "Zero Point Module", "Single use battery", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 64L), new Aspects.AspectStack(Aspects.VITREUS, 16L), new Aspects.AspectStack(Aspects.POTENTIA, 64L)}));
        setElectricStats(32000 + tLastID, 2000000000000L, GT_Values.V[7], 7L, -2L, true);

        ItemList.Energy_LapotronicOrb2.set(addItem(tLastID = 599, "Lapotronic Energy Orb Cluster", "Reusable battery", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.VITREUS, 16L), new Aspects.AspectStack(Aspects.POTENTIA, 16L), OrePrefixes.battery.get(Materials.Ultimate)}));
        setElectricStats(32000 + tLastID, 1000000000L, GT_Values.V[6], 6L, -3L, true);
        


        ItemList.Energy_Module.set(addItem(tLastID = 736, "Energy Module", "Reusable battery", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.VITREUS, 16L), new Aspects.AspectStack(Aspects.POTENTIA, 16L), OrePrefixes.battery.get(Materials.Ultimate)}));
        setElectricStats(32000 + tLastID, 10000000000L, GT_Values.V[7], 7L, -3L, true);

        ItemList.Energy_Cluster.set(addItem(tLastID = 737, "Energy Cluster", "Reusable battery", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 64L), new Aspects.AspectStack(Aspects.VITREUS, 16L), new Aspects.AspectStack(Aspects.POTENTIA, 64L)}));
        ...
        /**ItemList.Rotor_LV.set(addItem(tLastID = 620, "Tin Rotor", "", new Object[] { OrePrefixes.rotor.get(Materials.Tin), new Aspects.AspectStack(Aspects.METALLUM, 1L), new Aspects.AspectStack(Aspects.MOTUS, 1L) }));
         ItemList.Rotor_MV.set(addItem(tLastID = 621, "Bronze Rotor", "", new Object[] { OrePrefixes.rotor.get(Materials.Bronze), new Aspects.AspectStack(Aspects.METALLUM, 2L), new Aspects.AspectStack(Aspects.MOTUS, 2L) }));
         ItemList.Rotor_HV.set(addItem(tLastID = 622, "Steel Rotor", "", new Object[] { OrePrefixes.rotor.get(Materials.Steel), new Aspects.AspectStack(Aspects.METALLUM, 4L), new Aspects.AspectStack(Aspects.MOTUS, 4L) }));
         ItemList.Rotor_EV.set(addItem(tLastID = 623, "Stainless Steel Rotor", "", new Object[] { OrePrefixes.rotor.get(Materials.StainlessSteel), new Aspects.AspectStack(Aspects.METALLUM, 8L), new Aspects.AspectStack(Aspects.MOTUS, 8L) }));
         ItemList.Rotor_IV.set(addItem(tLastID = 624, "Tungstensteel Rotor", "", new Object[] { OrePrefixes.rotor.get(Materials.TungstenSteel), new Aspects.AspectStack(Aspects.METALLUM, 16L), new Aspects.AspectStack(Aspects.MOTUS, 16L) }));

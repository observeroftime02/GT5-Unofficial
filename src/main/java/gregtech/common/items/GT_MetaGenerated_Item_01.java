...
public class GT_MetaGenerated_Item_01 extends GT_MetaGenerated_Item_X32 {
    ...
    public GT_MetaGenerated_Item_01() {
        super("metaitem.01", OrePrefixes.dustTiny, OrePrefixes.dustSmall, OrePrefixes.dust, OrePrefixes.dustImpure, OrePrefixes.dustPure, OrePrefixes.crushed, OrePrefixes.crushedPurified, OrePrefixes.crushedCentrifuged, OrePrefixes.gem, OrePrefixes.nugget, null, OrePrefixes.ingot, OrePrefixes.ingotHot, null, null, null, null, OrePrefixes.plate, null, null, null, null, OrePrefixes.plateDense, OrePrefixes.stick, OrePrefixes.lens, OrePrefixes.round, OrePrefixes.bolt, OrePrefixes.screw, OrePrefixes.ring, OrePrefixes.foil, OrePrefixes.cell, OrePrefixes.cellPlasma);
        INSTANCE = this;
        ...
        ItemList.Coin_Doge.set(addItem(tLastID = 9, "Doge Coin", "wow much coin how money so crypto plz mine v rich very currency wow", new Object[]{new ItemData(Materials.Brass, 907200L), new Aspects.AspectStack(Aspects.LUCRUM, 1L)}));

        ItemList.Component_Minecart_Wheels_Iron.set(addItem(tLastID = 100, "Iron Minecart Wheels", "To get things rolling", new Object[]{new Aspects.AspectStack(Aspects.MOTUS, 2L), new Aspects.AspectStack(Aspects.METALLUM, 2L)}));
        ItemList.Component_Minecart_Wheels_Steel.set(addItem(tLastID = 101, "Steel Minecart Wheels", "To get things rolling", new Object[]{new Aspects.AspectStack(Aspects.MOTUS, 2L), new Aspects.AspectStack(Aspects.METALLUM, 2L)}));
        ...
        ItemList.Shape_Empty.set(addItem(tLastID = 300, "Empty Shape Plate", "Raw Plate to make Molds and Extruder Shapes", new Object[]{new Aspects.AspectStack(Aspects.FABRICO, 4L), new Aspects.AspectStack(Aspects.METALLUM, 4L)}));
        ...
        ItemList.Fuel_Can_Plastic_Empty.set(addItem(tLastID = 400, "Empty Plastic Fuel Can", "Used to store Fuels", new Object[]{new ItemData(Materials.Plastic, OrePrefixes.plate.mMaterialAmount * 1L), new Aspects.AspectStack(Aspects.VACUOS, 1L), new Aspects.AspectStack(Aspects.ITER, 1L)}));
        ItemList.Fuel_Can_Plastic_Filled.set(addItem(tLastID = 401, "Plastic Fuel Can", "Burns well in Diesel Generators", new Object[]{new ItemData(Materials.Plastic, OrePrefixes.plate.mMaterialAmount * 1L), new Aspects.AspectStack(Aspects.VACUOS, 1L), new Aspects.AspectStack(Aspects.ITER, 1L)}));
        ...
        ItemList.Spray_Empty.set(addItem(tLastID = 402, "Empty Spray Can", "Used for making Sprays", new Object[]{new ItemData(Materials.Tin, OrePrefixes.plate.mMaterialAmount * 2L, Materials.Redstone, OrePrefixes.dust.mMaterialAmount), new Aspects.AspectStack(Aspects.VACUOS, 1L), new Aspects.AspectStack(Aspects.MOTUS, 1L)}));
        ...
        ItemList.Large_Fluid_Cell_Steel.set(addItem(tLastID = 405, "Large Steel Fluid Cell", "", new Object[]{new ItemData(Materials.Steel, OrePrefixes.plate.mMaterialAmount * 2L + 2L * OrePrefixes.ring.mMaterialAmount), new Aspects.AspectStack(Aspects.VACUOS, 4L), new Aspects.AspectStack(Aspects.AQUA, 2L)}));
        setFluidContainerStats(32000 + tLastID, 16000L, 16L);

        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Steel, 2L), GT_OreDictUnificator.get(OrePrefixes.ring, Materials.Steel, 2L), ItemList.Large_Fluid_Cell_Steel.get(1L), 100, 64);

        ItemList.Large_Fluid_Cell_TungstenSteel.set(addItem(tLastID = 406, "Large Tungstensteel Fluid Cell", "", new Object[]{new ItemData(Materials.TungstenSteel, OrePrefixes.plate.mMaterialAmount * 2L + 2L * OrePrefixes.ring.mMaterialAmount), new Aspects.AspectStack(Aspects.VACUOS, 6L), new Aspects.AspectStack(Aspects.AQUA, 3L)}));
        setFluidContainerStats(32000 + tLastID, 64000L, 16L);

        GT_Values.RA.addAssemblerRecipe(GT_OreDictUnificator.get(OrePrefixes.plate, Materials.TungstenSteel, 2L), GT_OreDictUnificator.get(OrePrefixes.ring, Materials.TungstenSteel, 2L), ItemList.Large_Fluid_Cell_TungstenSteel.get(1L), 200, 256);

        ItemList.Tool_Matches.set(addItem(tLastID = 471, "Match", "", new Object[]{new Aspects.AspectStack(Aspects.IGNIS, 1L), new Aspects.AspectStack(Aspects.VACUOS, 1L)}));
        ItemList.Tool_MatchBox_Used.set(addItem(tLastID = 472, "Match Box", "This is not a Car", new Object[]{new Aspects.AspectStack(Aspects.IGNIS, 2L), new Aspects.AspectStack(Aspects.POTENTIA, 1L), SubTag.INVISIBLE}));
        ItemList.Tool_MatchBox_Full.set(addItem(tLastID = 473, "Match Box (Full)", "This is not a Car", new Object[]{new Aspects.AspectStack(Aspects.IGNIS, 1L), new Aspects.AspectStack(Aspects.POTENTIA, 2L)}));
        ...
        GT_Values.RA.addBoxingRecipe(ItemList.Tool_Matches.get(16L), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Paper, 2L), ItemList.Tool_MatchBox_Full.get(1L), 64, 16);
        GT_Values.RA.addUnboxingRecipe(ItemList.Tool_MatchBox_Full.get(1L), ItemList.Tool_Matches.get(16L), null, 32, 16);

        ItemList.Tool_Lighter_Invar_Empty.set(addItem(tLastID = 474, "Lighter (Empty)", "", new Object[]{new ItemData(Materials.Invar, OrePrefixes.plate.mMaterialAmount * 2L), new Aspects.AspectStack(Aspects.IGNIS, 1L), new Aspects.AspectStack(Aspects.VACUOS, 1L)}));
        ItemList.Tool_Lighter_Invar_Used.set(addItem(tLastID = 475, "Lighter", "", new Object[]{new ItemData(Materials.Invar, OrePrefixes.plate.mMaterialAmount * 2L), new Aspects.AspectStack(Aspects.IGNIS, 2L), new Aspects.AspectStack(Aspects.POTENTIA, 1L), SubTag.INVISIBLE}));
        ItemList.Tool_Lighter_Invar_Full.set(addItem(tLastID = 476, "Lighter (Full)", "", new Object[]{new ItemData(Materials.Invar, OrePrefixes.plate.mMaterialAmount * 2L), new Aspects.AspectStack(Aspects.IGNIS, 1L), new Aspects.AspectStack(Aspects.POTENTIA, 2L)}));
        ...
        ItemList.Tool_Lighter_Platinum_Empty.set(addItem(tLastID = 477, "Platinum Lighter (Empty)", "A known Prank Master is engraved on it", new Object[]{new ItemData(Materials.Platinum, OrePrefixes.plate.mMaterialAmount * 2L), new Aspects.AspectStack(Aspects.IGNIS, 1L), new Aspects.AspectStack(Aspects.NEBRISUM, 1L), new Aspects.AspectStack(Aspects.VACUOS, 1L)}));
        ItemList.Tool_Lighter_Platinum_Used.set(addItem(tLastID = 478, "Platinum Lighter", "A known Prank Master is engraved on it", new Object[]{new ItemData(Materials.Platinum, OrePrefixes.plate.mMaterialAmount * 2L), new Aspects.AspectStack(Aspects.IGNIS, 2L), new Aspects.AspectStack(Aspects.NEBRISUM, 1L), new Aspects.AspectStack(Aspects.POTENTIA, 1L), SubTag.INVISIBLE}));
        ItemList.Tool_Lighter_Platinum_Full.set(addItem(tLastID = 479, "Platinum Lighter (Full)", "A known Prank Master is engraved on it", new Object[]{new ItemData(Materials.Platinum, OrePrefixes.plate.mMaterialAmount * 2L), new Aspects.AspectStack(Aspects.IGNIS, 1L), new Aspects.AspectStack(Aspects.NEBRISUM, 1L), new Aspects.AspectStack(Aspects.POTENTIA, 2L)}));
        ...
        ItemList.Plate_IridiumAlloy.set(GT_ModHandler.getIC2Item("iridiumPlate", 1L));
        ItemList.Plate_AdvancedAlloy.set(GT_ModHandler.getIC2Item("advancedAlloy", 1L));
        ItemList.Plate_CarbonAlloy.set(GT_ModHandler.getIC2Item("carbonPlate", 1L));
        ...
        ItemList.Paper_Printed_Pages.set(addItem(tLastID = 481, "Printed Pages", "Used to make written Books", new Object[]{new ItemData(Materials.Paper, 10886400L), new Behaviour_PrintedPages(), new Aspects.AspectStack(Aspects.COGNITIO, 2L)}));
        ItemList.Paper_Magic_Empty.set(addItem(tLastID = 482, "Magic Paper", "", new Object[]{SubTag.INVISIBLE, new ItemData(Materials.Paper, 3628800L), new Aspects.AspectStack(Aspects.COGNITIO, 1L), new Aspects.AspectStack(Aspects.PRAECANTATIO, 1L)}));
        ItemList.Paper_Magic_Page.set(addItem(tLastID = 483, "Enchanted Page", "", new Object[]{SubTag.INVISIBLE, new ItemData(Materials.Paper, 3628800L), new Aspects.AspectStack(Aspects.COGNITIO, 1L), new Aspects.AspectStack(Aspects.PRAECANTATIO, 2L)}));
        ItemList.Paper_Magic_Pages.set(addItem(tLastID = 484, "Enchanted Pages", "", new Object[]{SubTag.INVISIBLE, new ItemData(Materials.Paper, 10886400L), new Aspects.AspectStack(Aspects.COGNITIO, 2L), new Aspects.AspectStack(Aspects.PRAECANTATIO, 4L)}));
        ItemList.Paper_Punch_Card_Empty.set(addItem(tLastID = 485, "Punch Card", "", new Object[]{SubTag.INVISIBLE, new ItemData(Materials.Paper, 7257600L), new Aspects.AspectStack(Aspects.COGNITIO, 1L)}));
        ItemList.Paper_Punch_Card_Encoded.set(addItem(tLastID = 486, "Punched Card", "", new Object[]{SubTag.INVISIBLE, new ItemData(Materials.Paper, 7257600L), new Aspects.AspectStack(Aspects.COGNITIO, 2L)}));
        ItemList.Book_Written_01.set(addItem(tLastID = 487, "Book", "", new Object[]{new ItemData(Materials.Paper, 10886400L), "bookWritten", OreDictNames.craftingBook, new Behaviour_WrittenBook(), new Aspects.AspectStack(Aspects.COGNITIO, 2L)}));
        ItemList.Book_Written_02.set(addItem(tLastID = 488, "Book", "", new Object[]{new ItemData(Materials.Paper, 10886400L), "bookWritten", OreDictNames.craftingBook, new Behaviour_WrittenBook(), new Aspects.AspectStack(Aspects.COGNITIO, 2L)}));
        ItemList.Book_Written_03.set(addItem(tLastID = 489, "Book", "", new Object[]{new ItemData(Materials.Paper, 10886400L), "bookWritten", OreDictNames.craftingBook, new Behaviour_WrittenBook(), new Aspects.AspectStack(Aspects.COGNITIO, 2L)}));

        ItemList.Schematic.set(addItem(tLastID = 490, "Schematic", "EMPTY", new Object[]{new ItemData(Materials.StainlessSteel, 7257600L), new Aspects.AspectStack(Aspects.STRONTIO, 1L)}));
        ItemList.Schematic_Crafting.set(addItem(tLastID = 491, "Schematic (Crafting)", "Crafts the Programmed Recipe", new Object[]{new ItemData(Materials.StainlessSteel, 7257600L), new Aspects.AspectStack(Aspects.COGNITIO, 1L), new Aspects.AspectStack(Aspects.FABRICO, 1L)}));
        ItemList.Schematic_1by1.set(addItem(tLastID = 495, "Schematic (1x1)", "Crafts 1 Items as 1x1 (use in Packager)", new Object[]{new ItemData(Materials.StainlessSteel, 7257600L), new Aspects.AspectStack(Aspects.COGNITIO, 1L), new Aspects.AspectStack(Aspects.FABRICO, 1L)}));
        ItemList.Schematic_2by2.set(addItem(tLastID = 496, "Schematic (2x2)", "Crafts 4 Items as 2x2 (use in Packager)", new Object[]{new ItemData(Materials.StainlessSteel, 7257600L), new Aspects.AspectStack(Aspects.COGNITIO, 1L), new Aspects.AspectStack(Aspects.FABRICO, 1L)}));
        ItemList.Schematic_3by3.set(addItem(tLastID = 497, "Schematic (3x3)", "Crafts 9 Items as 3x3 (use in Packager)", new Object[]{new ItemData(Materials.StainlessSteel, 7257600L), new Aspects.AspectStack(Aspects.COGNITIO, 1L), new Aspects.AspectStack(Aspects.FABRICO, 1L)}));
        ItemList.Schematic_Dust.set(addItem(tLastID = 498, "Schematic (Dusts)", "Combines Dusts (use in Packager)", new Object[]{new ItemData(Materials.StainlessSteel, 7257600L), new Aspects.AspectStack(Aspects.COGNITIO, 1L), new Aspects.AspectStack(Aspects.FABRICO, 1L)}));
        ...
        ItemList.Battery_RE_ULV_Tantalum.set(addItem(tLastID = 499, "Tantalum Capacitor", "Reusable", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1L), new Aspects.AspectStack(Aspects.METALLUM, 1L), new Aspects.AspectStack(Aspects.POTENTIA, 1L)}));
        setElectricStats(32000 + tLastID, 1000L, GT_Values.V[0], 0L, -3L, false);

        ItemList.Battery_SU_LV_SulfuricAcid.set(addItem(tLastID = 510, "Small Acid Battery", "Single Use", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1L), new Aspects.AspectStack(Aspects.METALLUM, 1L), new Aspects.AspectStack(Aspects.POTENTIA, 2L)}));
        setElectricStats(32000 + tLastID, 18000L, GT_Values.V[1], 1L, -2L, true);
        ItemList.Battery_SU_LV_Mercury.set(addItem(tLastID = 511, "Small Mercury Battery", "Single Use", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1L), new Aspects.AspectStack(Aspects.METALLUM, 1L), new Aspects.AspectStack(Aspects.POTENTIA, 2L)}));
        setElectricStats(32000 + tLastID, 32000L, GT_Values.V[1], 1L, -2L, true);

        ItemList.Battery_RE_LV_Cadmium.set(addItem(tLastID = 517, "Small Cadmium Battery", "Reusable", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1L), new Aspects.AspectStack(Aspects.METALLUM, 1L), new Aspects.AspectStack(Aspects.POTENTIA, 1L), "calclavia:ADVANCED_BATTERY"}));
        setElectricStats(32000 + tLastID, 75000L, GT_Values.V[1], 1L, -3L, true);
        ItemList.Battery_RE_LV_Lithium.set(addItem(tLastID = 518, "Small Lithium Battery", "Reusable", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1L), new Aspects.AspectStack(Aspects.METALLUM, 1L), new Aspects.AspectStack(Aspects.POTENTIA, 1L), "calclavia:ADVANCED_BATTERY"}));
        setElectricStats(32000 + tLastID, 100000L, GT_Values.V[1], 1L, -3L, true);
        ItemList.Battery_RE_LV_Sodium.set(addItem(tLastID = 519, "Small Sodium Battery", "Reusable", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1L), new Aspects.AspectStack(Aspects.METALLUM, 1L), new Aspects.AspectStack(Aspects.POTENTIA, 1L), "calclavia:ADVANCED_BATTERY"}));
        setElectricStats(32000 + tLastID, 50000L, GT_Values.V[1], 1L, -3L, true);

        ItemList.Battery_SU_MV_SulfuricAcid.set(addItem(tLastID = 520, "Medium Acid Battery", "Single Use", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2L), new Aspects.AspectStack(Aspects.METALLUM, 2L), new Aspects.AspectStack(Aspects.POTENTIA, 4L)}));
        setElectricStats(32000 + tLastID, 72000L, GT_Values.V[2], 2L, -2L, true);
        ItemList.Battery_SU_MV_Mercury.set(addItem(tLastID = 521, "Medium Mercury Battery", "Single Use", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2L), new Aspects.AspectStack(Aspects.METALLUM, 2L), new Aspects.AspectStack(Aspects.POTENTIA, 4L)}));
        setElectricStats(32000 + tLastID, 128000L, GT_Values.V[2], 2L, -2L, true);

        ItemList.Battery_RE_MV_Cadmium.set(addItem(tLastID = 527, "Medium Cadmium Battery", "Reusable", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2L), new Aspects.AspectStack(Aspects.METALLUM, 2L), new Aspects.AspectStack(Aspects.POTENTIA, 2L)}));
        setElectricStats(32000 + tLastID, 300000L, GT_Values.V[2], 2L, -3L, true);
        ItemList.Battery_RE_MV_Lithium.set(addItem(tLastID = 528, "Medium Lithium Battery", "Reusable", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2L), new Aspects.AspectStack(Aspects.METALLUM, 2L), new Aspects.AspectStack(Aspects.POTENTIA, 2L)}));
        setElectricStats(32000 + tLastID, 400000L, GT_Values.V[2], 2L, -3L, true);
        ItemList.Battery_RE_MV_Sodium.set(addItem(tLastID = 529, "Medium Sodium Battery", "Reusable", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2L), new Aspects.AspectStack(Aspects.METALLUM, 2L), new Aspects.AspectStack(Aspects.POTENTIA, 2L)}));
        setElectricStats(32000 + tLastID, 200000L, GT_Values.V[2], 2L, -3L, true);

        ItemList.Battery_SU_HV_SulfuricAcid.set(addItem(tLastID = 530, "Large Acid Battery", "Single Use", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4L), new Aspects.AspectStack(Aspects.METALLUM, 4L), new Aspects.AspectStack(Aspects.POTENTIA, 8L)}));
        setElectricStats(32000 + tLastID, 288000L, GT_Values.V[3], 3L, -2L, true);
        ItemList.Battery_SU_HV_Mercury.set(addItem(tLastID = 531, "Large Mercury Battery", "Single Use", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4L), new Aspects.AspectStack(Aspects.METALLUM, 4L), new Aspects.AspectStack(Aspects.POTENTIA, 8L)}));
        setElectricStats(32000 + tLastID, 512000L, GT_Values.V[3], 3L, -2L, true);

        ItemList.Battery_RE_HV_Cadmium.set(addItem(tLastID = 537, "Large Cadmium Battery", "Reusable", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4L), new Aspects.AspectStack(Aspects.METALLUM, 4L), new Aspects.AspectStack(Aspects.POTENTIA, 4L)}));
        setElectricStats(32000 + tLastID, 1200000L, GT_Values.V[3], 3L, -3L, true);
        ItemList.Battery_RE_HV_Lithium.set(addItem(tLastID = 538, "Large Lithium Battery", "Reusable", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4L), new Aspects.AspectStack(Aspects.METALLUM, 4L), new Aspects.AspectStack(Aspects.POTENTIA, 4L)}));
        setElectricStats(32000 + tLastID, 1600000L, GT_Values.V[3], 3L, -3L, true);
        ItemList.Battery_RE_HV_Sodium.set(addItem(tLastID = 539, "Large Sodium Battery", "Reusable", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4L), new Aspects.AspectStack(Aspects.METALLUM, 4L), new Aspects.AspectStack(Aspects.POTENTIA, 4L)}));
        ...
        ItemList.Energy_LapotronicOrb.set(addItem(tLastID = 597, "Lapotronic Energy Orb", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.VITREUS, 16L), new Aspects.AspectStack(Aspects.POTENTIA, 16L), OrePrefixes.battery.get(Materials.Ultimate)}));
        setElectricStats(32000 + tLastID, 100000000L, GT_Values.V[5], 5L, -3L, true);

        ItemList.ZPM.set(addItem(tLastID = 598, "Zero Point Module", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 64L), new Aspects.AspectStack(Aspects.VITREUS, 16L), new Aspects.AspectStack(Aspects.POTENTIA, 64L)}));
        setElectricStats(32000 + tLastID, 2000000000000L, GT_Values.V[7], 7L, -2L, true);

        ItemList.Energy_LapotronicOrb2.set(addItem(tLastID = 599, "Lapotronic Energy Orb Cluster", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.VITREUS, 16L), new Aspects.AspectStack(Aspects.POTENTIA, 16L), OrePrefixes.battery.get(Materials.Ultimate)}));
        setElectricStats(32000 + tLastID, 1000000000L, GT_Values.V[6], 6L, -3L, true);

        ItemList.ZPM2.set(addItem(tLastID = 605, "Ultimate Battery", "Fill this to win minecraft", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 64L), new Aspects.AspectStack(Aspects.VITREUS, 16L), new Aspects.AspectStack(Aspects.POTENTIA, 64L)}));
        setElectricStats(32000 + tLastID, Long.MAX_VALUE, GT_Values.V[8], 8L, -3L, true);

        ItemList.Electric_Motor_LV.set(addItem(tLastID = 600, "Electric Motor (LV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1L), new Aspects.AspectStack(Aspects.MACHINA, 1L), new Aspects.AspectStack(Aspects.MOTUS, 1L)}));
        ItemList.Electric_Motor_MV.set(addItem(tLastID = 601, "Electric Motor (MV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2L), new Aspects.AspectStack(Aspects.MACHINA, 2L), new Aspects.AspectStack(Aspects.MOTUS, 2L)}));
        ItemList.Electric_Motor_HV.set(addItem(tLastID = 602, "Electric Motor (HV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4L), new Aspects.AspectStack(Aspects.MACHINA, 4L), new Aspects.AspectStack(Aspects.MOTUS, 4L)}));
        ItemList.Electric_Motor_EV.set(addItem(tLastID = 603, "Electric Motor (EV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 8L), new Aspects.AspectStack(Aspects.MACHINA, 8L), new Aspects.AspectStack(Aspects.MOTUS, 8L)}));
        ItemList.Electric_Motor_IV.set(addItem(tLastID = 604, "Electric Motor (IV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.MOTUS, 16L)}));
        ItemList.Electric_Motor_LuV.set(addItem(tLastID = 606, "Electric Motor (LuV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 24L), new Aspects.AspectStack(Aspects.MACHINA, 24L), new Aspects.AspectStack(Aspects.MOTUS, 24L)}));
        ItemList.Electric_Motor_ZPM.set(addItem(tLastID = 607, "Electric Motor (ZPM)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 32L), new Aspects.AspectStack(Aspects.MACHINA, 32L), new Aspects.AspectStack(Aspects.MOTUS, 32L)}));
        ItemList.Electric_Motor_UV.set(addItem(tLastID = 608, "Electric Motor (UV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 48L), new Aspects.AspectStack(Aspects.MACHINA, 48L), new Aspects.AspectStack(Aspects.MOTUS, 48L)}));
        ...
        ItemList.Electric_Pump_LV.set(addItem(tLastID = 610, "Electric Pump (LV)", "640 L/sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1L), new Aspects.AspectStack(Aspects.MACHINA, 1L), new Aspects.AspectStack(Aspects.ITER, 1L), new Aspects.AspectStack(Aspects.AQUA, 1L)}));
        ItemList.Electric_Pump_MV.set(addItem(tLastID = 611, "Electric Pump (MV)", "2560 L/sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2L), new Aspects.AspectStack(Aspects.MACHINA, 2L), new Aspects.AspectStack(Aspects.ITER, 2L), new Aspects.AspectStack(Aspects.AQUA, 2L)}));
        ItemList.Electric_Pump_HV.set(addItem(tLastID = 612, "Electric Pump (HV)", "10240 L/sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4L), new Aspects.AspectStack(Aspects.MACHINA, 4L), new Aspects.AspectStack(Aspects.ITER, 4L), new Aspects.AspectStack(Aspects.AQUA, 4L)}));
        ItemList.Electric_Pump_EV.set(addItem(tLastID = 613, "Electric Pump (EV)", "40.960 L/sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 8L), new Aspects.AspectStack(Aspects.MACHINA, 8L), new Aspects.AspectStack(Aspects.ITER, 8L), new Aspects.AspectStack(Aspects.AQUA, 8L)}));
        ItemList.Electric_Pump_IV.set(addItem(tLastID = 614, "Electric Pump (IV)", "163.840 L/sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.ITER, 16L), new Aspects.AspectStack(Aspects.AQUA, 16L)}));
        ItemList.Electric_Pump_LuV.set(addItem(tLastID = 620, "Electric Pump (LuV)", "655.360 L/sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.ITER, 16L), new Aspects.AspectStack(Aspects.AQUA, 16L)}));
        ItemList.Electric_Pump_ZPM.set(addItem(tLastID = 621, "Electric Pump (ZPM)", "2.621.440 L/sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.ITER, 16L), new Aspects.AspectStack(Aspects.AQUA, 16L)}));
        ItemList.Electric_Pump_UV.set(addItem(tLastID = 622, "Electric Pump (UV)", "10.485.760 L/sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.ITER, 16L), new Aspects.AspectStack(Aspects.AQUA, 16L)}));

        GregTech_API.registerCover(ItemList.Electric_Pump_LV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[1][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_PUMP)), new GT_Cover_Pump(32));
        GregTech_API.registerCover(ItemList.Electric_Pump_MV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[2][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_PUMP)), new GT_Cover_Pump(128));
        GregTech_API.registerCover(ItemList.Electric_Pump_HV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[3][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_PUMP)), new GT_Cover_Pump(512));
        GregTech_API.registerCover(ItemList.Electric_Pump_EV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[4][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_PUMP)), new GT_Cover_Pump(2048));
        GregTech_API.registerCover(ItemList.Electric_Pump_IV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[5][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_PUMP)), new GT_Cover_Pump(8192));
        GregTech_API.registerCover(ItemList.Electric_Pump_LuV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[6][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_PUMP)), new GT_Cover_Pump(32768));
        GregTech_API.registerCover(ItemList.Electric_Pump_ZPM.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[7][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_PUMP)), new GT_Cover_Pump(131072));
        GregTech_API.registerCover(ItemList.Electric_Pump_UV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[8][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_PUMP)), new GT_Cover_Pump(524288));
        ...
        GregTech_API.registerCover(ItemList.FluidRegulator_LV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[1][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_PUMP)), new GT_Cover_FluidRegulator(32));
        GregTech_API.registerCover(ItemList.FluidRegulator_MV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[2][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_PUMP)), new GT_Cover_FluidRegulator(128));
        GregTech_API.registerCover(ItemList.FluidRegulator_HV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[3][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_PUMP)), new GT_Cover_FluidRegulator(512));
        GregTech_API.registerCover(ItemList.FluidRegulator_EV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[4][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_PUMP)), new GT_Cover_FluidRegulator(2048));
        GregTech_API.registerCover(ItemList.FluidRegulator_IV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[5][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_PUMP)), new GT_Cover_FluidRegulator(8192));
        ...
        GregTech_API.registerCover(ItemList.FluidFilter.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[1][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_SHUTTER)), new GT_Cover_Fluidfilter());
        ...
        ItemList.Conveyor_Module_LV.set(addItem(tLastID = 630, "Conveyor Module (LV)", "1 Stack every 20 secs (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1L), new Aspects.AspectStack(Aspects.MACHINA, 1L), new Aspects.AspectStack(Aspects.ITER, 1L)}));
        ItemList.Conveyor_Module_MV.set(addItem(tLastID = 631, "Conveyor Module (MV)", "1 Stack every 5 secs (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2L), new Aspects.AspectStack(Aspects.MACHINA, 2L), new Aspects.AspectStack(Aspects.ITER, 2L)}));
        ItemList.Conveyor_Module_HV.set(addItem(tLastID = 632, "Conveyor Module (HV)", "1 Stack every 1 sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4L), new Aspects.AspectStack(Aspects.MACHINA, 4L), new Aspects.AspectStack(Aspects.ITER, 4L)}));
        ItemList.Conveyor_Module_EV.set(addItem(tLastID = 633, "Conveyor Module (EV)", "1 Stack every 1/5 sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 8L), new Aspects.AspectStack(Aspects.MACHINA, 8L), new Aspects.AspectStack(Aspects.ITER, 8L)}));
        ItemList.Conveyor_Module_IV.set(addItem(tLastID = 634, "Conveyor Module (IV)", "1 Stack every 1/20 sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.ITER, 16L)}));
        ItemList.Conveyor_Module_LuV.set(addItem(tLastID = 636, "Conveyor Module (LuV)", "1 Stack every 1/20 sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.ITER, 16L)}));
        ItemList.Conveyor_Module_ZPM.set(addItem(tLastID = 637, "Conveyor Module (ZPM)", "1 Stack every 1/20 sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.ITER, 16L)}));
        ItemList.Conveyor_Module_UV.set(addItem(tLastID = 638, "Conveyor Module (UV)", "1 Stack every 1/20 sec (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.ITER, 16L)}));
        ...
        GregTech_API.registerCover(ItemList.Conveyor_Module_LV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[1][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_CONVEYOR)), new GT_Cover_Conveyor(400));
        GregTech_API.registerCover(ItemList.Conveyor_Module_MV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[2][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_CONVEYOR)), new GT_Cover_Conveyor(100));
        GregTech_API.registerCover(ItemList.Conveyor_Module_HV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[3][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_CONVEYOR)), new GT_Cover_Conveyor(20));
        GregTech_API.registerCover(ItemList.Conveyor_Module_EV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[4][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_CONVEYOR)), new GT_Cover_Conveyor(4));
        GregTech_API.registerCover(ItemList.Conveyor_Module_IV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[5][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_CONVEYOR)), new GT_Cover_Conveyor(1));
        GregTech_API.registerCover(ItemList.Conveyor_Module_LuV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[6][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_CONVEYOR)), new GT_Cover_Conveyor(1));
        GregTech_API.registerCover(ItemList.Conveyor_Module_ZPM.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[7][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_CONVEYOR)), new GT_Cover_Conveyor(1));
        GregTech_API.registerCover(ItemList.Conveyor_Module_UV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[8][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_CONVEYOR)), new GT_Cover_Conveyor(1));

        ItemList.Electric_Piston_LV.set(addItem(tLastID = 640, "Electric Piston (LV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1L), new Aspects.AspectStack(Aspects.MACHINA, 2L), new Aspects.AspectStack(Aspects.MOTUS, 1L)}));
        ItemList.Electric_Piston_MV.set(addItem(tLastID = 641, "Electric Piston (MV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2L), new Aspects.AspectStack(Aspects.MACHINA, 4L), new Aspects.AspectStack(Aspects.MOTUS, 2L)}));
        ItemList.Electric_Piston_HV.set(addItem(tLastID = 642, "Electric Piston (HV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4L), new Aspects.AspectStack(Aspects.MACHINA, 8L), new Aspects.AspectStack(Aspects.MOTUS, 4L)}));
        ItemList.Electric_Piston_EV.set(addItem(tLastID = 643, "Electric Piston (EV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 8L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.MOTUS, 8L)}));
        ItemList.Electric_Piston_IV.set(addItem(tLastID = 644, "Electric Piston (IV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 32L), new Aspects.AspectStack(Aspects.MOTUS, 16L)}));
        ItemList.Electric_Piston_LuV.set(addItem(tLastID = 645, "Electric Piston (LuV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 32L), new Aspects.AspectStack(Aspects.MOTUS, 16L)}));
        ItemList.Electric_Piston_ZPM.set(addItem(tLastID = 646, "Electric Piston (ZPM)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 32L), new Aspects.AspectStack(Aspects.MOTUS, 16L)}));
        ItemList.Electric_Piston_UV.set(addItem(tLastID = 647, "Electric Piston (UV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 32L), new Aspects.AspectStack(Aspects.MOTUS, 16L)}));
        ...
        ItemList.Robot_Arm_LV.set(addItem(tLastID = 650, "Robot Arm (LV)", "Inserts into specific Slots (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1L), new Aspects.AspectStack(Aspects.MACHINA, 2L), new Aspects.AspectStack(Aspects.MOTUS, 1L), new Aspects.AspectStack(Aspects.COGNITIO, 1L)}));
        ItemList.Robot_Arm_MV.set(addItem(tLastID = 651, "Robot Arm (MV)", "Inserts into specific Slots (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2L), new Aspects.AspectStack(Aspects.MACHINA, 4L), new Aspects.AspectStack(Aspects.MOTUS, 2L), new Aspects.AspectStack(Aspects.COGNITIO, 2L)}));
        ItemList.Robot_Arm_HV.set(addItem(tLastID = 652, "Robot Arm (HV)", "Inserts into specific Slots (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4L), new Aspects.AspectStack(Aspects.MACHINA, 8L), new Aspects.AspectStack(Aspects.MOTUS, 4L), new Aspects.AspectStack(Aspects.COGNITIO, 4L)}));
        ItemList.Robot_Arm_EV.set(addItem(tLastID = 653, "Robot Arm (EV)", "Inserts into specific Slots (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 8L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.MOTUS, 8L), new Aspects.AspectStack(Aspects.COGNITIO, 8L)}));
        ItemList.Robot_Arm_IV.set(addItem(tLastID = 654, "Robot Arm (IV)", "Inserts into specific Slots (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 32L), new Aspects.AspectStack(Aspects.MOTUS, 16L), new Aspects.AspectStack(Aspects.COGNITIO, 16L)}));
        ItemList.Robot_Arm_LuV.set(addItem(tLastID = 655, "Robot Arm (LuV)", "Inserts into specific Slots (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 32L), new Aspects.AspectStack(Aspects.MOTUS, 16L), new Aspects.AspectStack(Aspects.COGNITIO, 16L)}));
        ItemList.Robot_Arm_ZPM.set(addItem(tLastID = 656, "Robot Arm (ZPM)", "Inserts into specific Slots (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 32L), new Aspects.AspectStack(Aspects.MOTUS, 16L), new Aspects.AspectStack(Aspects.COGNITIO, 16L)}));
        ItemList.Robot_Arm_UV.set(addItem(tLastID = 657, "Robot Arm (UV)", "Inserts into specific Slots (as Cover)", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 32L), new Aspects.AspectStack(Aspects.MOTUS, 16L), new Aspects.AspectStack(Aspects.COGNITIO, 16L)}));
        ...
        GregTech_API.registerCover(ItemList.Robot_Arm_LV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[1][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_ARM)), new GT_Cover_Arm(400));
        GregTech_API.registerCover(ItemList.Robot_Arm_MV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[2][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_ARM)), new GT_Cover_Arm(100));
        GregTech_API.registerCover(ItemList.Robot_Arm_HV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[3][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_ARM)), new GT_Cover_Arm(20));
        GregTech_API.registerCover(ItemList.Robot_Arm_EV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[4][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_ARM)), new GT_Cover_Arm(4));
        GregTech_API.registerCover(ItemList.Robot_Arm_IV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[5][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_ARM)), new GT_Cover_Arm(1));
        GregTech_API.registerCover(ItemList.Robot_Arm_LuV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[6][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_ARM)), new GT_Cover_Arm(1));
        GregTech_API.registerCover(ItemList.Robot_Arm_ZPM.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[7][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_ARM)), new GT_Cover_Arm(1));
        GregTech_API.registerCover(ItemList.Robot_Arm_UV.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[8][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_ARM)), new GT_Cover_Arm(1));

        ItemList.Field_Generator_LV.set(addItem(tLastID = 670, "Field Generator (LV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2L), new Aspects.AspectStack(Aspects.MACHINA, 1L), new Aspects.AspectStack(Aspects.TUTAMEN, 1L)}));
        ItemList.Field_Generator_MV.set(addItem(tLastID = 671, "Field Generator (MV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4L), new Aspects.AspectStack(Aspects.MACHINA, 2L), new Aspects.AspectStack(Aspects.TUTAMEN, 2L)}));
        ItemList.Field_Generator_HV.set(addItem(tLastID = 672, "Field Generator (HV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 8L), new Aspects.AspectStack(Aspects.MACHINA, 4L), new Aspects.AspectStack(Aspects.TUTAMEN, 4L)}));
        ItemList.Field_Generator_EV.set(addItem(tLastID = 673, "Field Generator (EV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 8L), new Aspects.AspectStack(Aspects.TUTAMEN, 8L)}));
        ItemList.Field_Generator_IV.set(addItem(tLastID = 674, "Field Generator (IV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 32L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.TUTAMEN, 16L)}));
        ItemList.Field_Generator_LuV.set(addItem(tLastID = 675, "Field Generator (LuV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 32L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.TUTAMEN, 16L)}));
        ItemList.Field_Generator_ZPM.set(addItem(tLastID = 676, "Field Generator (ZPM)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 32L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.TUTAMEN, 16L)}));
        ItemList.Field_Generator_UV.set(addItem(tLastID = 677, "Field Generator (UV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 32L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.TUTAMEN, 16L)}));
        ...
        ItemList.Emitter_LV.set(addItem(tLastID = 680, "Emitter (LV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1L), new Aspects.AspectStack(Aspects.MACHINA, 1L), new Aspects.AspectStack(Aspects.LUX, 1L)}));
        ItemList.Emitter_MV.set(addItem(tLastID = 681, "Emitter (MV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2L), new Aspects.AspectStack(Aspects.MACHINA, 2L), new Aspects.AspectStack(Aspects.LUX, 2L)}));
        ItemList.Emitter_HV.set(addItem(tLastID = 682, "Emitter (HV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4L), new Aspects.AspectStack(Aspects.MACHINA, 4L), new Aspects.AspectStack(Aspects.LUX, 4L)}));
        ItemList.Emitter_EV.set(addItem(tLastID = 683, "Emitter (EV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 8L), new Aspects.AspectStack(Aspects.MACHINA, 8L), new Aspects.AspectStack(Aspects.LUX, 8L)}));
        ItemList.Emitter_IV.set(addItem(tLastID = 684, "Emitter (IV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.LUX, 16L)}));
        ItemList.Emitter_LuV.set(addItem(tLastID = 685, "Emitter (LuV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.LUX, 16L)}));
        ItemList.Emitter_ZPM.set(addItem(tLastID = 686, "Emitter (ZPM)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.LUX, 16L)}));
        ItemList.Emitter_UV.set(addItem(tLastID = 687, "Emitter (UV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.LUX, 16L)}));
        ...
        ItemList.Sensor_LV.set(addItem(tLastID = 690, "Sensor (LV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1L), new Aspects.AspectStack(Aspects.MACHINA, 1L), new Aspects.AspectStack(Aspects.SENSUS, 1L)}));
        ItemList.Sensor_MV.set(addItem(tLastID = 691, "Sensor (MV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2L), new Aspects.AspectStack(Aspects.MACHINA, 2L), new Aspects.AspectStack(Aspects.SENSUS, 2L)}));
        ItemList.Sensor_HV.set(addItem(tLastID = 692, "Sensor (HV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4L), new Aspects.AspectStack(Aspects.MACHINA, 4L), new Aspects.AspectStack(Aspects.SENSUS, 4L)}));
        ItemList.Sensor_EV.set(addItem(tLastID = 693, "Sensor (EV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 8L), new Aspects.AspectStack(Aspects.MACHINA, 8L), new Aspects.AspectStack(Aspects.SENSUS, 8L)}));
        ItemList.Sensor_IV.set(addItem(tLastID = 694, "Sensor (IV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.SENSUS, 16L)}));
        ItemList.Sensor_LuV.set(addItem(tLastID = 695, "Sensor (LuV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.SENSUS, 16L)}));
        ItemList.Sensor_ZPM.set(addItem(tLastID = 696, "Sensor (ZPM)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.SENSUS, 16L)}));
        ItemList.Sensor_UV.set(addItem(tLastID = 697, "Sensor (UV)", "", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.MACHINA, 16L), new Aspects.AspectStack(Aspects.SENSUS, 16L)}));
        ...
        ItemList.Upgrade_Muffler.set(addItem(tLastID = 727, "Muffler Upgrade", "Makes Machines silent", new Object[]{new Aspects.AspectStack(Aspects.SENSUS, 2L), new Aspects.AspectStack(Aspects.VACUOS, 2L)}));
        ItemList.Upgrade_Lock.set(addItem(tLastID = 728, "Lock Upgrade", "Protects your Machines", new Object[]{new Aspects.AspectStack(Aspects.TUTAMEN, 4L)}));
        ...
        ItemList.Component_Filter.set(addItem(tLastID = 729, "Item Filter", "", new Object[]{new ItemData(Materials.Zinc, OrePrefixes.foil.mMaterialAmount * 16L), new Aspects.AspectStack(Aspects.COGNITIO, 1L), new Aspects.AspectStack(Aspects.SENSUS, 1L), new Aspects.AspectStack(Aspects.ITER, 1L), OreDictNames.craftingFilter}));
        ...
        ItemList.Cover_FluidDetector.set(addItem(tLastID = 732, "Fluid Detector", "Gives out Fluid Amount as Redstone", new Object[]{new Aspects.AspectStack(Aspects.SENSUS, 2L), new Aspects.AspectStack(Aspects.AQUA, 1L)}));
        ItemList.Cover_ItemDetector.set(addItem(tLastID = 733, "Item Detector", "Gives out Item Amount as Redstone", new Object[]{new Aspects.AspectStack(Aspects.SENSUS, 2L), new Aspects.AspectStack(Aspects.TERRA, 1L)}));
        ItemList.Cover_EnergyDetector.set(addItem(tLastID = 734, "Energy Detector", "Gives out Energy Amount as Redstone", new Object[]{new Aspects.AspectStack(Aspects.SENSUS, 2L), new Aspects.AspectStack(Aspects.POTENTIA, 1L)}));
        ItemList.Cover_PlayerDetector.set(addItem(tLastID = 735, "Player Detector", "Gives out close Players as Redstone", new Object[]{new Aspects.AspectStack(Aspects.SENSUS, 2L), new Aspects.AspectStack(Aspects.MACHINA, 1L)}));
        GT_Values.RA.addAssemblerRecipe(ItemList.Sensor_EV.get(1L, new Object[0]), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Titanium, 1L), ItemList.Cover_PlayerDetector.get(1L), 3200, 128);

        GregTech_API.registerCover(ItemList.Cover_Controller.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[2][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_CONTROLLER)), new GT_Cover_ControlsWork());
        GregTech_API.registerCover(ItemList.Cover_ActivityDetector.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[2][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_ACTIVITYDETECTOR)), new GT_Cover_DoesWork());
        GregTech_API.registerCover(ItemList.Cover_FluidDetector.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[2][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_FLUIDDETECTOR)), new GT_Cover_LiquidMeter());
        GregTech_API.registerCover(ItemList.Cover_ItemDetector.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[2][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_ITEMDETECTOR)), new GT_Cover_ItemMeter());
        GregTech_API.registerCover(ItemList.Cover_EnergyDetector.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[2][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_ENERGYDETECTOR)), new GT_Cover_EUMeter());
        GregTech_API.registerCover(ItemList.Cover_PlayerDetector.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[2][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_ACTIVITYDETECTOR)), new GT_Cover_PlayerDetector());

        ItemList.Cover_Screen.set(addItem(tLastID = 740, "Computer Monitor", "Displays Data", new Object[]{new Aspects.AspectStack(Aspects.COGNITIO, 2L), new Aspects.AspectStack(Aspects.LUX, 2L), new Aspects.AspectStack(Aspects.VITREUS, 1L)}));
        ItemList.Cover_Crafting.set(addItem(tLastID = 744, "Crafting Table Cover", "Better than a wooden Workbench", new Object[]{new Aspects.AspectStack(Aspects.FABRICO, 4L)}));
        ItemList.Cover_Drain.set(addItem(tLastID = 745, "Drain", "Absorbs Fluids and collects Rain", new Object[]{new Aspects.AspectStack(Aspects.VACUOS, 2L), new Aspects.AspectStack(Aspects.AQUA, 2L)}));

        ItemList.Cover_Shutter.set(addItem(tLastID = 749, "Shutter Module", "Blocks Inventory/Tank Side. Usage together with Machine Controller.", new Object[]{new Aspects.AspectStack(Aspects.ORDO, 2L), new Aspects.AspectStack(Aspects.ITER, 1L)}));
        ...
        GregTech_API.registerCover(ItemList.Cover_Screen.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[2][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_SCREEN)), new GT_Cover_Screen());
        GregTech_API.registerCover(ItemList.Cover_Crafting.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[1][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_CRAFTING)), new GT_Cover_Crafting());
        GregTech_API.registerCover(ItemList.Cover_Drain.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[0][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_DRAIN)), new GT_Cover_Drain());
        GregTech_API.registerCover(ItemList.Cover_Shutter.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[1][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_SHUTTER)), new GT_Cover_Shutter());

        ItemList.Cover_SolarPanel.set(addItem(tLastID = 750, "Solar Panel", "May the Sun be with you", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 1L), new Aspects.AspectStack(Aspects.POTENTIA, 1L), new Aspects.AspectStack(Aspects.TENEBRAE, 1L)}));
        ItemList.Cover_SolarPanel_8V.set(addItem(tLastID = 751, "Solar Panel (8V)", "8 Volt Solar Panel", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 2L), new Aspects.AspectStack(Aspects.POTENTIA, 2L), new Aspects.AspectStack(Aspects.TENEBRAE, 2L)}));
        ItemList.Cover_SolarPanel_LV.set(addItem(tLastID = 752, "Solar Panel (LV)", "Low Voltage Solar Panel", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 4L), new Aspects.AspectStack(Aspects.POTENTIA, 4L), new Aspects.AspectStack(Aspects.TENEBRAE, 4L)}));
        ItemList.Cover_SolarPanel_MV.set(addItem(tLastID = 753, "Solar Panel (MV)", "Medium Voltage Solar Panel", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 8L), new Aspects.AspectStack(Aspects.POTENTIA, 8L), new Aspects.AspectStack(Aspects.TENEBRAE, 8L)}));
        ItemList.Cover_SolarPanel_HV.set(addItem(tLastID = 754, "Solar Panel (HV)", "High Voltage Solar Panel", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 16L), new Aspects.AspectStack(Aspects.POTENTIA, 16L), new Aspects.AspectStack(Aspects.TENEBRAE, 16L)}));
        ItemList.Cover_SolarPanel_EV.set(addItem(tLastID = 755, "Solar Panel (EV)", "Extreme Solar Panel", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 32L), new Aspects.AspectStack(Aspects.POTENTIA, 32L), new Aspects.AspectStack(Aspects.TENEBRAE, 32L)}));
        ItemList.Cover_SolarPanel_IV.set(addItem(tLastID = 756, "Solar Panel (IV)", "Insane Solar Panel", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 64L), new Aspects.AspectStack(Aspects.POTENTIA, 64L), new Aspects.AspectStack(Aspects.TENEBRAE, 64L)}));
        ItemList.Cover_SolarPanel_LuV.set(addItem(tLastID = 757, "Solar Panel (LuV)", "Ludicrous Solar Panel", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 64L), new Aspects.AspectStack(Aspects.POTENTIA, 64L), new Aspects.AspectStack(Aspects.TENEBRAE, 64L)}));
        ItemList.Cover_SolarPanel_ZPM.set(addItem(tLastID = 758, "Solar Panel (ZPM)", "ZPM Voltage Solar Panel", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 64L), new Aspects.AspectStack(Aspects.POTENTIA, 64L), new Aspects.AspectStack(Aspects.TENEBRAE, 64L)}));
        ItemList.Cover_SolarPanel_UV.set(addItem(tLastID = 759, "Solar Panel (UV)", "Ultimate Solar Panel", new Object[]{new Aspects.AspectStack(Aspects.ELECTRUM, 64L), new Aspects.AspectStack(Aspects.POTENTIA, 64L), new Aspects.AspectStack(Aspects.TENEBRAE, 64L)}));
        ...
        ItemList.Tool_Sonictron.set(addItem(tLastID = 760, "Sonictron", "Bring your Music with you", new Object[]{Behaviour_Sonictron.INSTANCE, new Aspects.AspectStack(Aspects.SENSUS, 4L)}));
        ItemList.Tool_Cheat.set(addItem(tLastID = 761, "Debug Scanner", "Also an Infinite Energy Source", new Object[]{Behaviour_Scanner.INSTANCE, new Aspects.AspectStack(Aspects.NEBRISUM, 64L)}));
        setElectricStats(32000 + tLastID, -2000000000L, 1000000000L, -1L, -3L, false);
        ItemList.Tool_Scanner.set(addItem(tLastID = 762, "Portable Scanner", "Tricorder", new Object[]{Behaviour_Scanner.INSTANCE, new Aspects.AspectStack(Aspects.ELECTRUM, 6L), new Aspects.AspectStack(Aspects.SENSUS, 6L)}));
        ...
        ItemList.Duct_Tape.set(addItem(tLastID = 764, "BrainTech Aerospace Advanced Reinforced Duct Tape FAL-84", "If you can't fix it with this, use more of it!", new Object[]{new Aspects.AspectStack(Aspects.ORDO, 2L), new Aspects.AspectStack(Aspects.INSTRUMENTUM, 2L), OreDictNames.craftingDuctTape}));

       GT_Values.RA.addAssemblerRecipe(ItemList.Sensor_LV.get(1L, new Object[0]), ItemList.Emitter_LV.get(1L), ItemList.NC_SensorKit.get(1L), 1600, 2);

        ItemList.Cover_RedstoneTransmitterExternal.set(addItem(tLastID = 741, "Redstone Transmitter (Out)", "Transfers Redstonesignals wireless", new Object[]{new Aspects.AspectStack(Aspects.ORDO, 2L), new Aspects.AspectStack(Aspects.MACHINA, 1L)}));
        ItemList.Cover_RedstoneTransmitterInternal.set(addItem(tLastID = 742, "Redstone Transmitter (In)", "Transfers Redstonesignals wireless", new Object[]{new Aspects.AspectStack(Aspects.ORDO, 2L), new Aspects.AspectStack(Aspects.MACHINA, 1L)}));
        ItemList.Cover_RedstoneReceiverExternal.set(addItem(tLastID = 746, "Redstone Receiver (Out)", "Transfers Redstonesignals wireless", new Object[]{new Aspects.AspectStack(Aspects.ORDO, 2L), new Aspects.AspectStack(Aspects.MACHINA, 1L)}));
        ItemList.Cover_RedstoneReceiverInternal.set(addItem(tLastID = 747, "Redstone Receiver (In)", "Transfers Redstonesignals wireless", new Object[]{new Aspects.AspectStack(Aspects.ORDO, 2L), new Aspects.AspectStack(Aspects.MACHINA, 1L)}));

        GregTech_API.registerCover(ItemList.Cover_RedstoneTransmitterExternal.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[2][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_ACTIVITYDETECTOR)), new GT_Cover_RedstoneTransmitterExternal());
        GregTech_API.registerCover(ItemList.Cover_RedstoneTransmitterInternal.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[2][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_ACTIVITYDETECTOR)), new GT_Cover_RedstoneTransmitterInternal());
        GregTech_API.registerCover(ItemList.Cover_RedstoneReceiverExternal.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[2][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_FLUIDDETECTOR)), new GT_Cover_RedstoneReceiverExternal());
        GregTech_API.registerCover(ItemList.Cover_RedstoneReceiverInternal.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[2][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_FLUIDDETECTOR)), new GT_Cover_RedstoneReceiverInternal());

        GT_Values.RA.addAssemblerRecipe(ItemList.Emitter_EV.get(1L, new Object[0]), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.StainlessSteel, 1L), ItemList.Cover_RedstoneTransmitterExternal.get(1L), 3200, 128);
        GT_Values.RA.addAssemblerRecipe(ItemList.Sensor_EV.get(1L, new Object[0]), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.StainlessSteel, 1L), ItemList.Cover_RedstoneReceiverExternal.get(1L), 3200, 128);
        ...
        ItemList.Cover_NeedsMaintainance.set(addItem(tLastID = 748, "Needs Maintenance Cover", "Attach to Multiblock Controller. Emits Redstone Signal if needs Maintenance", new Object[]{new Aspects.AspectStack(Aspects.ORDO, 2L), new Aspects.AspectStack(Aspects.MACHINA, 1L)}));
        GregTech_API.registerCover(ItemList.Cover_NeedsMaintainance.get(1L, new Object[0]), new GT_MultiTexture(Textures.BlockIcons.MACHINE_CASINGS[2][0], new GT_RenderedTexture(Textures.BlockIcons.OVERLAY_ACTIVITYDETECTOR)), new GT_Cover_NeedMaintainance());
        GT_Values.RA.addAssemblerRecipe(ItemList.Emitter_MV.get(1L, new Object[0]), GT_OreDictUnificator.get(OrePrefixes.plate, Materials.Aluminium, 1L), ItemList.Cover_NeedsMaintainance.get(1L), 600, 24);

                                        ...
                                        for (int eZ = tMinZ; eZ <= tMaxZ; eZ++) {
                                            ...
                                            if (var12d + var45 * var45 < 1.0F) {
                                                ...
                                                if (tTargetedBlock instanceof GT_Block_Ores_Abstract) {
                                                    GT_Block_Ores_Abstract aBlockOresAbs = (GT_Block_Ores_Abstract) tTargetedBlock;
                                                    int aOreMeta = this.mBlock == GregTech_API.sBlockGranites ? this.mBlockMeta == 0 ? 1 : 2 : this.mBlockMeta == 0 ? 3 : 4;
                                                    aWorld.setBlock(eX, eY, eZ, aBlockOresAbs.aMaterial.aDefOreBlock, aOreMeta, 0);

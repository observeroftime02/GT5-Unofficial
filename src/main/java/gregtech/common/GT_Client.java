...
public class GT_Client extends GT_Proxy {
    ...
    public GT_Client() {
        ...
        mPosR = Arrays.asList(Materials.Enderium, Materials.Uranium235, Materials.Plutonium241, Materials.NaquadahEnriched, Materials.Naquadria, Materials.InfusedOrder, Materials.Glowstone, Materials.Thaumium, Materials.InfusedAir, Materials.InfusedFire);
        ...
        mPosB = Arrays.asList(Materials.Enderium, Materials.Uranium235, Materials.Plutonium241, Materials.NaquadahEnriched, Materials.Naquadria, Materials.InfusedOrder, Materials.InfusedWater, Materials.Thaumium);
        ...
        mMoltenPosR = Arrays.asList(Materials.Enderium, Materials.NetherStar, Materials.Uranium235, Materials.Plutonium241, Materials.NaquadahEnriched, Materials.Naquadria, Materials.InfusedOrder, Materials.Glowstone, Materials.Thaumium, Materials.InfusedAir, Materials.InfusedFire);
        ...
        mMoltenPosB = Arrays.asList(Materials.Enderium, Materials.NetherStar, Materials.Uranium235, Materials.Plutonium241, Materials.NaquadahEnriched, Materials.Naquadria, Materials.InfusedOrder, Materials.InfusedWater, Materials.Thaumium);

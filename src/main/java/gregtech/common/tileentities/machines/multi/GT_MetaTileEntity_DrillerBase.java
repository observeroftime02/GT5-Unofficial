...
public abstract class GT_MetaTileEntity_DrillerBase extends GT_MetaTileEntity_MultiBlockBase {
	private static final ItemStack miningPipe = ItemList.Block_MiningPipe.get(0);
    private static final ItemStack miningPipeTip = ItemList.Block_MiningPipeTip.get(0);

    ...
    public int checkRecipe() {
        ...
        if (getOutputAt(0) != null) {
            ...
            if (ItemList.Tool_DataOrb.isStackEqual(getSpecialSlot(), false, true)) {
                ...
                if (tData != null && (tData.mPrefix == OrePrefixes.dust || tData.mPrefix == OrePrefixes.cell) && tData.mMaterial.mMaterial.mElement != null && !tData.mMaterial.mMaterial.mElement.mIsIsotope && tData.mMaterial.mMaterial != Materials.Magic && tData.mMaterial.mMaterial.getMass() > 0) {
                    ...
                    this.mMaxProgresstime = tData.mMaterial.mMaterial.getMass() * 8192 / (1 << this.mTier - 1);
                    this.mEUt = 32 * (1 << this.mTier - 1) * (1 << this.mTier - 1);
                    return 2;
                }
            }

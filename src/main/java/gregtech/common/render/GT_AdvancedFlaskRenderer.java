...
public final class GT_AdvancedFlaskRenderer implements IItemRenderer {
    public GT_AdvancedFlaskRenderer() {
        MinecraftForgeClient.registerItemRenderer(ItemList.VOLUMETRIC_FLASK_ADVANCED.getItem(), this);
    }
    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        GT_VolumetricFlaskAdvanced cell = (GT_VolumetricFlaskAdvanced) item.getItem();

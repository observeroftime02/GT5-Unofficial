...
public final class GT_GUIContainerVolumetricFlaskAdvanced extends GuiContainer {
    ...
    private GT_ContainerVolumetricFlaskAdvanced container;

    public GT_GUIContainerVolumetricFlaskAdvanced(GT_ContainerVolumetricFlaskAdvanced container) {
        super(container);
    ...
    public void initGui() {
        ...
        amount = new GuiIntegerBox(fontRendererObj, guiLeft + 62, guiTop + 57, 59, fontRendererObj.FONT_HEIGHT, ((GT_VolumetricFlaskAdvanced) container.flask.getItem()).getMaxCapacity());
        ...
        amount.setText("1");
        System.out.println(((GT_VolumetricFlaskAdvanced) container.flask.getItem()).getCapacity(container.flask));
        amount.setText(String.valueOf(((GT_VolumetricFlaskAdvanced) container.flask.getItem()).getCapacity(container.flask)));
    }

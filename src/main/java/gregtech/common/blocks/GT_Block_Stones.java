...
public class GT_Block_Stones extends GT_Block_Stones_Abstract {
    public GT_Block_Stones() {
        ...
        for(int i = 0;i<16;i++){
            MatUnifier.registerOre(OrePrefixes.stone, i < 8 ? Materials.Marble : Materials.Basalt, new ItemStack(this, 1, i));
            MatUnifier.registerOre(OrePrefixes.block, i < 8 ? Materials.Marble : Materials.Basalt, new ItemStack(this, 1, i));
            MatUnifier.registerOre((i < 8 ? Materials.Marble.mName.toLowerCase() : Materials.Basalt.mName.toLowerCase()), new ItemStack(this, 1, i));
        }
    }

...
public class GT_Block_Ores_UB2 extends GT_Block_Ores_Abstract {
    public static Block aUBBlock3;

    public GT_Block_Ores_UB2(Materials aMaterial) {
        super("blockores.ub2", aMaterial);
        for (int i = 0; i < 8; i++) {
    ...
    public String getUnlocalizedName() {
        return "gt.blockores.ub2." + aMaterial.mName.toLowerCase();
    }

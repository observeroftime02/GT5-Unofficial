...
public class GT_Block_Reinforced extends GT_Generic_Block {
    ...
    public GT_Block_Reinforced(String aName) {
        ...
        GT_LanguageManager.addStringLocalization(getUnlocalizedName() + ".8.name", "Mining Pipe");
        GT_LanguageManager.addStringLocalization(getUnlocalizedName() + ".9.name", "Mining Pipe Tip");
        ...
        MatUnifier.setItemData(ItemList.Block_IridiumTungstensteel.get(1), new ItemData(new MaterialStack(Materials.Iridium, OrePrefixes.plate.mMaterialAmount), new MaterialStack(Materials.TungstenSteel, 2*OrePrefixes.plate.mMaterialAmount),new MaterialStack(Materials.Concrete, OrePrefixes.dust.mMaterialAmount)));

...
public class GT_Block_Stones_Abstract extends GT_Generic_Block {
    ...
    public GT_Block_Stones_Abstract(Class<? extends ItemBlock> aItemClass, String aName) {
        ...
        GT_Values.RA.addAssemblerRecipe(new ItemStack(this, 1, 0), ItemList.Circuit_Integrated.getWithDamage(0, 4), new ItemStack(this, 1, 3), 50, 4);
        GT_Values.RA.addAssemblerRecipe(new ItemStack(this, 1, 8), ItemList.Circuit_Integrated.getWithDamage(0, 4), new ItemStack(this, 1, 11), 50, 4);
        GT_ModHandler.addShapedToolRecipe(new ItemStack(this, 1, 6), "f  ", "X  ", "   ", 'X', new ItemStack(this, 1, 7));
        GT_ModHandler.addShapedToolRecipe(new ItemStack(this, 1, 14), "f  ", "X  ", "   ", 'X', new ItemStack(this, 1, 15));
        GT_ModHandler.addShapedToolRecipe(new ItemStack(this, 1, 4), "h  ", "X  ", "   ", 'X', new ItemStack(this, 1, 3));
        GT_ModHandler.addShapedToolRecipe(new ItemStack(this, 1, 12), "h  ", "X  ", "   ", 'X', new ItemStack(this, 1, 11));
        GT_ModHandler.addShapedToolRecipe(new ItemStack(this, 1, 1), "h  ", "X  ", "   ", 'X', new ItemStack(this, 1, 0));
        GT_ModHandler.addShapedToolRecipe(new ItemStack(this, 1, 9), "h  ", "X  ", "   ", 'X', new ItemStack(this, 1, 8));
        ...
        GT_ModHandler.addBasicShapedRecipe(new ItemStack(this, 4, 3), "XX ", "XX ", "   ", 'X', new ItemStack(this, 4, 0));
        GT_ModHandler.addBasicShapedRecipe(new ItemStack(this, 4, 11), "XX ", "XX ", "   ", 'X', new ItemStack(this, 4, 8));
        GT_ModHandler.addBasicShapedRecipe(new ItemStack(this, 4, 3), "XX ", "XX ", "   ", 'X', new ItemStack(this, 4, 7));
        GT_ModHandler.addBasicShapedRecipe(new ItemStack(this, 4, 11), "XX ", "XX ", "   ", 'X', new ItemStack(this, 4, 15));
    }

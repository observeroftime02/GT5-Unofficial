...
## Changes
-Removed food related items
-Removed LuV+ Machines
-Removed IC2 & Railcraft mod integration
-Ore Blocks now drop Ore Chunks
-Rewrote Material component recipes registration - improves load times
-Assembly line recipes visible by default